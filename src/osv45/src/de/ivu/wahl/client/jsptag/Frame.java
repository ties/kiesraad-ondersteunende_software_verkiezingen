...
/**
 * Erweitertes HTML-FRAME-Tag, der selbst�ndig f�r die Source-URL das URL-Rewriting im ClientHelper
...
public class Frame extends TagSupport {
  ...
  /**
   * Keine Gr��en�nderung durch den Benutzer, Voreinstellung definiert
   */
  ...
  /**
   * Setze URL f�r das Frame.
   * 
   * @param value URL f�r das Frame
   */
  ...
  /**
   * Setze Verbot Gr��en�nderung durch den Benutzer, Voreinstellung definiert.
   * 
   * @param value Verbot Gr��en�nderung durch den Benutzer, Voreinstellung definiert
   */
  ...
  /**
   * End-Tag interpretieren. Schlie�t nur den FRAME-Tag ab.
   * 

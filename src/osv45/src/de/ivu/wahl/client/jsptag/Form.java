...
/**
 * Erweitertes HTML-FORM-Tag, der selbst�ndig f�r die Action-URL das URL-Rewriting im ClientHelper
...
public class Form extends TagSupport {
  ...
  /**
   * Setzt den neuen Wert f�r accept_charset auf accept_charset.
   * 
   * @param value neuer Wert f�r accept_charset
   */
  ...
  /**
   * End-Tag interpretieren. Schlie�t nur den FORM-Tag ab.
   * 

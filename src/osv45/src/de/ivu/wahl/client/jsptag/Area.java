...
/**
 * Erweitertes HTML-AREA-Tag, der selbst�ndig f�r die Ziel-URL das URL-Rewriting im ClientHelper
...
public class Area extends TagSupport {
  ...
  /**
   * JavaScript f�r Maus �ber der Area
   */
  protected String onmouseover;

  /**
   * JavaScript f�r Maus verl�sst die Area
   */
  ...
  /**
   * Setze JavaScript f�r Maus �ber der Area.
   * 
   * @param value JavaScript f�r Maus �ber der Area
   */
  ...
  /**
   * Setze JavaScript f�r Maus verl�sst die Area.
   * 
   * @param value JavaScript f�r Maus verl�sst die Area
   */
  ...
  /**
   * End-Tag interpretieren. Schlie�t nur den AREA-Tag ab.
   * 

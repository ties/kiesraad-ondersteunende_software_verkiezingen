 ...
 */
public class InitGuiCommandEiland_P5 extends InitGuiCommandGR_DR_P5
    implements
   ...
   */
  public InitGuiCommandEiland_P5(Map<Integer, String> jspMap, int gebietsartErfassungseinheitMax) {
    super(jspMap, gebietsartErfassungseinheitMax);
  }

  @Override
  protected int getTopLevel() {
    return WahlModel.GEBIETE_EILAND_NL[0];
  }

...
public class GruppeGebietsspezifischBean extends BasicGruppeGebietsspezifischBean {
  ...
  /**
   * F�hrt eine Suche mit einem (oder keinem) erwarteten Ergebnis aus
   * 
   ...
   * @return Prim�rschl�ssel der gefundenen GruppeGebietsspezifisch
   * @throws ObjectNotFoundException wenn keine Instanz gefunden werden konnte
  ...
  /**
   * @param id_Gruppe Prim�rschl�ssel der Gruppe
   * @param id_Gebiet Prim�rschl�ssel des Gebiets
   * @return Prim�rschl�ssel der GruppeGebietsspezifisch an der Kreuzung von gegebener Gruppe mit
   ...
   * @param id_Gruppe Prim�rschl�ssel der Gruppe
   * @param id_Gebiet Prim�rschl�ssel des Gebiets
   * @return Prim�rschl�ssel aller GruppeGebietsspezifisch an der Kreuzung von gegebener Gruppe mit
   *         gegebenem Gebiet
   * @throws FinderException genereller Fehler bei der Durchf�hrung der Suche
   * @throws EJBException bei einem allgemeinem Problem
   */
  ...
  /**
   * @param id_Gebiet Prim�rschl�ssel des Gebiets
   * @return Prim�rschl�ssel aller GruppeGebietsspezifisch eines Gebiets, sortiert nach der Position
   * @throws FinderException genereller Fehler bei der Durchf�hrung der Suche
   * @throws EJBException bei einem allgemeinem Problem
   */
  ...
  /**
   * @param id_Gruppe Prim�rschl�ssel der Gruppe
   * @return Prim�rschl�ssel aller GruppeGebietsspezifisch einer Gruppe, geordnet nach Gebietsart
   ...
   *          zutreffend)
   * @param gebietIDs Gebiete �ber die gesucht wird
   * @return Prim�rschl�ssel aller GruppeGebietsspezifisch auf einer bestimmten Position in einer
   *         Gruppe von Gebieten
   * @throws FinderException genereller Fehler bei der Durchf�hrung der Suche
   * @throws EJBException bei einem allgemeinem Problem
   */
   ...
   * @return Prim�rschl�ssel aller GruppeGebietsspezifisch der Wahl
   * @throws FinderException genereller Fehler bei der Durchf�hrung der Suche
   * @throws EJBException bei einem allgemeinem Problem
   */
  ...
  /**
   * Liefert die Prim�rschl�ssel aller auf der Liste oder direkt zugelassenen
   * GruppeGebietsspezifisch eines Gebietes (also die, die eine Zeile auf dem Wahlzettel
   * beanspruchen)
   * 
   * @param id_Gebiet Prim�rschl�ssel des Gebiets
   * @return Prim�rschl�ssel aller auf der Liste oder direkt zugelassenen GruppeGebietsspezifisch
   *         eines Gebietes
   * @throws FinderException genereller Fehler bei der Durchf�hrung der Suche
   * @throws EJBException bei einem allgemeinem Problem
   */
   ...
   * heraus.
   * 
   * @param id_Gebiet Prim�rschl�ssel des Gebiets, in dem gesucht wird
   * @param wahlergebnisart Wahlergebnisart, f�r die der/die Gewinner gesucht wird/werden
   * @param stimmart Stimmart, f�r die der/die Gewinner gesucht wird/werden
   * @return Prim�rschl�ssel der Gruppe/Gruppen im Gebiet mit der maximalen Stimmanzahl
   * @throws FinderException genereller Fehler bei der Durchf�hrung der Suche
   * @throws EJBException bei einem allgemeinem Problem
   */
   ...
   *         einem {@link GruppeModel} und f�r der zugeh�rigen Kandidatenliste b�ndelt
   * @throws EJBException bei einem allgemeinem Problem
   */

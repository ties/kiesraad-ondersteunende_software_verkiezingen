...
/**
  * Interface for the entity SitzberechnungErgebnis as Entity Bean.
  * The navigation (1:1, 1:n, m:n) is contained
  *
  * @author cos@ivu.de  (c) 2003-7 IVU Traffic Technologies AG
  * @version $Id: tablegen.properties,v 1.36 2009/10/12 09:33:21 jon Exp $
  */
public interface SitzberechnungErgebnis extends EJBLocalObject, SitzberechnungErgebnisModel {
   /**
     ...
     */
   void setDetails(SitzberechnungErgebnisModel details);
   ...
   /**
     ...
     */
   SitzberechnungErgebnisModel getDetails();

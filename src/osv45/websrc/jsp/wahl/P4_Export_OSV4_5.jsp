...
<%@ page import="de.ivu.wahl.admin.P4ExportStateOSV4_5"%>
                  ...
                  <td valign="top">
                     <table width="<%= breite %>" border="0" cellspacing="0" cellpadding="0" class="hghell">
                        <tr>
                           ...
                           <td colspan="2" class="hggrau" height="20"><ivu:int key="Export_P4_titel_OSV4_5"/></td>
                        </tr>
                        <tr>
                               ...
                               <tr>
                                  <td valign="top">
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="1" border="0">
                                      ...
                                      <% }                                  
                                    if (P4ExportStateOSV4_5.STATUS_P4_D1 == state._modus){  %>
                                                <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                <legend><b><ivu:int key="Export_P4_OSV4_5"/></b></legend>
                                                    <p><ivu:int key="Export_P4_OSV4_5_D1"/></p>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="<%= breite %>">
                                                       <tr>
                                                        <td height="20" valign="top" class="guiBefehle"><%
                                                         ...
                                                         for (String buttonName : Konstanten.PROP_OSV4_5_D1.keySet()) {
                                                         ...
                                                         if (selectedKey != null) {
                                                          ...
                                                          <ivu:form action="<%= formurl %>">
                                                            <table border="0" cellspacing="4" cellpadding="1" width="<%= breite %>" style="padding: 1em;">
                                                             ...
                                                             List<Basiseinstellung> basiseinstellungen = Konstanten.PROP_OSV4_5_D1.get(selectedKey);
                                     ...
                                     <% } else if (P4ExportStateOSV4_5.STATUS_P4_D2 == state._modus){
                                                        ...
                                                        <legend><b><ivu:int key="Export_P4_OSV4_5"/></b></legend>
                                                           ...
                                                           <ivu:form action="<%=urlExp%>" onsubmit="transp();">
                                                            <table cellspacing="4" cellpadding="2" border="0">
                                                               <%   for (Basiseinstellung basiseinstellung : Konstanten.PROP_OSV4_5_D1_BASIS) { 
                                                                       String property = basiseinstellung.getProperty();
                                     ...
                                     <% } else if (P4ExportStateOSV4_5.STATUS_P4_D3 == state._modus){
                                                    // reset export status
                                                    expP4Bean.resetExportStateOSV4_5();
                                                    //forward to Werkmap
                                                    String urlExp = "/osv?cmd=" + ExportP4Commands.EXP_P4_EXPORT_P4_OSV4_5 + "&" + ApplicationBeanKonstanten.WORK+"="+ ApplicationBeanKonstanten.EXPORT_VERZEICHNIS+"&" +ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK);
                                        %>
                                        <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                    <legend><b><ivu:int key="Export_P4_OSV4_5"/></b></legend>

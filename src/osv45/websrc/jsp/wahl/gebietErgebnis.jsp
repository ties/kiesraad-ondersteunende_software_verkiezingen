...
<%
   ...
   String rechteFehler = appBean.getErrorIfRightsAreMissing(JspPage.GEBIET_ERGEBNIS);
...
<table width="<%= breite %>" border="0" cellspacing="0" cellpadding="0" align="center" class="hghell">
   ...
   <tr>
      <td colspan="3" height="10" class="hghell"><img alt="" src="<%= request.getContextPath() %>/img/icon/blind.gif" width="1" height="10"></td>
   </tr>
                           ...
                           <table border="0" width="<%= breite %>" cellspacing="2" cellpadding="4" align="center">
                              ...
                              if (msg != null){
                                Map<Integer, GUIEingangMsg.Gruppendaten> gd =  msg.getGruppendaten();
                                  ...
                                  for (GUIEingangMsg.Gruppendaten gErg : gd.values()){

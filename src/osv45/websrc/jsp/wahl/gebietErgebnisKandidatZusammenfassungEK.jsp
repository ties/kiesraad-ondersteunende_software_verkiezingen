...
String helpKey = "gebietErgKand"; //$NON-NLS-1$
   ...
   String rechteFehler = appBean.getErrorIfRightsAreMissing(JspPage.GEBIET_ERGEBNIS_KANDIDAT_ZUSAMMENFASSUNG_EK); 
                            ...
                            <td valign="top">
                               <table border="0" width="<%= breite %>" cellspacing="2" cellpadding="4" align="center" >
                                  ...
                                  for(PartyWithCandidates partyWithCandidates : partysWithC){
                                    ...
                                    <!--  Tableheader-->
                                  <tr class="hgformular">
                                     <td valign="top" rowspan="1" align="center" colspan="2">
                                        <strong><ivu:int key="Subjekt"/></strong>
                                     </td>
                                     <td valign="top" colspan="<%= 2 * gebieteSize +1 %>" align="center">
                                        <strong><ivu:int key="Stimmen"/></strong>
                                     </td>
                                  </tr>
                                  <tr class="hgformular">
                                        <td valign="top" rowspan="2" align="center" colspan="2">
                                          <strong>A = Aantal uitgebrachte stemmen<br/>B = Gelden voor</strong>
                                        </td>
                                        <td valign="top" rowspan="2" align="center"><strong><ivu:int key="Summe"/></strong></td>
                                      <%for(Gebiet gebiet : rs.getGebiete()){ %>
                                        <td valign="top" colspan="2" align="center"><strong><%= ClientHelper.forHTML(gebiet.getName()) %></strong></td>
                                      <% } %>
                                  </tr>
                                  <tr class="hgformular">
                                      <%for(Gebiet gebiet : rs.getGebiete()){ %>
                                        <td valign="top" align="center"><strong>A</strong></td>
                                        <td valign="top" align="center"><strong>B</strong></td>
                                      <% } %>
                                  </tr>
                                  <tr class="<%= j>0 ?"hgweiss":"hgeeeeee" %>">
                                        ...
                                        <td><b><%= partyWithCandidates.getSummeGewichtet() %></b></td>
                                        <%for(Gebiet gebiet : rs.getGebiete()){ %>
                                            <td><b><%= partyWithCandidates.getGruppenstimmeProGebiet(gebiet) %></b></td>
                                            <td><b><%= partyWithCandidates.getGruppenstimmeGewichtetProGebiet(gebiet) %></b></td>
                                        <% } %>
                                    </tr><%
                                    j = -j;
                                    int candidatePos = 1;
                                    ...
                                    for (CandidateVotesPerRegion candidateVotesPerRegion: partyWithCandidates.getCandidateVotesPerRegion()){
                                        ...
                                        <tr >
                                            ...
                                            <td class="<%= j>0 ?"hgweiss":"hgeeeeee" %>"><b><%= candidateVotesPerRegion.getSummeGewichtet() %></b></td>
                                            <%for(Gebiet gebiet : rs.getGebiete()){ %>
                                                <td class="<%= j>0 ?"hgweiss":"hgeeeeee" %>"><%= candidateVotesPerRegion.getKandidatenstimmeProGebiet(gebiet) %></td>
                                                <td class="<%= j>0 ?"hgweiss":"hgeeeeee" %>"><%= candidateVotesPerRegion.getKandidatenstimmeGewichtetProGebiet(gebiet) %></td>
                                            <% } %>
                                        </tr><%
                                        j = -j;
                                        if (candidatePos % 20 == 0 && (numOfCandidates - candidatePos >= 15 || partyPos == numOfParties)) { %>
                                            ...
                                            <tr>
                                                ...
                                                <%for(Gebiet gebiet : rs.getGebiete()){ %>
                                                    <td class="<%= j>0 ?"hgweiss":"hgeeeeee" %>" valign="top" colspan="2" align="center"><strong><%= gebiet.getName() %></strong></td>
                                                <% } %>
                                            </tr><%

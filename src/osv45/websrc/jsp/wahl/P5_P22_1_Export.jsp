...
String rechteFehler = appBean.getErrorIfRightsAreMissing(JspPage.P5_P22_1_EXPORT); 
...
BasiseinstellungMultiMap bmm = Konstanten.PROP_P22_1_D1;
                                  ...
                                  <td valign="top">
                                    ...
                                    %>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" width="<%=breite%>">
                                                       <tr>
                                                        ...
                                                        %> 
                                                           ...
                                                           if (selectedKey != null) {
                                                               String formurl = "/osv?cmd=" + Action.CMD_ADM_PROP_EINGABE_P22_1_1.getKey() + "&" + ApplicationBeanKonstanten.PREFIX + "subwork=" + subwork 
                                     ...
                                     <%
                                            ...
                                            String urlExp = "/osv?cmd=" + Action.CMD_ADM_EXPORT_P22_1.getKey() + "&" +ClientHelper.getAllParameters (request);
                                        %>
                                              <table border="0" cellspacing="0" cellpadding="1" width="<%= breite %>">
                                                 <tr>
                                                    <td valign="top">
                                     ...
                                     <% }  else if (P5ExportStateP22_1.STATUS_P22_1_D3 == p22ES._modus){
                                            ...
                                            //forward to Werkmap
                                            String urlExp = "/osv?cmd=" + Action.CMD_ADM_EXPORT_P22_1.getKey() + "&"+ClientHelper.workIs(Command.EXPORT_VERZEICHNIS)+"&" +ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK);
                                            %>
                                            <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                        <legend><b><ivu:int key="Export_P22_1"/></b></legend>

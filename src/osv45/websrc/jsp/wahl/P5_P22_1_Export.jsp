                                  ...
                                  <td valign="top">
                                    ...
                                    %>
                                     ...
                                     <% }  else if (P5ExportStateP22_1.STATUS_P22_1_D3 == p22ES._modus){
                                            ...
                                            //forward to Werkmap
                                            String urlExp = "/osv?cmd=adm_exportP22_1&"+ClientHelper.workIs(Command.EXPORT_VERZEICHNIS)+"&" +ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK);
                                            %>
                                            <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                        <legend><b><ivu:int key="Export_P22_1"/></b></legend>

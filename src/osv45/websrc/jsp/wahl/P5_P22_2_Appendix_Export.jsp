...
<%@ page import="de.ivu.wahl.admin.P5ExportStateP22_2Appendix"%>
...
DialogStateHolder state = admBean.getP5ExportStateP22_2Appendix();
    ...
    <div id="content">
        ...
        <div id="trans">
            <div class="hgeeeeee" style="height: 14px; width: 100%;" align="right">
                <ivu:help key="ProtocolAppendixExport"/>
            </div>
            ...
            <div class="hggrau" style="height: 20px; width: 100%; text-indent: 5px; line-height: 18px;">
                <ivu:int key="Export_Protocol_Appendix_P5_titel"/>
            </div>
            <div class="hgschwarz" style="height: 1px; line-height: 1px; width: 100%;">
                &nbsp;
            </div>
                                    ...
                                    %>
                                        <table width="100%" cellspacing="0" cellpadding="1" border="0">
                                          ...
                                          <%
                                            ...
                                            if (P5ExportStateP22_2Appendix.STATUS_P22_2_APPENDIX_D1 == state._modus){
                                     %>
                                         <fieldset style="border: 1px solid #093C69; padding: 15px">
                                            <legend><b><ivu:int key="Export_Protocol_Appendix"/></b></legend>
                                            <p><ivu:int key="Export_Protocol_Appendix_D2"/></p>
                                            <%
                                               ...
                                               <tr>
                                                <td height="20" valign="top" class="guiBefehle"><%
                                                  int buttonIdx = 0;
                                                                                                 ...
                                                                                                 for (String buttonName : Konstanten.PROP_P22_2_APPENDIX.keySet()) {
                                                ...
                                                %> 
                                                   ...
                                                   if (selectedKey != null) {
                                                                                                        String formurl = "/osv?cmd=" + ExportP5Commands.CMD_ADM_PROP_EINGABE_P22_2_APPENDIX_2 + "&" + ApplicationBeanKonstanten.PREFIX + "subwork=" + subwork 
                                                   ...
                                                   <td style="border: 1px solid rgb(9, 60, 105); padding-left: 1em width: 100%;">
                                                    ...
                                                    <table border="0" cellspacing="4" cellpadding="1" width="<%=breite%>" style="padding: 1em;">
                                                      <colgroup width="50%" span="2"></colgroup><%
                                                        List<Basiseinstellung> basiseinstellungen = Konstanten.PROP_P22_2_APPENDIX.get(selectedKey);
                                                      ...
                                                      <tr title="<%=basiseinstellung.getHinweis()%>">
                                                       <td valign="top"><%=basiseinstellung.getBeschreibung()%><%=basiseinstellung.isPflichtfeld() ? " *": ""%></td>
                                                       <td>
                                                       <%
                                                        ...
                                                        Typ typ = basiseinstellung.getTyp();
                                                        switch (typ) {
                                                         case RelURL:
                                                       ...
                                                       %>
                                                         ...
                                                         case String:
                                                          ...
                                                          %>
                                                              <input type="text" class="feld <%=styleClass%>" height="4" size="64" id="<%=property%>" name="<%=property%>" value="<%=wert%>"><%
                                                                break;
                                                              case Date:
                                                              case Time:
                                                              case ZIP:
                                     ...
                                     <%
                                       } else if (P5ExportStateP22_2Appendix.STATUS_P22_2_APPENDIX_D2 == state._modus){
                                            String urlExp = "/osv?cmd=" + ExportP5Commands.CMD_ADM_EXPORT_P22_2_APPENDIX + "&" + ClientHelper.getAllParameters (request);
                                        %>
                                              <table border="0" cellspacing="0" cellpadding="1" width="<%= breite %>">
                                                 <tr>
                                                    <td valign="top">
                                                           ...
                                                           <ivu:form action="<%=urlExp%>" onsubmit="transp();">
                                                            <table cellspacing="4" cellpadding="2" border="0">
                                                               <tr>
                                                                ...
                                                                <%
                                                                  for (Basiseinstellung basiseinstellung : Konstanten.PROP_P22_2_APPENDIX_BASIS) { 
                                                                                                                                       String property = basiseinstellung.getProperty();
                                                                                                                                       String wert = admBean.getProperty(property);
                                                                %>
                                                                     <tr title="<%= basiseinstellung.getHinweis() %>">
                                                                       <td valign="top"><%= basiseinstellung.getBeschreibung() %><%= basiseinstellung.isPflichtfeld() ? " *": "" %>:</td>
                                                                       <td><textarea rows="5" cols="64" disabled="disabled"><%= ClientHelper.forHTML(ClientHelper.getEmptyStringIfBlank(wert)) %></textarea></td>
                                                                      </tr>
                                                                    <% } %>
                                                                    <tr>
                                                                   <td>&nbsp;</td>
                                     ...
                                     <%
                                       }  else if (P5ExportStateP22_2Appendix.STATUS_P22_2_APPENDIX_D3 == state._modus){
                                                                                // reset export status
                                                                                admBean.resetExportStateP22_2Appendix();
                                                                                //forward to Werkmap
                                                                                String urlExp = "/osv?cmd=" + ExportP5Commands.CMD_ADM_EXPORT_P22_2_APPENDIX + "&" + ApplicationBeanKonstanten.WORK + "=" + ApplicationBeanKonstanten.EXPORT_VERZEICHNIS + "&" + ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK);
                                     %>
                                            <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                        <legend><b><ivu:int key="Export_Protocol_Appendix"/></b></legend>
                                                        ...
                                                        %>
                                                            ...
                                                            %>
                                                                <div>
                                                                    <ivu:int key="Export_Protocol_Appendix_FinalMessage_I"/>
                                                                </div>
                                                                <br />
                                                            <% }
                                                          } %>

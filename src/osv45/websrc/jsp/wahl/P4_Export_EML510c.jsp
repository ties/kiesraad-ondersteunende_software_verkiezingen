...
<%@ page import="de.ivu.wahl.admin.P4ExportStateEML510c"%><html>
...
<head>
   <title><ivu:int key="Export_P4_EML510c"/></title>
                  ...
                  <td valign="top">
                     <table width="<%= breite %>" border="0" cellspacing="0" cellpadding="0" class="hghell">
                        <tr>
                           ...
                           <td colspan="2" class="hggrau" height="20"><ivu:int key="Export_P4_titel_EML510c"/></td>
                        </tr>
                        <tr>
                               ...
                               <tr>
                                  <td valign="top">
                                    ...
                                    <% } else if (!wahlInfo.isWahlVollstaendig() || !wahlInfo.isFreigegeben()){ %>
                                      ...
                                      <% } else if (P4ExportStateEML510c.STATUS_P4_D1 == state._modus){ 
                                  
                                                    String urlExp = "/osv?cmd=" + ExportP4Commands.EXP_P4_EXPORT_P4_EML510C + "&" + ClientHelper.getAllParameters(request);
                                                   %>
                                              <table border="0" cellspacing="0" cellpadding="1" width="<%= breite %>">
                                                 <tr>
                                                    <td valign="top">
                                                      <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                        <legend><b><ivu:int key="Export_P4_EML510c"/></b></legend>
                                     ...
                                     <% 
                                    } else if (P4ExportStateEML510c.STATUS_P4_D2 == state._modus){
                                                    // reset export status
                                                    expP4Bean.resetExportStateEML510c();
                                                    //forward to Werkmap
                                                    String urlExp = "/osv?cmd=" + ExportP4Commands.EXP_P4_EXPORT_P4_EML510C + "&" + ApplicationBeanKonstanten.WORK + "=" + ApplicationBeanKonstanten.EXPORT_VERZEICHNIS + "&" + ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK);
                                        %>
                                        <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                    <legend><b><ivu:int key="Export_P4_EML510c"/></b></legend>

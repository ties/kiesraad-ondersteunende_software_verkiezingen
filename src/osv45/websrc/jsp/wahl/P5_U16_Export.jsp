                                    ...
                                    %>
                                        <table width="100%" cellspacing="0" cellpadding="1" border="0">
                                          ...
                                          <%
                                            ...
                                            if (P5ExportStateU16.STATUS_U16_D1 == state._modus){
                                          %>
                                                 <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                 <legend><b><ivu:int key="Export_U16"/></b></legend>
                                                        <p><ivu:int key="Export_U16_D1"/></p>
                                                        <%
                                                          ...
                                                          <ivu:form action="<%=formurl%>">
                                                            <table border="0" cellspacing="4" cellpadding="1" width="<%=breite%>" style="padding: 1em;">
                                                              <colgroup width="50%" span="2"></colgroup><%
                                                                List<Basiseinstellung> basiseinstellungen = Konstanten.PROP_U16_D1.get(selectedKey);
                                                        ...
                                                        <legend><b><ivu:int key="Export_Zusammenfassung"/></b></legend>
                                                           ...
                                                           <ivu:form action="<%=urlExp%>" onsubmit="transp();">
                                                            <table cellspacing="4" cellpadding="2" border="0">
                                                               <tr>
                                                                   <td colspan="2"><b><ivu:int key="Export_U16"/></b></td>
                                                                </tr>
                                                                    <%  for (Basiseinstellung basiseinstellung : Konstanten.PROP_U16_D1_BASIS) { 
                                                                         String property = basiseinstellung.getProperty();
                                     ...
                                     <% }  else if (P5ExportStateU16.STATUS_U16_D3 == state._modus){
                                            // reset export status

<%--
Weitgehend ähnliche JSP-Seiten:
...
String rechteFehler = appBean.getErrorIfRightsAreMissing(JspPage.P4_EXPORT_N11); 
...
BasiseinstellungMultiMap bmm = Konstanten.PROP_N11_D1;
WahlInfo wahlInfo = WahlInfo.getWahlInfo();
boolean legende = false;

String i18nName = "Export_P4_N11"; //$NON-NLS-1$
String i18nTitle = "Export_P4_titel_N11"; //$NON-NLS-1$
...
<head>
   ...
   <script type="text/javascript">
            ...
            $(document).ready(function(){
                $("#<%= ApplicationBeanKonstanten.PREFIX + XMLTags.RG_ORGANIZING_MUNICIPALITY %>").autocomplete(gbaData);
            });
   </script>
                                  ...
                                  <td valign="top">
                                     ...
                                     if (exportVerz == null || exportVerz.isEmpty()){ %>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="1" border="0">
                                          ...
                                          <% }
                                    if (ExportWithParametersState.STATUS_INITIAL_PAGE == p4ES._modus){  %>
                                                <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                <legend><b><ivu:int key="<%=i18nName%>"/></b></legend>
                                                    <p><ivu:int key="Export_P4_N11_D1"/></p>
                                                       ...
                                                       <tr>
                                                        <td height="20" valign="top" class="guiBefehle"><%
                                                         ...
                                                         if (selectedKey != null) {
                                                           ...
                                                           String formurl = "/osv?cmd=" + Action.EXP_P4_PROP_EINGABE_N11.getKey() + "&" + ApplicationBeanKonstanten.PREFIX + "subwork=" + subwork 
                                                         ...
                                                         break;
                                                                 ...
                                                                 case Option:
                                                                      String propCentralCounting = expP4Bean.getProperty(Konstanten.PROP_EXPORTS_FOR_CENTRAL_COUNTING);
                                                                      if (propCentralCounting == null) {
                                                                          propCentralCounting = "no_central_counting";
                                                                      } %>
                                                                      <select name="<%=ApplicationBeanKonstanten.PREFIX%>EXPORTS_FOR_CENTRAL_COUNTING">
                                                                          <option value="no_central_counting"<%= propCentralCounting.equals("no_central_counting") ? " selected=\"selected\"" : "" %>>Model N11</option>
                                                                          <option value="central_counting"<%= propCentralCounting.equals("central_counting") ? " selected=\"selected\"" : "" %>>Model II en lege bijlage 1</option>
                                                                      </select><%
                                                                      break;
                                     ...
                                     <% } else if (ExportWithParametersState.STATUS_P4_D2 == p4ES._modus){
                                            String urlExp = "/osv?cmd=" + Action.EXP_P4_EXPORT_P4_N11.getKey() + "&" + ClientHelper.getAllParameters(request);
                                                   %>
                                              <table border="0" cellspacing="0" cellpadding="1" width="<%= breite %>">
                                                 <tr>
                                                    <td valign="top">
                                                               ...
                                                               <%   for (Basiseinstellung basiseinstellung : bmm.getBasis()) { 
                                                                     ...
                                                                     <tr title="<%= basiseinstellung.getHinweis() %>">
                                                                       ...
                                                                       <td><% if (basiseinstellung.getTyp() == Typ.Textarea){ %>
                                                                            ...
                                                                            <% } else if (basiseinstellung.getTyp() == Typ.Option){ %>
                                                                            <select name="<%=ApplicationBeanKonstanten.PREFIX + Konstanten.PROP_EXPORTS_FOR_CENTRAL_COUNTING%>" disabled="disabled">
                                                                                <option value="no_central_counting"<%= "no_central_counting".equals(wert) ? " selected=\"selected\"" : "" %>>Model N11</option>
                                                                                <option value="central_counting"<%= (wert == null || "central_counting".equals(wert)) ? " selected=\"selected\"" : "" %>>Model II en lege bijlage 1</option>
                                                                            </select>
                                                                            <% } else{ %>
                                     ...
                                     <% } else if (ExportWithParametersState.STATUS_P4_D3 == p4ES._modus){
                                                    // reset export status
                                                    expP4Bean.resetExportStateN11();
                                                    //forward to Werkmap
                                                    String urlExp = "/osv?cmd=" + Action.EXP_P4_EXPORT_P4_N11.getKey() + "&" + ClientHelper.workIs(Command.EXPORT_VERZEICHNIS) + "&" + ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                                        %>
                                        <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                        <legend><b><ivu:int key="<%=i18nName%>"/></b></legend>

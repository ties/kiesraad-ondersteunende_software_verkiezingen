                  ...
                  <td valign="top">
                     <table width="<%= breite %>" border="0" cellspacing="0" cellpadding="0" class="hghell">
                        <tr>
                           ...
                           <td colspan="2" class="hggrau" height="20"><ivu:int key="Export_P4_titel_N11"/></td>
                        </tr>
                        <tr>
                                  ...
                                  <td valign="top">
                                     ...
                                     if (exportVerz == null || exportVerz.isEmpty()){ %>
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="1" border="0">
                                          ...
                                          <% }  
                                                if (P4ExportStateN11.STATUS_P4_D1 == p4ES._modus){ 
                                                    String urlExp = "/osv?cmd=expP4_exportP4_N11&" +ClientHelper.getAllParameters (request);
                                                   %>
                                              <table border="0" cellspacing="0" cellpadding="1" width="<%= breite %>">
                                                 <tr>
                                                    <td valign="top">
                                     ...
                                     <% } else if (P4ExportStateN11.STATUS_P4_D2 == p4ES._modus){
                                                    // reset export status

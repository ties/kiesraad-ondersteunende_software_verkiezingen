...
String rechteFehler = appBean.getErrorIfRightsAreMissing(JspPage.P4_EXPORT_OSV4_4); 
                                  ...
                                  <td valign="top">
                                    ...
                                    if (ExportWithParametersState.STATUS_INITIAL_PAGE == state._modus){  %>
                                     ...
                                     <% } else if (ExportWithParametersState.STATUS_P4_D2 == state._modus){
                                            String urlExp = "/osv?cmd=" + Action.EXP_P4_EXPORT_P4_OSV4_4.getKey() + "&" + ClientHelper.getAllParameters (request);
                                                   %>
                                              <table border="0" cellspacing="0" cellpadding="1" width="<%= breite %>">
                                                 <tr>
                                                    <td valign="top">
                                     ...
                                     <% } else if (ExportWithParametersState.STATUS_P4_D3 == state._modus){
                                                    ...
                                                    //forward to Werkmap
                                                    String urlExp = "/osv?cmd=" + Action.EXP_P4_EXPORT_P4_OSV4_4.getKey() + "&" + ClientHelper.workIs(Command.EXPORT_VERZEICHNIS) + "&" + ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK);
                                        %>
                                        <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                    <legend><b><ivu:int key="Export_P4_Appendix_O3"/></b></legend>

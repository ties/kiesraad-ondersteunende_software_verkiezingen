...
<%@ page import="de.ivu.wahl.admin.P4ExportStateOSV4_4"%>
        ...
        <div id="trans">
            <table width="<%= breite %>" border="0" cellspacing="0" cellpadding="0" align="center" class="hghell">
               <tr class="hgeeeeee" align="right">
                  <td><ivu:help key="ExpAppendixO3"/></td>
               </tr>
               <tr class="hgeeeeee">
                               ...
                               <tr>
                                  <td valign="top">
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="1" border="0">
                                      ...
                                      <% }                                  
                                    if (P4ExportStateOSV4_4.STATUS_P4_D1 == state._modus){  %>
                                                <fieldset style="border: 1px solid #093C69; padding: 15px">
                                     ...
                                     <% } else if (P4ExportStateOSV4_4.STATUS_P4_D2 == state._modus){
                                     ...
                                     <% } else if (P4ExportStateOSV4_4.STATUS_P4_D3 == state._modus){
                                                    // reset export status
                                                    expP4Bean.resetExportStateOSV4_4();
                                                    //forward to Werkmap
                                                    String urlExp = "/osv?cmd=" + ExportP4Commands.EXP_P4_EXPORT_P4_OSV4_4 + "&" + ApplicationBeanKonstanten.WORK + "=" + ApplicationBeanKonstanten.EXPORT_VERZEICHNIS + "&" + ClientHelper.getAllParameters(request, ApplicationBeanKonstanten.WORK);
                                        %>
                                        <fieldset style="border: 1px solid #093C69; padding: 15px">
                                                    <legend><b><ivu:int key="Export_P4_Appendix_O3"/></b></legend>

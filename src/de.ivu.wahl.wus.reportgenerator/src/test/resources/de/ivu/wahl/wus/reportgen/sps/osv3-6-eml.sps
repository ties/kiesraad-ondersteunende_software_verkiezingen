...
<structure version="16" xsltversion="1" html-doctype="HTML4 Transitional" compatibility-view="IE9" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" useimportschema="1" embed-images="1" pastemode="xml" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="D:\projekte\Eml-kiesraad\EML-v5.0-os\230-extended.xsd" workingxmlfile="D:\projekte\Eml-kiesraad\Examples\EML 230c EK2011-rg.xml"/>
		</schemasources>
	</schemasources>
	<modules>
												...
												<children>
													<template subtype="element" match="eml:Election">
														<children>
																...
																<children>
																	<condition>
																		<children>
																			<conditionbranch xpath="$lang=0">
																				<children>
																					<text fixtext="Dit document wordt om technische redenen aangemaakt."/>
																				</children>
																			</conditionbranch>
																			<conditionbranch>
																				<children>
																					<autocalc xpath="$o3-6_020_omTechnischeRedenen"/>
																				</children>
																			</conditionbranch>
																		</children>
																	</condition>
															...
															<condition>
																<children>
																	<conditionbranch xpath="$isDraft=&quot;false&quot;">
																		<children>
																			<paragraph paragraphtag="p">
																				<styles text-align="center"/>
																				<children>
																					<condition>
																						<children>
																							...
																							<conditionbranch>
																								<children>
																									<autocalc xpath="$o3-6_030_hashcode"/>
																								</children>
																							</conditionbranch>
																						</children>
																					</condition>

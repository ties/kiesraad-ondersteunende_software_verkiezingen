...
<structure version="20" xsltversion="1" html-doctype="HTML4 Transitional" compatibility-view="IE9" html-outputextent="Complete" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" useimportschema="1" embed-images="1" pastemode="xml" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="XML" main="1" schemafile="D:\projekte\Eml-kiesraad\EML-v5.0-os\510-extended.xsd" workingxmlfile="D:\projekte\EML-kiesraad\Examples-2.14\Totaaltelling_NR20160406.Wrr83.emlpp.xml"/>
		</schemasources>
	</schemasources>
	<modules>
	...
	<flags>
		...
		<designfragments>
			...
			<designfragment match="Contests" spsfile="reused-parts-simple.sps" isactive="1"/>
			...
			<designfragment match="Filter0" spsfile="reused-parts-simple.sps" isactive="1"/>
			...
			<designfragment match="LastNameH1" spsfile="reused-parts-simple.sps" isactive="1"/>
	...
	<mainparts>
		<children>
			<globaltemplate subtype="main" match="/">
				<document-properties title="Model Wrr 83"/>
				<children>
					<documentsection>
						<properties columncount="1" columngap="0.50in" headerfooterheight="variable" pagemultiplepages="0" pagenumberingformat="1" pagenumberingstartat="auto" pagestart="next" paperheight="11.69in" papermarginbottom="1.2in" papermarginfooter="0.0in" papermarginheader="0.0in" papermarginleft="1.0in" papermarginright="1.0in" papermargintop="0.9in" paperwidth="8.27in" title="Model Wrr 83"/>
						<children>
									...
									<template subtype="element" match="eml:EML">
										<children>
											<template subtype="element" match="eml:Count">
																...
																<children>
																	<template subtype="element" match="eml:ElectionCategory">
																		<children>
																			...
																			<newline/>
																			<text fixtext="Model Wrr 83">
																				<properties class="pretitle"/>
																			</text>
																			<newline/>
																			<newline/>
																			<text fixtext="Proces-verbaal van de uitslag van het referendum">
																				<properties class="title"/>
																			</text>
																			<newline/>
																			<newline/>
																			<text fixtext="Met dit formulier doet het centraal stembureau verslag van de zitting waarin de uitslag is vastgesteld van het referendum."/>
																			<newline/>
																			<newline/>
																			<calltemplate subtype="named" match="Line">
																				<parameters/>
																			...
																			<newline/>
																			<text fixtext="1. Referendum">
																				<properties class="heading"/>
																			</text>
																			<newline/>
																			<newline/>
																			<text fixtext="Het gaat om het referendum over "/>
																		</children>
																		<variables/>
																	</template>
														...
														<children>
																			...
																			<tgridrow>
																				<children>
																					...
																					<tgridcell>
																						<styles text-align="left"/>
																						<children>
																							<template subtype="element" match="rg:TimeOfMeeting">
																								<children>
																									<content subtype="regular">
																										<styles font-weight="bold"/>
															...
															<template subtype="element" match="rg:PresenceVotes">
																<children>
																				...
																				<children>
																						...
																						<children>
																							<tgridrow>
																								...
																								<children>
																									<tgridcell>
																										<children>
																											<text fixtext="Het totaal aantal stemmen "/>
																											<condition>
																												<children>
																													<conditionbranch xpath="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Voor&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;voor&quot;">
																														<children>
																															<text fixtext="voor de wet / het verdrag"/>
																														</children>
																													</conditionbranch>
																													<conditionbranch xpath="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Tegen&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;tegen&quot;">
																														<children>
																															<text fixtext="tegen de wet / het verdrag"/>
																														</children>
																													</conditionbranch>
																													<conditionbranch>
																														<children>
																															<text fixtext="voor het antwoord "/>
																					...
																					<tgridrow>
																						...
																						<children>
																							<tgridcell>
																								<styles font-size="small"/>
																								<children>
																									<text fixtext="Het totaal aantal blanco stemmen bedraagt"/>
																								</children>
																							</tgridcell>
																							<tgridcell>
																								<styles text-align="right"/>
																								<children>
																									<template subtype="element" match="rg:BlancVotes">
																										<children>
																											<content subtype="regular">
																												<format basic-type="xsd" datatype="nonNegativeInteger"/>
																											</content>
																					...
																					<tgridrow>
																						<children>
																							<tgridcell/>
																							<tgridcell>
																								<styles border-bottom-color="black" border-bottom-style="solid" border-bottom-width="1px"/>
																							</tgridcell>
																							<tgridcell>
																								<children>
																									<text fixtext="+"/>
																					...
																					<tgridrow>
																						...
																						<children>
																							<tgridcell>
																								<children>
																									<text fixtext="Het totaal aantal geldig uitgebrachte stemmen bedraagt"/>
																								</children>
																							</tgridcell>
																							<tgridcell>
																								<styles text-align="right"/>
																								<children>
																									<autocalc xpath="rg:TotalCounted + rg:BlancVotes"/>
																								</children>
																							</tgridcell>
																							<tgridcell>
																								<children>
																					...
																					<tgridrow>
																						...
																						<children>
																							<tgridcell>
																								<children>
																									<text fixtext="Het totaal aantal ongeldige stemmen bedraagt"/>
																								</children>
																							</tgridcell>
																							<tgridcell>
																								<styles text-align="right"/>
																								<children>
																									<template subtype="element" match="rg:InvalidVotes">
																										<children>
																											<content subtype="regular">
																												<format basic-type="xsd" datatype="nonNegativeInteger"/>
																											</content>
																	...
																	<newline/>
																	<text fixtext="4. Aantal kiesgerechtigden">
																		<properties class="heading"/>
																	</text>
																	<newline/>
																	<template subtype="source" match="XML">
																											...
																											<template subtype="element" match="eml:Contest">
																												<children>
																													<template subtype="element" match="eml:TotalVotes">
																														<children>
																															<newline/>
																															<text fixtext="Het totaal aantal kiesgerechtigden voor het referendum bedraagt "/>
																															...
																															<newline/>
																															<text fixtext="5. Vaststelling van de opkomst van het referendum">
																																<properties class="heading"/>
																															</text>
																															<newline/>
																															<newline/>
																															<text fixtext="Het opkomstpercentage bedraagt "/>
																															<calltemplate subtype="named" match="Fraction">
																																<parameters>
																																	<parameter name="x" value="100 * (eml:TotalCounted + eml:RejectedVotes[@ReasonCode=&quot;blanco&quot;] + eml:RejectedVotes[@ReasonCode=&quot;ongeldig&quot;])"/>
																																	<parameter name="y" value="eml:Cast"/>
																																</parameters>
																															</calltemplate>
																															<text fixtext=" %">
																																<styles font-weight="bold"/>
																	...
																	<newline/>
																	<text fixtext="6. Vaststelling van de uitslag van het referendum">
																		<properties class="heading"/>
																	</text>
																	<newline/>
																	<newline/>
																						...
																						<children>
																							<tgridrow>
																								...
																								<children>
																									<tgridcell>
																										<children>
																											<text fixtext="Van het aantal kiezers dat een "/>
																											<text fixtext="GELDIGE">
																												<styles font-weight="bold"/>
																											</text>
																											<text fixtext=" stem heeft uitgebracht, heeft"/>
																										</children>
																									</tgridcell>
																									...
																									<tgridcell>
																										<children>
																											<template subtype="element" match="rg:ValidVotes">
																																								...
																																								<children>
																																									<template subtype="element" match="eml:TotalVotes">
																																										<children>
																																											<calltemplate subtype="named" match="Fraction">
																																												<parameters>
																																													<parameter name="x" value="100 * $validVotes"/>
																																													<parameter name="y" value="eml:TotalCounted + eml:RejectedVotes[@ReasonCode=&quot;blanco&quot;]"/>
																																												</parameters>
																																											</calltemplate>
																																											<text fixtext=" %">
																																												<styles font-weight="bold"/>
																												...
																												<variables>
																													<variable name="validVotes" value="." valuetype="&lt;auto&gt;"/>
																												</variables>
																											</template>
																										</children>
																									</tgridcell>
																												...
																												<children>
																													<conditionbranch xpath="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Voor&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;voor&quot;">
																														<children>
																															...
																															<text fixtext="de wet/het verdrag gestemd."/>
																														</children>
																													</conditionbranch>
																													<conditionbranch xpath="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Tegen&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;tegen&quot;">
																														<children>
																	...
																	<newline/>
																	<text fixtext="7. Verschil tussen het aantal toegelaten kiezers en het aantal getelde stemmen">
																		<properties class="heading"/>
																	</text>
																	<newline/>
																	<newline/>
																	<paragraph>
																		<styles line-height="24pt"/>
																		<children>
																			<text fixtext="In de processen-verbaal van de stembureaus is vastgesteld in hoeverre er:">
																	...
																	<paragraph>
																		<styles line-height="24pt"/>
																		<children>
																			<text fixtext="Voor beide categorieën afzonderlijk stelt u het aantal voor het referendum vast.">
																				<styles font-style="italic"/>
																			</text>
																		</children>
																	</paragraph>
																	...
																	<newline/>
																	<text fixtext="8. Aantal kiezers dat bij volmacht mocht stemmen">
																		<properties class="heading"/>
																	</text>
																	<newline/>
																	<newline/>
																	<text fixtext="Het aantal kiezers dat mocht stemmen met een geldig volmachtbewijs (schriftelijk of via ingevulde achterkant van de stempas of kiezerspas), bedraagt "/>
																	...
																	<newline/>
																	<text fixtext="9. Bezwaren van aanwezige kiezers">
																		<properties class="heading"/>
																	</text>
																	<newline/>
																	<newline/>
																	...
																	<newline/>
																	<text fixtext="10. Geschillen">
																		<properties class="heading"/>
																	</text>
																	<newline/>
																	<newline/>
																	<text fixtext="Tijdens het onderzoeken van de geldigheid van de stemming en de juistheid van de vaststelling van de uitkomsten van de stemming door de stembureaus en de hoofdstembureaus, zijn te dien aanzien:"/>
																	<newline/>
																	<tgrid>
																		<properties border="0" cellpadding="1" cellspacing="0" width="100%"/>
																		<children>
																					...
																					<tgridrow>
																						<children>
																							...
																							<tgridcell>
																								<styles vertical-align="top"/>
																								<children>
																									<text fixtext="geen geschillen gerezen."/>
																								</children>
																							</tgridcell>
																						</children>
																					</tgridrow>
																					<tgridrow>
																						<children>
																							...
																							<tgridcell>
																								<styles vertical-align="top"/>
																								<children>
																									<text fixtext="geschillen gerezen: zie gewaarmerkte bijlage met opmerkingen van het centraal stembureau."/>
																								</children>
																							</tgridcell>
																						</children>
																					</tgridrow>
																	...
																	<newline/>
																	<text fixtext="11. Ondertekening">
																		<properties class="heading"/>
																	</text>
																	<newline/>
																	<newline/>
																	<text fixtext="Het proces-verbaal wordt ondertekend door alle aanwezige leden van het centraal stembureau.">
												...
												<variables>
													<variable name="includesPostalVotes" value="count (//eml:ElectionCategory[text() = &quot;TK&quot; or text() = &quot;EP&quot; or text() = &quot;NR&quot;]) &gt; 0 and count(eml:Election/eml:Contests/eml:Contest/eml:ContestIdentifier[@Id = 12]) &gt; 0" valuetype="xs:boolean"/>
													<variable name="isElection" value="count(//eml:ElectionCategory[.!=&quot;NR&quot; and .!=&quot;PR&quot; and .!= &quot;LR&quot;])" valuetype="xs:int"/>
												</variables>
											</template>
										</children>
										<variables/>
	...
	<designfragments>
		<children>
			<globaltemplate subtype="named" match="Fraction">
				<parameters>
					<parameter name="x" default-value="&apos;&apos;"/>
					<parameter name="y" default-value="&apos;&apos;"/>
				</parameters>
				<children>
					<autocalc xpath="floor( $x div $y )">
						<styles font-weight="bold"/>
					</autocalc>
					<condition>
						<children>
							<conditionbranch xpath="$x mod $y &gt; 0">
								<children>
									<text fixtext=" ">
										<styles font-weight="bold"/>
									</text>
									<autocalc xpath="$x mod $y">
										<styles font-weight="bold"/>
									</autocalc>
									<text fixtext="/">
										<styles font-weight="bold"/>

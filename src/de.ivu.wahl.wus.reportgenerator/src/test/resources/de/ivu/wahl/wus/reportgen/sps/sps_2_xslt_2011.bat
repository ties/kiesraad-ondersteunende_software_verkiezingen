set svb="C:\Program Files (x86)\Altova\StyleVision2014\StyleVisionBatch"
...
rem P2/P3
@rem for %%G in (I1 osv2-1 I4 osv2-6 osv2-7 osv3-1 osv3-2        osv3-4        osv3-7        ) do call %svb% -v %spsdir%\%%G-eml.sps -OutXSLRTF=%tpldir%\%%G-to-RTF.xslt
@rem for %%G in (I1        I4 osv2-6 osv2-7               osv3-3 osv3-4 osv3-6        osv3-9 ) do call %svb% -v %spsdir%\%%G-eml.sps -OutXSLFO=%tpldir%\%%G-to-FO.xslt

rem P4/P5
@rem for %%G in (N10-1 N11 O3        osv4-2 osv4-4 P22-1 P22-2 osv5-1 osv5-2 osv5-3 ) do call %svb% -v %spsdir%\%%G-eml.sps -OutXSLRTF=%tpldir%\%%G-to-RTF.xslt
@rem for %%G in (      N11 O3 osv4-1 osv4-2 osv4-4 P22-1 P22-2               osv5-3 ) do call %svb% -v %spsdir%\%%G-eml.sps -OutXSLFO=%tpldir%\%%G-to-FO.xslt
...
for %%G in (N11 O3 ) do call %svb% -v %spsdir%\%%G-eml.sps -OutXSLRTF=%tpldir%\%%G-to-RTF.xslt
for %%G in (N11 O3 ) do call %svb% -v %spsdir%\%%G-eml.sps -OutXSLFO=%tpldir%\%%G-to-FO.xslt

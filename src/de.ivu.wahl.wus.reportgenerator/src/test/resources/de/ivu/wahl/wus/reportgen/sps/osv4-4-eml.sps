	...
	<mainparts>
		<children>
			<globaltemplate subtype="main" match="/">
				<document-properties title="Model osv 4-4"/>
				<children>
					<documentsection>
						<properties columncount="1" columngap="0.50in" headerfooterheight="variable" pagemultiplepages="0" pagenumberingformat="1" pagenumberingstartat="auto" pagestart="next" paperheight="11.69in" papermarginbottom="1.2in" papermarginfooter="0.0in" papermarginheader="0.0in" papermarginleft="1.0in" papermarginright="1.0in" papermargintop="0.9in" paperwidth="8.27in" title="Model osv 4-4"/>
						<children>
																...
																<children>
																	<condition>
																		<children>
																			...
																			<conditionbranch>
																				<children>
																					<autocalc xpath="$o4-4_020_volgendeBezwaren"/>
																				</children>
																			</conditionbranch>
																		</children>
																	</condition>
																...
																<children>
																	<condition>
																		<children>
																			<conditionbranch xpath="$lang=0">
																				<children>
																					<text fixtext="Naar aanleiding van bovenstaande bezwaren merkt het hoofdstembureau het volgende op:"/>
																				</children>
																			</conditionbranch>
																			<conditionbranch>
																				<children>
																					<autocalc xpath="$o4-4_030_volgendeOpTeMerken"/>
																				</children>
																			</conditionbranch>
																		</children>
																	</condition>
																...
																<children>
																	<condition>
																		<children>
																			...
																			<conditionbranch>
																				<children>
																					<autocalc xpath="$o4-4_040_ParaafVoorzitter"/>
																				</children>
																			</conditionbranch>
																		</children>
																	</condition>
												...
												<children>
													<condition>
														<children>
															<conditionbranch xpath="$lang=0">
																<children>
																	<text fixtext="o4-4_050_Pagina"/>
																</children>
															</conditionbranch>
															<conditionbranch>
																<children>
																	<autocalc xpath="$o4-4_050_Pagina"/>
																</children>
															</conditionbranch>
														</children>
													</condition>

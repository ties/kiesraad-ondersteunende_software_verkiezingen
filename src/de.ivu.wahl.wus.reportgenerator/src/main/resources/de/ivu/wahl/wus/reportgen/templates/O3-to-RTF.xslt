            ...
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:Count">
                    ...
                    <xsl:for-each select="eml:Election">
                        <xsl:for-each select="eml:ElectionIdentifier">
                            <xsl:for-each select="eml:ElectionCategory">
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Proces-verbaal van het hoofdstembureau voor </xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>het referendum</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Met dit formulier stelt het hoofdstembureau de uitkomst vast voor een kieskring </xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:choose>
                                    <xsl:when test=". != &quot;NR&quot;">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>van de verkiezing voor </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                        <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>voor het referendum</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                        ...
                        <xsl:text>\par </xsl:text>
                        <xsl:call-template name="ChapterStemming">
                            <xsl:with-param name="isElection" select="$isElection"/>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:call-template>
                        <xsl:text>\par </xsl:text>
                    ...
                    <xsl:for-each select="rg:RG510">
                        ...
                        <xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(6801.00)"/>
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_1_0" select="round(1.39 * 1440 * $altova:TableWidthFactor_1)"/>
                        <xsl:variable name="altova:nColumnWidthTw_1_1" select="round(3.33 * 1440 * $altova:TableWidthFactor_1)"/>
                        <xsl:text>\pard\s0\f0\fs24</xsl:text>
                        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 1"/>
                        ...
                        <xsl:for-each select="rg:PresenceVotes">
                            ...
                            <xsl:choose>
                                <xsl:when test="$isElection = 1">
                                    ...
                                    <xsl:variable name="altova:nTableWidthIn_2" select="$altova:nMaxWidthIn * 0.52000"/>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(4401.00)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_2_0" select="round(2.50 * 1440 * $altova:TableWidthFactor_2)"/>
                                    <xsl:variable name="altova:nColumnWidthTw_2_1" select="round(0.56 * 1440 * $altova:TableWidthFactor_2)"/>
                                    <xsl:text>\pard\s0\f0\fs24</xsl:text>
                                    <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 1"/>
                                ...
                                <xsl:otherwise>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>3. Aantal kiesgerechtigden en stemmen</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Het aantal kiesgerechtigden bedraagt </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(7101.50)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_3_0" select="round(4.17 * 1440 * $altova:TableWidthFactor_3)"/>
                                                    ...
                                                    <xsl:for-each select="eml:Contests">
                                                        <xsl:for-each select="eml:Contest">
                                                            <xsl:for-each select="eml:TotalVotes">
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:value-of select="number(eml:TotalCounted) + number(eml:RejectedVotes[@ReasonCode=&quot;ongeldig&quot;]) + number(eml:RejectedVotes[@ReasonCode=&quot;blanco&quot;])"/>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:for-each>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>4. Verschil tussen het aantal toegelaten kiezers en het aantal getelde stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par</xsl:text>
                            ...
                            <xsl:for-each select="rg:BallotPaperNotReturned">
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_4_1 div 1440) - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>5. Aantal kiezers dat bij volmacht mocht stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>6. Bezwaren van aanwezige kiezers</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>7. Ondertekening</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:call-template name="LineBreakPdf">

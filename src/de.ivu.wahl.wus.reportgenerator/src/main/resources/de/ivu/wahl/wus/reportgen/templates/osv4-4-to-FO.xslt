                                        ...
                                        <xsl:for-each select="eml:Election">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:text>Bijlage bij proces verbaal O 3, uitkomst voor</xsl:text>
                                                    </fo:inline>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                            ...
                                            <xsl:if test="./eml:ElectionIdentifier/kr:ElectionSubcategory[text()=&quot;TK&quot; or text()=&quot;EK&quot; or text()=&quot;PS2&quot; or text()=&quot;EP&quot;]">
                                                        ...
                                                        <xsl:for-each select="eml:ContestIdentifier">
                                                            <xsl:for-each select="@Id">
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:text> de kieskring </xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                ...
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$o4-4_016_van"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:if>
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:text> de verkiezing voor </xsl:text>
                                                    </fo:inline>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:value-of select="$o4-4_017_deVerkiezingVoor"/>
                                                    </fo:inline>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                            ...
                                            <xsl:choose>
                                                ...
                                                <xsl:otherwise>
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:value-of select="$o4-4_018_op"/>
                                                    </fo:inline>
                                                </xsl:otherwise>
                                            </xsl:choose>

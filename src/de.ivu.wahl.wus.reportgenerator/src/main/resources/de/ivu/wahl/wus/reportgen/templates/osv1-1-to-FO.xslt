                                                    ...
                                                    <xsl:if test="$parameter1 = &apos;all&apos; or ($parameter1 != &apos;all&apos; and $parameter1 =@Id)">
                                                        <xsl:for-each select="@Id">
                                                            ...
                                                            <xsl:for-each select="//eml:Candidate[eml:CandidateIdentifier/@Id = $candidateId]">
                                                                ...
                                                                <fo:block font-family="Arial" font-size="medium" font-weight="bold" text-align="center" margin-right="100% - 100%" space-before="1.12em" space-after="1.12em" margin="0pt">
                                                                    <xsl:choose>
                                                                    ...
                                                                    <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                                                                        ...
                                                                        <fo:block font-family="Arial" font-size="small" line-height="22pt" text-align="center" margin-right="100% - 100%" margin="0pt"/>
                                                                    </xsl:if>
                                                                </fo:block>
                                                                <fo:block>
                                                                    <fo:leader leader-pattern="space"/>
                                                                    ...
                                                                    <fo:table-body font-family="Arial" font-size="small" start-indent="0pt">
                                                                        <xsl:variable name="altova:tablerows">
                                                                            <fo:table-row font-family="Arial" font-size="small">
                                                                                <fo:table-cell font-family="Arial" font-size="small" line-height="22pt" padding="1" display-align="before">
                                                                ...
                                                                <fo:block font-family="Arial" font-size="small" line-height="22pt" margin-right="100% - 100%" margin="0pt">
                                                                    <xsl:choose>
                                                                        <xsl:when test="$lang=0">
                                                                            <fo:inline font-family="Arial" font-size="small">
                                                                ...
                                                                <fo:table font-family="Arial" font-size="small" table-layout="fixed" width="100%" border-spacing="0">
                                                                    ...
                                                                    <fo:table-body font-family="Arial" font-size="small" start-indent="0pt">
                                                                        <xsl:variable name="altova:tablerows">
                                                                            <fo:table-row font-family="Arial" font-size="small">
                                                                                <fo:table-cell font-family="Arial" font-size="small" font-weight="bold" line-height="22pt" padding="1" display-align="before">
                                                                                    <fo:block-container overflow="hidden">
                                                                                        <fo:block text-align="left">
                                                                                            <xsl:choose>
                                                                                                <xsl:when test="$lang=0">
                                                                ...
                                                                <fo:table font-family="Arial" font-size="small" table-layout="fixed" width="300pt" border-spacing="0">
                                                                    ...
                                                                    <fo:table-body font-family="Arial" font-size="small" start-indent="0pt">
                                                                        <xsl:variable name="altova:tablerows">
                                                                            <fo:table-row font-family="Arial" font-size="small">
                                                                                <fo:table-cell font-family="Arial" font-size="small" line-height="22pt" padding="1" display-align="center">
                                                                                    <fo:block-container overflow="hidden">
                                                                                        <fo:block text-align="left">
                                                                                            <xsl:choose>
                                                                                                <xsl:when test="$lang=0">
            ...
            <fo:table-body font-family="Arial" font-size="small" start-indent="0pt">
                <xsl:variable name="altova:tablerows">
                    <fo:table-row font-family="Arial" font-size="small" height="30pt">
                        <fo:table-cell number-columns-spanned="2" font-family="Arial" font-size="small" line-height="22pt" padding="0" display-align="center">
                            <fo:block-container overflow="hidden">
                                <fo:block text-align="left"/>
                            </fo:block-container>
                        </fo:table-cell>
                    ...
                    <fo:table-row font-family="Arial" font-size="small">
                        <fo:table-cell number-columns-spanned="2" font-family="Arial" font-size="small" line-height="22pt" padding="0" display-align="after">
                            <fo:block-container overflow="hidden">
                                <fo:block text-align="left">

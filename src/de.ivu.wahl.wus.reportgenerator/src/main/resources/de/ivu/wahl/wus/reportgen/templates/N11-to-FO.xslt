                                    ...
                                    <xsl:for-each select="eml:Count">
                                        ...
                                        <xsl:for-each select="rg:RG510">
                                            ...
                                            <xsl:for-each select="rg:PostalVotes">
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="$isElection">
                                                        <fo:inline font-family="Arial" font-size="9pt" text-decoration="underline">
                                                ...
                                                <fo:block font-family="Arial" font-size="9pt" line-height="13.5pt" margin-right="100% - 100%" space-before="0" space-after="0" margin="0pt">
                                                    <fo:inline font-family="Arial" font-size="9pt" font-style="italic" line-height="13.5pt">

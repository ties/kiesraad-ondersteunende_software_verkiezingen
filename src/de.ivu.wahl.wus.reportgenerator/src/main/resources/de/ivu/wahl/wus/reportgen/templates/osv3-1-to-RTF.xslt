...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype ds eml fn iso4217 ix java kr link rg sps ts xal xbrldi xbrli xlink xnl xs xsi">
    ...
    <xsl:template match="/">
        ...
        <xsl:text>{\s1\f0\fs24\sl0\fs26\snext0 Paragraph;}</xsl:text>
        ...
        <xsl:text>{\s16\sl0\fs26\snext0 div;}</xsl:text>
        <xsl:text>{\s17\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s18\sl0\fs26\b\snext0 h4;}</xsl:text>
        <xsl:text>{\s21\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s22\sl0\fs26\b\snext0 h4;}</xsl:text>
        <xsl:text>{\s101\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s183\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s184\sl0\snext0 p;}</xsl:text>
        <xsl:text>{\s327\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s332\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s348\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s398\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s399\sl0\snext0 p;}</xsl:text>
        <xsl:text>{\s400\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s401\sl0\snext0 p;}</xsl:text>
        <xsl:text>{\s402\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s403\sl0\snext0 p;}</xsl:text>
        ...
        <xsl:text>{\*\cs59\f1\snext0 Character *;}</xsl:text>
        ...
        <xsl:text>{\*\cs346\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs347\f1\snext0 Character *;}</xsl:text>
        ...
        <xsl:text>{\*\cs423\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs424\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs425\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs426\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs427\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs428\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs429\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs430\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs431\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs432\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs433\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs434\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs435\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs436\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs437\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs438\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs439\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs440\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs441\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs442\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs443\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs444\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs445\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs446\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs447\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs448\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs449\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs450\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs451\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs452\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs453\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs454\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs455\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs456\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs457\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs458\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs459\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs460\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs461\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs464\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs465\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs466\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs467\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs468\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs469\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs470\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs471\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs472\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs473\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs474\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs475\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs476\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs477\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs478\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs479\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs480\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs481\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs482\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs483\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs484\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs485\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs486\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs487\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\cs488\f1\snext0 Character *;}</xsl:text>
        <xsl:text>{\*\ts187\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts188\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts462\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts463\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>}</xsl:text>
    ...
    <xsl:template name="altova:DocumentSection_0">
        ...
        <xsl:text>\s1\f0\fs24\sl0\fs26\s15\s16\sl0\f1\fs26 </xsl:text>
        <xsl:for-each select="$XML">
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:CandidateList">
                    ...
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 0"/>
                    <xsl:text>\s1\f0\fs24\sl0\fs26\s15\s16\sl0\f1\fs26\s11\f1\fs22\b\sl0\fs26\b\s17\s18\qc\sl0\f1\fs26\b </xsl:text>
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs19\f1\fs18 </xsl:text>
                        ...
                        <xsl:otherwise>
                            <xsl:text>{\cs20\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_010_centralStembureau"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 0"/>
                    <xsl:text>\par\s1\f0\fs24\sl0\fs26\s15\s16\sl0\f1\fs26 </xsl:text>
                    ...
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 0"/>
                    <xsl:text>\s1\f0\fs24\sl0\fs26\s15\s16\sl0\f1\fs26\s11\f1\fs22\b\sl0\fs26\b\s21\s22\sl0\f1\fs26\b </xsl:text>
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs23\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Nummering kandidatenlijsten en geldige lijstencombinaties voor de verkiezing van </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:text>{\cs24\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_020_title"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:for-each select="eml:Election">
                        ...
                        <xsl:text>{\cs25\f1\fs26\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text> </xsl:text>
                            </xsl:with-param>
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs26\f1\fs18\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="substring(eml:ElectionIdentifier/kr:ElectionDate, 0, 5)"/>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                    </xsl:for-each>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs27\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>In de openbare zitting van </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:text>{\cs28\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_030_1_nummersToegekend"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs29\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> heeft het centraal stembureau voor de verkiezing van de leden van </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:text>{\cs30\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_030_2_nummersToegekend"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:if test="//eml:ElectionCategory[ text() = &apos;TK&apos; or text() = &apos;EP&apos; ]">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs31\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text> (de Kiesraad)</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:text>{\cs32\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$o3-1_030_3_nummersToegekend"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs33\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> aan de kandidatenlijsten die zijn ingediend op </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:text>{\cs34\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_030_4_nummersToegekend"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs35\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                        ...
                        <xsl:otherwise>
                            <xsl:text>{\cs36\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_030_5_nummersToegekend"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs37\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>, de volgende nummers toegekend:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:text>{\cs38\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_030_6_nummersToegekend"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:text>\par </xsl:text>
                    <xsl:for-each select="rg:RG230c">
                        <xsl:for-each select="rg:NumberedCandidateList">
                            <xsl:sort select="rg:CandidateListName/eml:AffiliationIdentifier/@Id" data-type="number" order="ascending"/>
                            <xsl:for-each select="rg:CandidateListName">
                                <xsl:for-each select="eml:AffiliationIdentifier">
                                    <xsl:for-each select="@Id">
                                        <xsl:text>{\cs39\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                        ...
                                        <xsl:text>}</xsl:text>
                                        <xsl:text>{\cs40\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>.</xsl:text>
                                            </xsl:with-param>
                                ...
                                <xsl:text>{\cs41\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text> </xsl:text>
                                    </xsl:with-param>
                                ...
                                <xsl:choose>
                                    <xsl:when test="./eml:AffiliationIdentifier/eml:RegisteredName[text() != &quot;&quot;]">
                                        <xsl:for-each select="eml:AffiliationIdentifier">
                                            <xsl:for-each select="eml:RegisteredName">
                                                <xsl:text>{\cs42\f1\fs18 </xsl:text>
                                                <xsl:apply-templates>
                                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                                </xsl:apply-templates>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <xsl:text>{\cs43\f1\fs18 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                            ...
                                            <xsl:otherwise>
                                                <xsl:text>{\cs44\f1\fs18 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o3-1_040_BlancoLijst"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:for-each select="rg:FirstCandidateName">
                                            ...
                                            <xsl:for-each select="xnl:PersonName">
                                                <xsl:if test="xnl:NameLine/@NameType = &apos;Initials&apos;">
                                                    <xsl:text>{\cs45\f1\fs18 </xsl:text>
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>,</xsl:text>
                                                        </xsl:with-param>
                                                    ...
                                                    <xsl:for-each select="xnl:NameLine">
                                                        <xsl:if test="@NameType  = &apos;Initials&apos;">
                                                            <xsl:text>{\cs46\f1\fs18 </xsl:text>
                                                            <xsl:apply-templates>
                                                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                                            </xsl:apply-templates>
                    ...
                    <xsl:choose>
                        <xsl:when test="rg:RG230c/rg:CombinedList[@valid=&quot;true&quot;]">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs47\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Tevens heeft het centraal stembureau de volgende lijstencombinaties geldig verklaard:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:text>{\cs48\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$o3-1_050_lijstencombinatiesGeldig"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:otherwise>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs49\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Er zijn geen lijstencombinaties geldig verklaard.</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:text>{\cs50\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$o3-1_060_geenLijstencombinatiesGeldig"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:otherwise>
                    ...
                    <xsl:for-each select="rg:RG230c">
                        <xsl:for-each select="rg:CombinedList">
                            ...
                            <xsl:if test="./@valid = &quot;true&quot;">
                                <xsl:for-each select="@id">
                                    <xsl:text>{\cs51\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="string(.)"/>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs52\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>. </xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:call-template name="CombinedList2">
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:call-template>
                                <xsl:text>\par </xsl:text>
                                <xsl:text>\par </xsl:text>
                                <xsl:if test="$SV_OutputFormat = &apos;RTF&apos; and   position() != count(  .. /rg:CombinedList )">
                                    <xsl:text>\par </xsl:text>
                                    <xsl:text>\par </xsl:text>
                                </xsl:if>
                            </xsl:if>
                    ...
                    <xsl:choose>
                        <xsl:when test="rg:RG230c/rg:CombinedList[@valid=&quot;false&quot;]">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs53\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Tevens heeft het centraal stembureau de volgende lijstencombinaties ongeldig verklaard:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:text>{\cs54\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$o3-1_070_lijstencombinatiesOngeldig"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:otherwise>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs55\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Er zijn geen lijstencombinaties ongeldig verklaard.</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xsl:text>{\cs56\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$o3-1_080_geenLijstencombinatiesOngeldig"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:otherwise>
                    ...
                    <xsl:for-each select="rg:RG230c">
                        <xsl:for-each select="rg:CombinedList">
                            ...
                            <xsl:if test="./@valid = &quot;false&quot;">
                                <xsl:for-each select="@id">
                                    <xsl:text>{\cs57\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="string(.)"/>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs58\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>. </xsl:text>
                                        </xsl:with-param>
                    ...
                    <xsl:for-each select="rg:RG230c">
                        <xsl:for-each select="rg:P3PublicationSignature">
                            <xsl:for-each select="rg:Place">
                                <xsl:text>{\cs59\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:apply-templates>
                            ...
                            <xsl:text>{\cs60\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>, </xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:for-each select="rg:RG230c">
                        <xsl:for-each select="rg:P3PublicationSignature">
                            <xsl:for-each select="rg:Name">
                                <xsl:text>{\cs61\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:apply-templates>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs62\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                        ...
                        <xsl:otherwise>
                            <xsl:text>{\cs63\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o3-1_090_voorzitter"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
    ...
    <xsl:template name="ElectionName">
        ...
        <xsl:if test="0=1">
            <xsl:text>{\cs64\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
        ...
        <xsl:choose>
            <xsl:when test="$lang=0">
                <xsl:text>{\cs65\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
            ...
            <xsl:otherwise>
                <xsl:text>{\cs66\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
        ...
        <xsl:for-each select="eml:ElectionIdentifier">
            <xsl:choose>
                <xsl:when test="$lang=0">
                    <xsl:text>{\cs67\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                ...
                <xsl:otherwise>
                    <xsl:text>{\cs68\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
    ...
    <xsl:template name="ElectionNameShort">
        ...
        <xsl:param name="isBold" select="0"/>
        <xsl:if test="0=1">
            <xsl:text>{\cs69\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
    ...
    <xsl:template name="ElectionNameAcceptance">
        ...
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:if test="0=1">
            <xsl:text>{\cs70\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
            ...
            <xsl:for-each select="eml:ElectionCategory">
                <xsl:choose>
                    <xsl:when test=".= &quot;TK&quot; or .= &quot;EP&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs71\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs72\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;EK&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs73\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs74\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;PS&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs75\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs76\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;GR&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs77\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs78\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;BC&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs79\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs80\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;GC&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs81\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs82\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;ER&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs83\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs84\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
    ...
    <xsl:template name="Salutation">
        ...
        <xsl:if test="$isBold=0">
            <xsl:if test="0=1">
                <xsl:text>{\cs85\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
            ...
            <xsl:for-each select="eml:Gender">
                <xsl:choose>
                    <xsl:when test=".=&quot;male&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs86\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs87\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;female&quot; or .=&quot;unknown&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs88\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs89\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
        ...
        <xsl:if test="$isBold=1">
            <xsl:if test="0=1">
                <xsl:text>{\cs90\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text>Salutation &quot;Mr. &quot; or &quot;Mrs. &quot; with subsequent blank</xsl:text>
                    </xsl:with-param>
            ...
            <xsl:for-each select="eml:Gender">
                <xsl:choose>
                    <xsl:when test=".=&quot;male&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs91\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>dhr. </xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs92\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Salutation_dhr"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test=".=&quot;female&quot; or .=&quot;unknown&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs93\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>mevr. </xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs94\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Salutation_mevr"/>
                                    </xsl:with-param>
    ...
    <xsl:template name="PartyName">
        ...
        <xsl:choose>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs97\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                ...
                <xsl:if test="$isBold=1">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs99\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>niet van toepassing (blanco lijst)</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs100\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_PartyName_blancoLijst"/>
                                        </xsl:with-param>
            ...
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s7\f1\fs24\s101\sl0\f1\fs18 </xsl:text>
                <xsl:if test="$isBold=0">
                    <xsl:choose>
                        <xsl:when test="./eml:AffiliationIdentifier/eml:RegisteredName[text() != &quot;&quot;]">
                            <xsl:for-each select="eml:AffiliationIdentifier">
                                <xsl:for-each select="eml:RegisteredName">
                                    <xsl:text>{\cs102\f1\fs18 </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs103\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>niet van toepassing (blanco lijst)</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs104\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_PartyName_blancoLijst"/>
                                        </xsl:with-param>
                ...
                <xsl:if test="$isBold=1">
                    <xsl:choose>
                        <xsl:when test="./eml:AffiliationIdentifier/eml:RegisteredName[text() != &quot;&quot;]">
                            <xsl:for-each select="eml:AffiliationIdentifier">
                                <xsl:for-each select="eml:RegisteredName">
                                    <xsl:text>{\cs105\f1\fs18\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs106\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>niet van toepassing (blanco lijst)</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs107\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_PartyName_blancoLijst"/>
                                        </xsl:with-param>
    ...
    <xsl:template name="LastNameH1">
        ...
        <xsl:if test="0=1">
            <xsl:text>{\cs108\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
        ...
        <xsl:if test="$fontSize=&apos;normal&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NamePrefix">
                        <xsl:text>{\cs109\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NamePrefix">
                        <xsl:text>{\cs111\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:LastName">
                        <xsl:text>{\cs112\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
        ...
        <xsl:if test="$fontSize=&apos;smaller&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NamePrefix">
                        <xsl:text>{\cs113\f1\fs20 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:LastName">
                        <xsl:text>{\cs114\f1\fs20 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    ...
                    <xsl:for-each select="xnl:LastName">
                        <xsl:text>{\cs116\f1\fs20\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
        ...
        <xsl:if test="$fontSize=&apos;x-small&apos;">
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NamePrefix">
                        <xsl:text>{\cs119\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
    ...
    <xsl:template name="FirstNameH1">
        ...
        <xsl:param name="fontSize" select="&apos;normal&apos;"/>
        <xsl:if test="0=1">
            <xsl:text>{\cs121\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
        ...
        <xsl:if test="$fontSize=&apos;normal&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NameLine">
                        <xsl:text>{\cs122\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        <xsl:text>{\cs123\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>(</xsl:text>
                            </xsl:with-param>
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs124\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs125\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NameLine">
                        <xsl:text>{\cs126\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        <xsl:text>{\cs127\f1\fs18\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>(</xsl:text>
                            </xsl:with-param>
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs128\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs129\f1\fs18\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
            ...
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xnl:PersonName">
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs132\f1\fs20 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs133\f1\fs20 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs136\f1\fs20\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs137\f1\fs20\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
            ...
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xnl:PersonName">
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs140\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs141\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs144\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs145\f1\fs18\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
    ...
    <xsl:template name="Gender">
        ...
        <xsl:param name="fontSize" select="&apos;normal&apos;"/>
        <xsl:if test="0=1">
            <xsl:text>{\cs146\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            <xsl:when test=".=&quot;male&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs147\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (m)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs148\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            <xsl:when test=".=&quot;male&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs153\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (m)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs154\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_m"/>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs163\f1\fs20 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs169\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs170\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs175\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs176\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs181\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs182\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
        ...
        <xsl:for-each select="eml:ElectionIdentifier">
            <xsl:for-each select="kr:ElectionSubcategory">
                <xsl:if test=".=&quot;TK&quot; or .=&quot;EK&quot; or .=&quot;PS2&quot;">
                    ...
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 0"/>
                    <xsl:text>\s0\f0\fs24\sl0\s183\s184\sl0\f1\fs18 </xsl:text>
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                        ...
                        <xsl:otherwise>
                            <xsl:text>{\cs186\f1\fs18\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                    ...
                    <xsl:variable name="altova:nTableWidthIn_0" select="$altova:nMaxWidthIn * 0.90000"/>
                    ...
                    <xsl:variable name="altova:nSumColumnWidthsTw_0" select="round(0.00 + 1.03 * $altova:nTableWidthTw_0)"/>
                    ...
                    <xsl:variable name="altova:nColumnWidthTw_0_0" select="round($altova:nTableWidthTw_0 * 0.03 * $altova:TableWidthFactor_0)"/>
                    <xsl:variable name="altova:nColumnWidthTw_0_1" select="round($altova:nTableWidthTw_0 * 1.00 * $altova:TableWidthFactor_0)"/>
                    <xsl:text>\pard</xsl:text>
                    ...
                    <xsl:variable name="tablestyle0">
                        ...
                        <xsl:text>\ts187\ts188\trpaddt0\trpaddl0\trpaddb0\trpaddr0\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                    </xsl:variable>
                    ...
                    <xsl:text>{\cs189\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>*)</xsl:text>
                        </xsl:with-param>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <xsl:text>{\cs190\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                        ...
                        <xsl:otherwise>
                            <xsl:text>{\cs191\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
        ...
        <xsl:if test="$fontSize = &apos;normal&apos;">
            <xsl:if test="$isBold=0">
                <xsl:if test="substring(text(),9, 1) != &quot;0&quot;">
                    <xsl:text>{\cs192\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                ...
                <xsl:text>{\cs193\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs194\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:choose>
                    <xsl:when test="substring(text(),6, 2) = &quot;01&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs195\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs196\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;02&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs197\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs198\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;03&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs199\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs200\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;04&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs201\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs202\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;05&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs203\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs204\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;06&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs205\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs206\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;07&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs207\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs208\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;08&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs209\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs210\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;09&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs211\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs212\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;10&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs213\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs220\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
            ...
            <xsl:if test="$isBold=1">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;02&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs226\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>februari</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs227\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_februari"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;03&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs228\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>maart</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs229\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_maart"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;04&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs230\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>april</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs231\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_april"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;05&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs232\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>mei</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs233\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_mei"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;06&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs234\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juni</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs235\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_juni"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;07&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs236\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juli</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs237\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_juli"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;08&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs238\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>augustus</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs239\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_augustus"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;09&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs240\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>september</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs241\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_september"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs247\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_december"/>
                                    </xsl:with-param>
                ...
                <xsl:text>{\cs248\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs249\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="substring(text(),1, 4)"/>
                    </xsl:with-param>
            ...
            <xsl:if test="$isBold=0">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;11&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs273\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>november</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs274\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_november"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs275\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>december</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs276\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_december"/>
                                    </xsl:with-param>
                ...
                <xsl:text>{\cs277\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs278\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="substring(text(),1, 4)"/>
                    </xsl:with-param>
            ...
            <xsl:if test="$isBold=1">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;11&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs302\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>november</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs303\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_november"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs304\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>december</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs305\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_december"/>
                                    </xsl:with-param>
                ...
                <xsl:text>{\cs306\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs307\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="substring(text(),1, 4)"/>
                    </xsl:with-param>
    ...
    <xsl:template name="GenerateDate">
        <xsl:param name="altova:nMaxWidthIn" select="7.06944"/>
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:text>{\cs308\f1\fs16 </xsl:text>
        <xsl:call-template name="write-text">
            <xsl:with-param name="text">
    ...
    <xsl:template name="HashCode">
        <xsl:param name="altova:nMaxWidthIn" select="7.06944"/>
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:text>{\cs309\f1\fs16 </xsl:text>
        <xsl:call-template name="write-text">
            <xsl:with-param name="text">
    ...
    <xsl:template name="FooterWithHashcode">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        <xsl:text>{\cs316\f1\fs16 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
    ...
    <xsl:template name="CombinedListNames">
        ...
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 0"/>
        <xsl:text>\s7\f1\fs24\s327\sl0\f1\fs18 </xsl:text>
        <xsl:for-each select="rg:CandidateListName">
            <xsl:if test="position() != 1">
                <xsl:choose>
                    <xsl:when test="$lang=0">
    ...
    <xsl:template name="PartyName2">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;RTF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s7\f1\fs24\s332\sl0\f1\fs18 </xsl:text>
                <xsl:choose>
                    <xsl:when test="./eml:AffiliationIdentifier/eml:RegisteredName[text() != &quot;&quot;]">
                        <xsl:for-each select="eml:AffiliationIdentifier">
                            <xsl:for-each select="eml:RegisteredName">
            ...
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs339\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>blanco lijst met als eerste kandidaat</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs340\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_PartyName2_blancoLijst"/>
                                    </xsl:with-param>
                        ...
                        <xsl:text>{\cs341\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text> </xsl:text>
                            </xsl:with-param>
    ...
    <xsl:template name="PartyNameOrFirstCandidate">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s7\f1\fs24\s348\sl0\f1\fs18 </xsl:text>
                <xsl:for-each select="rg:CandidateListName">
                    <xsl:choose>
                        <xsl:when test="./eml:AffiliationIdentifier/eml:RegisteredName[text()!=&quot;&quot;]">
                            <xsl:for-each select="eml:AffiliationIdentifier">
                                <xsl:for-each select="eml:RegisteredName">
                                    <xsl:text>{\cs349\f1\fs18 </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                        ...
                        <xsl:otherwise>
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs350\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>blanco lijst met als eerste kandidaat </xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs351\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_PartyNameOrFirstCandidate_blancoLijst"/>
                                        </xsl:with-param>
                            ...
                            <xsl:for-each select="rg:FirstCandidateName">
                                ...
                                <xsl:text>{\cs352\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>,</xsl:text>
                                    </xsl:with-param>
    ...
    <xsl:template name="ElectionNameSimple">
        ...
        <xsl:param name="isBold" select="0"/>
        <xsl:if test="0=1">
            <xsl:text>{\cs353\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
            ...
            <xsl:for-each select="eml:ElectionCategory">
                <xsl:choose>
                    <xsl:when test=".=&quot;EP&quot; or .=&quot;BC&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs354\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs355\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:otherwise>
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs356\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs357\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                ...
                <xsl:if test="$isBold=0">
                    <xsl:choose>
                        <xsl:when test=".= &quot;TK&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs358\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs359\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                        ...
                        <xsl:when test=".=&quot;EK&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs360\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs361\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                        ...
                        <xsl:when test=".=&quot;PS&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs362\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>provinciale staten van</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs363\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                        ...
                        <xsl:when test=".=&quot;EP&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs364\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                        ...
                        <xsl:when test=".=&quot;GC&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs372\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                    ...
                    <xsl:choose>
                        <xsl:when test=".= &quot;TK&quot;">
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs375\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_tweedeKamer"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;EK&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs376\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Eerste Kamer der Staten-Generaal</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs377\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_eersteKamer"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;PS&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs378\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs379\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_provincialeStaten"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;EP&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs380\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Europees Parlement</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs381\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_hetEuropeesParlement"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;GR&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs382\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>gemeenteraad</xsl:text>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;ER&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs384\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>eilandsraad</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs385\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_eilandsraad"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;BC&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs386\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>algemeen bestuur van de bestuurscommissie</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs387\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_bestuurscommissie"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;GC&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs388\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>gebiedscommissie</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs389\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_gebiedscommissie"/>
                                        </xsl:with-param>
                ...
                <xsl:choose>
                    <xsl:when test=".=&quot;PS&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs390\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs391\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;GR&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs392\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text> van</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs393\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameSimple_van"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test=".=&quot;ER&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs394\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs395\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test=".=&quot;BC&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs396\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs397\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
    ...
    <xsl:template name="LineBreak">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\s398\s399\sl0\f1\fs18 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="SmallLineBreak">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\s400\s401\sl0\f1\fs18 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="LineBreakTable">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\s402\s403\sl0\f1\fs18 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="KieskringParty">
        ...
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:if test="0=1">
            <xsl:text>{\cs404\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
        ...
        <xsl:choose>
            <xsl:when test="eml:ContestIdentifier/@Id = &quot;alle&quot;">
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        <xsl:text>{\cs405\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                    ...
                    <xsl:otherwise>
                        <xsl:text>{\cs406\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
            ...
            <xsl:when test="eml:ContestIdentifier">
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        <xsl:text>{\cs407\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                    ...
                    <xsl:otherwise>
                        <xsl:text>{\cs408\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                ...
                <xsl:text>{\cs409\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
    ...
    <xsl:template name="ElectionDomain">
        ...
        <xsl:if test="0=1">
            <xsl:text>{\cs410\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
                ...
                <xsl:choose>
                    <xsl:when test="./eml:ElectionCategory[text()=&quot;PS&quot; or text()=&quot;GR&quot; or text()=&quot;ER&quot;]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:text>{\cs411\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs412\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                        ...
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:choose>
                                <xsl:when test=". != &quot;Rotterdam - Centrum&quot;  and  . != &quot;Rotterdam - Pernis&quot;">
                                    <xsl:text>{\cs413\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs414\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs415\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
        ...
        <xsl:if test="$isBold=1 and $font-size=&apos;small&apos;">
            <xsl:for-each select="eml:ElectionIdentifier">
                <xsl:choose>
                    <xsl:when test="./eml:ElectionCategory[text()=&quot;PS&quot; or text()=&quot;GR&quot; or text()=&quot;ER&quot;]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:text>{\cs417\f1\fs18\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs418\f1\fs18\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                    ...
                    <xsl:when test="./eml:ElectionCategory[ text()=&quot;BC&quot; or text()=&quot;GC&quot; ]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:choose>
                                <xsl:when test=". != &quot;Rotterdam - Centrum&quot;  and  . != &quot;Rotterdam - Pernis&quot;">
                                    <xsl:text>{\cs419\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
        ...
        <xsl:if test="$isBold=1 and $font-size=&apos;medium&apos;">
            <xsl:for-each select="eml:ElectionIdentifier">
                <xsl:choose>
                    <xsl:when test="./eml:ElectionCategory[text()=&quot;PS&quot; or text()=&quot;GR&quot; or text()=&quot;ER&quot;]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:text>{\cs423\f1\fs26\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs424\f1\fs26\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                    ...
                    <xsl:when test="./eml:ElectionCategory[ text()=&quot;BC&quot; or text()=&quot;GC&quot; ]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:choose>
                                <xsl:when test=". != &quot;Rotterdam - Centrum&quot;  and  . != &quot;Rotterdam - Pernis&quot;">
                                    <xsl:text>{\cs425\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs426\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="substring( text() , 13 )"/>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs427\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs428\f1\fs26\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
    ...
    <xsl:template name="ContestIdentifier">
        ...
        <xsl:if test="$fontSize = &apos;normal&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="eml:ContestIdentifier">
                    ...
                    <xsl:for-each select="eml:ContestName">
                        <xsl:text>{\cs431\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="eml:ContestIdentifier">
                    <xsl:for-each select="@Id">
                        <xsl:text>{\cs433\f1\fs18\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="string(.)"/>
                            </xsl:with-param>
                    ...
                    <xsl:text>{\cs434\f1\fs18\b </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text> (</xsl:text>
                        </xsl:with-param>
                    ...
                    <xsl:text>}</xsl:text>
                    <xsl:for-each select="eml:ContestName">
                        <xsl:text>{\cs435\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:text>{\cs436\f1\fs18\b </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>)</xsl:text>
                        </xsl:with-param>
        ...
        <xsl:if test="$fontSize = &apos;medium&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="eml:ContestIdentifier">
                    <xsl:for-each select="@Id">
                        <xsl:text>{\cs437\f1\fs26 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="string(.)"/>
                            </xsl:with-param>
                    ...
                    <xsl:text>{\cs438\f1\fs26 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text> (</xsl:text>
                        </xsl:with-param>
                    ...
                    <xsl:text>}</xsl:text>
                    <xsl:for-each select="eml:ContestName">
                        <xsl:text>{\cs439\f1\fs26 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:text>{\cs440\f1\fs26 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>)</xsl:text>
                        </xsl:with-param>
    ...
    <xsl:template name="Space">
        ...
        <xsl:choose>
            <xsl:when test="$fontSize=&quot;normal&quot;">
                <xsl:text>{\cs441\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="&apos; &apos;"/>
                    </xsl:with-param>
            ...
            <xsl:when test="$fontSize=&apos;x-small&apos;">
                <xsl:text>{\cs443\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="&apos; &apos;"/>
                    </xsl:with-param>
            ...
            <xsl:otherwise>
                <xsl:text>{\cs444\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="&apos; &apos;"/>
                    </xsl:with-param>
    ...
    <xsl:template name="CombinedList2">
        ...
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:if test="0=1">
            <xsl:text>{\cs445\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
        ...
        <xsl:for-each select="rg:CandidateListName">
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <xsl:text>{\cs449\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
            ...
            <xsl:text>{\cs450\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
                    <xsl:text>) </xsl:text>
                </xsl:with-param>
        ...
        <xsl:for-each select="eml:AffiliationIdentifier">
            <xsl:choose>
                <xsl:when test="@Id != 0 and @Id != &quot;&quot;">
                    <xsl:for-each select="@Id">
                        <xsl:text>{\cs451\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="string(.)"/>
                            </xsl:with-param>
                ...
                <xsl:otherwise>
                    <xsl:text>{\cs452\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>   </xsl:text>
                        </xsl:with-param>
    ...
    <xsl:template name="Line">
        ...
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
            <xsl:text>{\cs458\f1\fs22 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
        ...
        <xsl:text>{\cs459\f1\fs22 </xsl:text>
        <xsl:call-template name="write-text">
            <xsl:with-param name="text">
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="tablestyle1">
            ...
            <xsl:text>\ts462\ts463\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
        </xsl:variable>
        ...
        <xsl:if test="$isPagenumber=1">
            ...
            <xsl:text>}</xsl:text>
            <xsl:text>{\field{\*\fldinst{\cs468\f1\fs18 NUMPAGES }}{\fldrslt }}</xsl:text>
        </xsl:if>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend1"/>
        <xsl:if test="$templatetablelevel + 1 > 1">
                ...
                <xsl:for-each select="kr:Contests">
                    <xsl:for-each select="kr:Contest">
                        ...
                        <xsl:if test="$isBold = 1">
                            <xsl:choose>
                                <xsl:when test="$separator=&apos;comma&apos; and position()!=last()">
                                    <xsl:text>{\cs478\f1\fs18\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs479\f1\fs18\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>, </xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:when test="$separator=&apos;newline&apos;">
                                    <xsl:text>{\cs480\f1\fs18\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs481\f1\fs18\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                        ...
                        <xsl:if test="$isBold = 0">
                            <xsl:choose>
                                <xsl:when test="$separator=&apos;comma&apos; and position()!=last()">
                                    <xsl:text>{\cs482\f1\fs18 </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs483\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>, </xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:when test="$separator=&apos;newline&apos;">
                                    <xsl:text>{\cs484\f1\fs18 </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs485\f1\fs18 </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
    ...
    <xsl:template name="Filter0">
        ...
        <xsl:choose>
            <xsl:when test="text() = &quot;0&quot;">
                <xsl:text>{\cs486\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">

                                        ...
                                        <xsl:for-each select="eml:Election">
                                            ...
                                            <fo:block font-family="Arial" font-size="medium" font-weight="bold" margin-right="100% - 100%" space-before="1.12em" space-after="1.12em" margin="0pt">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial">
                                                            <xsl:value-of select="$o3-6_010_Voor"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            ...
                                            <fo:block font-family="Arial" text-align="center" margin-right="100% - 100%" margin="0pt">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial">
                                                            <xsl:value-of select="$o3-6_020_omTechnischeRedenen"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </fo:block>
                                            <xsl:if test="$isDraft=&quot;false&quot;">
                                                ...
                                                <fo:block font-family="Arial" text-align="center" margin-right="100% - 100%" margin="0pt">
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            <fo:inline font-family="Arial">
                                                                <xsl:text>De SHA1 hashcode van het EML 230c bestand genaamd Totaallijsten is</xsl:text>
                                                            </fo:inline>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial">
                                                                <xsl:value-of select="$o3-6_030_hashcode"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                </fo:block>

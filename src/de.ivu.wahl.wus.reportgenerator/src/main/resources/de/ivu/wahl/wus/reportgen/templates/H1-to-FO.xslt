                            ...
                            <xsl:for-each select="$XML">
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Nomination">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:text>Model H 1</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:value-of select="$H1_010_pretitle"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:text>Kandidatenlijst</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:value-of select="$H1_010_title"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>Met dit formulier stelt u, als inleveraar van de kandidatenlijst, kandidaten verkiesbaar voor een verkiezing.</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H1_020_MetDitFormulier"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <fo:block/>
                                        <xsl:if test="eml:ElectionIdentifier/kr:ElectionSubcategory[ text() = &quot;TK&quot; or text() = &quot;EK&quot; or text() = &quot;PS2&quot; ]">
                                            <fo:block>
                                                <fo:leader leader-pattern="space"/>
                                            </fo:block>
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:text>De kandidatenlijst wordt ingeleverd voor:</xsl:text>
                                                    </fo:inline>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:value-of select="$H1_022_kandidatenlijstWordtIngeleverd"/>
                                                    </fo:inline>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                            <fo:block/>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="eml:ContestIdentifier[@Id != &quot;alle&quot;]">
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:text>de volgende kieskring(en): </xsl:text>
                                                            </fo:inline>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:value-of select="$H1_024_volgendeKieskringen"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                    <xsl:choose>
                                                ...
                                                <xsl:otherwise>
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                                                                <xsl:value-of select="$H1_026_alleKieskringen"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                </xsl:otherwise>
                                        ...
                                        <xsl:call-template name="Line"/>
                                        <fo:block/>
                                        <xsl:call-template name="ChapterPartyName"/>
                                        <fo:block/>
                                        <xsl:call-template name="Line"/>
                                        <fo:block/>
                                        <fo:block>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H1_030_KandidatenOpDeLijst"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:call-template name="CandidatesOnListTable">
                                            <xsl:with-param name="showDateOfBirth" select="1"/>
                                        </xsl:call-template>
                                        <xsl:call-template name="Line"/>
                                        <fo:block/>
                                        <fo:block>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Vervanger(s) voor het herstel van verzuimen</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H1_040_Vervangers"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:if test="count(eml:Nominate/eml:Proposer/eml:JobTitle[text()=&quot;plaatsvervanger van de inleveraar&quot;]) = 0">
                                            <xsl:call-template name="AgentEmpty"/>
                                        </xsl:if>
                                        <fo:block/>
                                        <xsl:for-each select="eml:Nominate">
                                            <xsl:for-each select="eml:Proposer[eml:JobTitle[text()=&quot;plaatsvervanger van de inleveraar&quot;]]">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Gemachtigde voor het verbinden van de lijst tot een lijstencombinatie</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H1_050_GemachtigdeVoorLijstencombinatie"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt" font-style="italic">
                                                    <xsl:value-of select="$H1_060_nietEK"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:if test="count(eml:Nominate/eml:Proposer/eml:JobTitle[text()=&quot;gemachtigde voor het aangaan van lijstencombinaties&quot;]) = 0 and //eml:ElectionCategory[ text() != &quot;EK&quot; ]">
                                            <xsl:call-template name="AgentEmpty"/>
                                        </xsl:if>
                                        <fo:block/>
                                        <xsl:for-each select="eml:Nominate">
                                            <xsl:for-each select="eml:Proposer[eml:JobTitle[text()=&quot;gemachtigde voor het aangaan van lijstencombinaties&quot;]]">
                                                <xsl:call-template name="Agent"/>
                                            </xsl:for-each>
                                            <fo:block/>
                                            <xsl:if test="eml:Proposer/eml:JobTitle[text()=&quot;plaatsvervanger voor het aangaan van lijstencombinaties&quot;]">
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:text>Plaatsvervanger(s) van de gemachtigde:</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H1_070_plaatsvervangerGemachtigdeLijstencombinatie"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                                <fo:block/>
                                                ...
                                                <xsl:for-each select="eml:Proposer[eml:JobTitle[text()=&quot;plaatsvervanger voor het aangaan van lijstencombinaties&quot;]]">
                                                    <xsl:call-template name="Agent"/>
                                                </xsl:for-each>
                                            </xsl:if>
                                        </xsl:for-each>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>In te leveren bij de kandidatenlijst</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H1_100_InTeLeveren"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>Ik ben verplicht de volgende bijlage(n) in te leveren bij de kandidatenlijst (aanvinken wat van toepassing is):</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H1_110_IkBenVerplicht"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        <xsl:for-each select="rg:RG210">
                                                ...
                                                <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                    <xsl:variable name="altova:tablerows">
                                                        <fo:table-row font-family="Arial" font-size="9pt">
                                                            ...
                                                            <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                <fo:block text-align="left">
                                                                    <xsl:for-each select="rg:AuthorisationOfGroupNameAttached">
                                                                    ...
                                                                    <xsl:choose>
                                                                        <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                                                            <xsl:choose>
                                                                                <xsl:when test="$lang=0">
                                                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                                                        <xsl:text> Een verklaring van de gemachtigde(n) van de politieke groepering(en) waarmee aan mij toestemming wordt gegeven om de aanduiding boven de kandidatenlijst te plaatsen, want ik heb een aanduiding boven de lijst geplaatst (model H 3-1 of H 3-2).</xsl:text>
                                                                                    </fo:inline>
                                                                                </xsl:when>
                                                                                <xsl:otherwise>
                                                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                                                        <xsl:value-of select="$H1_120_modelH3"/>
                                                                                    </fo:inline>
                                                                                </xsl:otherwise>
                                                                            </xsl:choose>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            <xsl:choose>
                                                                                ...
                                                                                <xsl:otherwise>
                                                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                                                        <xsl:value-of select="$H1_120_modelH3_BC"/>
                                                                                    </fo:inline>
                                                                                </xsl:otherwise>
                                                                            </xsl:choose>
                                                                        </xsl:otherwise>
                                                        ...
                                                        <fo:table-row font-family="Arial" font-size="9pt">
                                                            ...
                                                            <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                <fo:block text-align="left">
                                                                    <xsl:for-each select="rg:SupportStatementsAttached">
                                                                        <xsl:call-template name="Checkbox"/>
                                                                    </xsl:for-each>
                                                                    <xsl:choose>
                                                                        <xsl:when test="$lang=0">
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:text> Verklaringen van kiezers dat zij de lijst ondersteunen, want de lijst komt niet in aanmerking voor de ontheffing van deze verplichting (model H4).</xsl:text>
                                                                            </fo:inline>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:value-of select="$H1_130_modelH4"/>
                                                                            </fo:inline>
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                </fo:block>
                                                        ...
                                                        <fo:table-row font-family="Arial" font-size="9pt">
                                                            ...
                                                            <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                <fo:block text-align="left">
                                                                    <xsl:for-each select="rg:AgreementStatementsAttached">
                                                                        <xsl:call-template name="Checkbox"/>
                                                                    </xsl:for-each>
                                                                    <xsl:choose>
                                                                        <xsl:when test="$lang=0">
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:text> Een verklaring van iedere op de lijst voorkomende kandidaat dat hij instemt met zijn kandidaatstelling op de lijst (model H 9).</xsl:text>
                                                                            </fo:inline>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:value-of select="$H1_140_modelH9"/>
                                                                            </fo:inline>
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                </fo:block>
                                                        ...
                                                        <fo:table-row font-family="Arial" font-size="9pt">
                                                            ...
                                                            <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                <fo:block text-align="left">
                                                                    <xsl:for-each select="rg:IdentificationDocumentsAttached">
                                                                        <xsl:call-template name="Checkbox"/>
                                                                    </xsl:for-each>
                                                                    <xsl:choose>
                                                                        <xsl:when test="$lang=0">
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:text> Een kopie van een geldig identiteitsbewijs van iedere kandidaat die géén zitting heeft in het orgaan waarvoor de verkiezing wordt gehouden.</xsl:text>
                                                                            </fo:inline>
                                                                        </xsl:when>
                                                                        <xsl:otherwise>
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:value-of select="$H1_150_modelIdentiteitsbewijs"/>
                                                                            </fo:inline>
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                </fo:block>
                                            ...
                                            <xsl:if test="//eml:ElectionCategory[ text() != &quot;EK&quot; and text() != &quot;GC&quot; ]">
                                                <fo:inline-container>
                                                    <fo:block>
                                                        <xsl:text>&#x200B;</xsl:text>
                                                    </fo:block>
                                                    ...
                                                    <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                        <xsl:variable name="altova:tablerows">
                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:for-each select="rg:DepositReceiptAttached">
                                                                            <xsl:call-template name="Checkbox"/>
                                                                        </xsl:for-each>
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:text> Een betalingsbewijs van de waarborgsom, want de lijst komt niet in aanmerking voor de ontheffing van deze verplichting (model H 12).</xsl:text>
                                                                                </fo:inline>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H1_160_modelH12"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                                            ...
                                            <xsl:if test="//eml:ElectionCategory[ text() = &quot;PS&quot; or text() = &quot;AB&quot; or text() = &quot;GR&quot; or text() = &quot;BC&quot; or text() = &quot;ER&quot; ]">
                                                <fo:inline-container>
                                                    <fo:block>
                                                        <xsl:text>&#x200B;</xsl:text>
                                                    </fo:block>
                                                    ...
                                                    <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                        <xsl:variable name="altova:tablerows">
                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:for-each select="rg:PlannedSettlementStatementsAttached">
                                                                            <xsl:call-template name="Checkbox"/>
                                                                        </xsl:for-each>
                                                                        <xsl:choose>
                                                                            <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <xsl:choose>
                                                                                    ...
                                                                                    <xsl:otherwise>
                                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                                            <xsl:value-of select="$H1_170_model_verklaring_voorgenomen_vestiging_BC"/>
                                                                                        </fo:inline>
                                                                                    </xsl:otherwise>
                                                                                </xsl:choose>
                                                                            </xsl:otherwise>
                                            ...
                                            <xsl:if test="//eml:ElectionCategory[ text() = &quot;EP&quot; ]">
                                                <fo:inline-container>
                                                    <fo:block>
                                                        <xsl:text>&#x200B;</xsl:text>
                                                    </fo:block>
                                                    ...
                                                    <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                        <xsl:variable name="altova:tablerows">
                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:for-each select="rg:NoForeignNominationStatementsAttached">
                                                                            <xsl:call-template name="Checkbox"/>
                                                                        </xsl:for-each>
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:text> Een verklaring van iedere op de lijst voorkomende&#160; kandidaat dat hij niet in een andere lidstaat kandidaat zal zijn voor het Europees Parlement (model Y 13).</xsl:text>
                                                                                </fo:inline>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H1_180_modelY13"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                                                            ...
                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:for-each select="rg:NotExcludedInOtherEUCountryStatementsAttached">
                                                                            <xsl:call-template name="Checkbox"/>
                                                                        </xsl:for-each>
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:text> Een verklaring van kandidaten die onderdaan zijn van een andere lidstaat, dat zij in die lidstaat niet zijn uitgesloten van het recht om gekozen te worden voor de verkiezingen van het Europees Parlement (model Y 35).</xsl:text>
                                                                                </fo:inline>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H1_190_modelY35"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Ondertekening door de inleveraar</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H1_200_Ondertekening"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:for-each select="eml:Nominate">
                                            <xsl:for-each select="eml:Proposer[eml:JobTitle[text()=&quot;inleveraar&quot;]]">
                                                <fo:block>
                                                    <fo:leader leader-pattern="space"/>
                                                </fo:block>
                                                <fo:inline-container>
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:text>Naam en voorletters</xsl:text>
                                                                                </fo:inline>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H1_205_NaamEnVoorletters"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:text>Postadres, Postcode en plaats</xsl:text>
                                                                                </fo:inline>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H1_210_PostadresPostcodePlaats"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H1_220_Datum"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                                                                ...
                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                    <fo:block text-align="left">
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H1_230_Handtekening"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                ...
                <xsl:variable name="altova:tablerows">
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                            <xsl:value-of select="$H1_300_AgentLabel-naam"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                            <xsl:value-of select="$H1_310_AgentLabel-voorletters"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                            <xsl:value-of select="$H1_320_AgentLabel-postadres"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                            <xsl:value-of select="$H1_330_AgentLabel-postcode"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                            <xsl:value-of select="$H1_340_AgentLabel-plaats"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                    ...
                    <fo:table-row font-family="Arial" font-size="9pt">
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    <xsl:when test="eml:Contact/eml:MailingAddress/xal:Locality/xal:AddressLine[ text() != &quot;&quot; ]">
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    <xsl:when test="eml:Contact/eml:MailingAddress/xal:Locality/xal:PostalCode/xal:PostalCodeNumber[ text() != &quot;&quot; ]">
                                        <xsl:for-each select="eml:Contact">
                                            <xsl:for-each select="eml:MailingAddress">
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    <xsl:when test="eml:Contact/eml:MailingAddress/xal:Locality/xal:LocalityName[ text() != &quot;&quot; ]">
                                        <xsl:for-each select="eml:Contact">
                                            <xsl:for-each select="eml:MailingAddress">
                    ...
                    <fo:table-row font-family="Arial" font-size="9pt">
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:call-template name="LineBreak"/>
                                <fo:inline color="#a6a6a6" font-family="Arial" font-size="9pt">
                                    <xsl:text>_________________________</xsl:text>
                                </fo:inline>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                            <fo:block text-align="left">
                                <xsl:call-template name="LineBreak"/>
                                <fo:inline color="#a6a6a6" font-family="Arial" font-size="9pt">
                                    <xsl:text>_________________</xsl:text>
                                </fo:inline>
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                    ...
                    <fo:table-header font-family="Arial" font-size="9pt" start-indent="0pt">
                        <xsl:variable name="altova:tablerows">
                            <fo:table-row font-family="Arial" font-size="9pt">
                                ...
                                <xsl:variable name="bColumnCondition_0xB347990">
                                    <xsl:for-each select="$altova:CurrContextGrid_99">
                                        <xsl:value-of select="$showDateOfBirth = 1"/>
                                    </xsl:for-each>
                                </xsl:variable>
                                <xsl:if test="$bColumnCondition_0xB347990 = 'true'">
                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="before">
                                        <fo:block text-align="left">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">

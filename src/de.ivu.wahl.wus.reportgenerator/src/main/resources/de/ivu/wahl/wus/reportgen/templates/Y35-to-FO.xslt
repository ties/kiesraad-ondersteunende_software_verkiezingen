                                ...
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Nomination">
                                        <xsl:for-each select="rg:RG210">
                                            <xsl:for-each select="rg:NotExcludedInOtherEUCountry">
                                                        ...
                                                        <xsl:for-each select="@Id">
                                                            ...
                                                            <xsl:for-each select="//eml:Candidate[eml:CandidateIdentifier/@Id = $candidateId]">
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                                            <xsl:text>Model Y 35</xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                                            <xsl:value-of select="$Y35_010_pretitle"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <fo:block/>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                                            <xsl:text>Verklaring dat u in de lidstaat van uw herkomst niet bent uitgesloten van het recht om gekozen te worden/Declaration of non-exclusion from the right to stand for election in your home Member State</xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                                            <xsl:value-of select="$Y35_020_title"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <fo:block/>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:text>Met dit formulier verklaart u, als onderdaan van een andere lidstaat van de Europese Unie, dat u in die lidstaat niet bent uitgesloten van het recht om gekozen te worden. By this form, you declare, as subject of another Member State of the European Union, that you are not excluded from the right to stand for election in your home Member State.</xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:value-of select="$Y35_030_MetDitFormulier"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <fo:block/>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                                            <xsl:text>Gegevens kandidaat /Candidate information</xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                                            <xsl:value-of select="$Y35_040_GegevensKandidaat"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <fo:block/>
                                                                ...
                                                                <fo:table font-family="Arial" font-size="9pt" display-align="after" table-layout="fixed" width="100%" border-spacing="2pt">
                                                                    ...
                                                                    <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                                        <xsl:variable name="altova:tablerows">
                                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>Naam/name</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_050_naam"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                                </fo:table-cell>
                                                                                <fo:table-cell number-columns-spanned="2" font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>voornaam en overige voorletters/given name and initials</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_060_voornaamVoorletters"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                                ...
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>adres/address</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_070_adres"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                                ...
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>woonplaats/place of residence</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_080_woonplaats"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                                ...
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>nationaliteit/nationality</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_090_nationaliteit"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                                ...
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>geboortedatum/date of birth</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_100_geboortedatum"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                                ...
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>geboorteplaats/place of birth</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_110_geboorteplaats"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                            ...
                                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                                <fo:table-cell number-columns-spanned="3" font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:text>laatste adres en woonplaats in de lidstaat van herkomst/last address and place of residence in the home member state</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="8pt" font-style="italic">
                                                                                                    <xsl:value-of select="$Y35_120_laatsteAdres"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                            ...
                                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                                <fo:table-cell number-columns-spanned="3" font-family="Arial" font-size="9pt" padding-top="10pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:call-template name="LineBreak"/>
                                                                                        <fo:inline color="#a6a6a6" font-family="Arial" font-size="9pt">
                                                                                            <xsl:text>_______________________________________________________________________________________________________________</xsl:text>
                                                                                        </fo:inline>
                                                                                    </fo:block>
                                                                                </fo:table-cell>
                                                                            </fo:table-row>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                                            <xsl:text>Ondertekening door de kandidaat/Signature by the candidate</xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                                            <xsl:value-of select="$Y35_130_Ondertekening"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <fo:block/>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:text>Ik verklaar dat ik niet ben uitgesloten van het recht om gekozen te worden in de lidstaat van mijn herkomst. / I hereby declare that I am not excluded from the right to stand for election in my home Member State.</xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:value-of select="$Y35_140_IkVerklaar"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <fo:block/>
                                                                                ...
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        ...
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                                    <xsl:text>Datum/Date</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                                    <xsl:value-of select="$Y35_150_Datum"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                                ...
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        ...
                                                                                        <xsl:choose>
                                                                                            <xsl:when test="$lang=0">
                                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                                    <xsl:text>Handtekening/Signature</xsl:text>
                                                                                                </fo:inline>
                                                                                            </xsl:when>
                                                                                            <xsl:otherwise>
                                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                                    <xsl:value-of select="$Y35_160_Handtekening"/>
                                                                                                </fo:inline>
                                                                                            </xsl:otherwise>
                                                                                        </xsl:choose>
                                                                                    </fo:block>
                                                                ...
                                                                <xsl:if test="$parameter1 = &apos;all&apos; and not($isLast)">

            ...
            <fo:page-sequence force-page-count="no-force" master-reference="page-master-0" initial-page-number="auto" format="1">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block font-family="Arial">
                        ...
                        <fo:block font-family="Arial" font-size="inherit" margin="0" padding="0" margin-right="0 + 100% - 100%">
                            <xsl:for-each select="$XML">
                                <xsl:for-each select="mtp:Registration">
                                    ...
                                    <fo:block font-family="Arial" margin-right="100% - 100%" text-align="center" space-before="0" space-after="0" margin="0pt">
                                        <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                                            ...
                                            <fo:block font-family="Arial" margin-right="100% - 100%" margin="0pt">
                                        ...
                                        <fo:block font-family="Arial" font-size="large" font-weight="bold" margin-right="100% - 100%" margin="0pt">
                                            <fo:inline font-family="Arial">
                                        ...
                                        <fo:block font-family="Arial" font-size="larger" font-weight="bold" margin-right="100% - 100%" margin="0pt">
                                            <fo:inline font-family="Arial">
                                        ...
                                        <fo:block font-family="Arial" font-size="larger" font-weight="bold" margin-right="100% - 100%" margin="0pt">
                                            <fo:inline font-family="Arial">
                                                <xsl:text>van de Ondersteunende Software Verkiezingen</xsl:text>
                                            </fo:inline>
                                        </fo:block>
                                        <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                                            <fo:block>
                                            ...
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    ...
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="center">
                                                            <fo:block text-align="left">
                                                                <fo:external-graphic font-family="Arial" content-width="160pt" scaling="non-uniform">
            ...
            <fo:table-body font-family="Arial" start-indent="0pt">
                <xsl:variable name="altova:tablerows">
                    <fo:table-row font-family="Arial">
                        <fo:table-cell font-family="Arial" padding="2pt" display-align="center">
                            <fo:block text-align="right">
                                <fo:external-graphic font-family="Arial" content-width="60pt" scaling="non-uniform">
                                    <xsl:attribute name="src">
                                        <xsl:text>url(</xsl:text>
                                        <xsl:call-template name="altova:double-backslash">
                                            <xsl:with-param name="text">

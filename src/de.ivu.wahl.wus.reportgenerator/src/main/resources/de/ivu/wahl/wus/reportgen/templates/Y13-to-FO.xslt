                                ...
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Nomination">
                                        <xsl:for-each select="eml:Affiliation">
                                            <xsl:for-each select="eml:Candidate[$parameter1 = &quot;all&quot; or $parameter1 = eml:CandidateIdentifier/@Id]">
                                                <xsl:call-template name="Y13-Core"/>
                                                <xsl:if test="position() != last() and $parameter1 = &quot;all&quot;">

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:mtp="http://www.ivu.de" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="clitype fn iso4217 ix java link mtp xbrldi xbrli xlink xs xsi altova">
    ...
    <xsl:variable name="fo:layout-master-set">
        <fo:layout-master-set>
            <fo:simple-page-master master-name="page-master-106643296-even" margin-left="0.6in" margin-right="0.6in" page-height="11.69in" page-width="8.27in" margin-top="0.0in" margin-bottom="0.0in">
            ...
            <fo:simple-page-master master-name="page-master-106643296-odd" margin-left="0.6in" margin-right="0.6in" page-height="11.69in" page-width="8.27in" margin-top="0.0in" margin-bottom="0.0in">
                <fo:region-body margin-top="0.79in" margin-bottom="1.20in" column-count="1" column-gap="0.50in"/>
            ...
            <fo:page-sequence-master master-name="page-master-106643296">
                <fo:repeatable-page-master-alternatives>
                    <fo:conditional-page-master-reference master-reference="page-master-106643296-even" odd-or-even="even"/>
                    <fo:conditional-page-master-reference master-reference="page-master-106643296-odd" odd-or-even="odd"/>
                </fo:repeatable-page-master-alternatives>
    ...
    <xsl:template match="/">
        <fo:root>
            ...
            <fo:page-sequence force-page-count="no-force" master-reference="page-master-106643296" initial-page-number="auto" format="1">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block font-family="Arial">
                        ...
                        <fo:block font-family="Arial" margin="0" padding="0">
                                ...
                                <xsl:for-each select="mtp:Registration">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            ...
                                            <xsl:variable name="altova:CurrContextGrid_065C08E0" select="."/>
                                                            ...
                                                            <fo:block text-align="left">
                                                                ...
                                                                <xsl:for-each select="mtp:Address">
                                                                    <xsl:for-each select="mtp:Name">
                                                                        <xsl:variable name="value-of-template_06536658">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_06536658),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_06536658"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                                                ...
                                                                <xsl:for-each select="mtp:Address">
                                                                    <xsl:for-each select="mtp:City">
                                                                        <xsl:variable name="value-of-template_06549448">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_06549448),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_06549448"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                                                        ...
                                                                        <xsl:if test="mtp:Person/mtp:Persontype  = &quot;contractmanager&quot;">
                                                                            <xsl:for-each select="mtp:Person">
                                                                                <xsl:for-each select="mtp:Initials">
                                                                                    <xsl:variable name="value-of-template_065C4BA8">
                                                                                        <xsl:apply-templates/>
                                                                                    </xsl:variable>
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="contains(string($value-of-template_065C4BA8),'&#x200B;')">
                                                                                            <fo:block font-family="Arial">
                                                                                                <xsl:copy-of select="$value-of-template_065C4BA8"/>
                                                                                            </fo:block>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <fo:inline font-family="Arial">
                                                                                ...
                                                                                <xsl:for-each select="mtp:Lastname">
                                                                                    <xsl:variable name="value-of-template_065C5210">
                                                                                        <xsl:apply-templates/>
                                                                                    </xsl:variable>
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="contains(string($value-of-template_065C5210),'&#x200B;')">
                                                                                            <fo:block font-family="Arial">
                                                                                                <xsl:copy-of select="$value-of-template_065C5210"/>
                                                                                            </fo:block>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <fo:inline font-family="Arial">
                                                                                ...
                                                                                <xsl:for-each select="mtp:Occupation">
                                                                                    <xsl:variable name="value-of-template_065C5628">
                                                                                        <xsl:apply-templates/>
                                                                                    </xsl:variable>
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="contains(string($value-of-template_065C5628),'&#x200B;')">
                                                                                            <fo:block font-family="Arial">
                                                                                                <xsl:copy-of select="$value-of-template_065C5628"/>
                                                                                            </fo:block>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <fo:inline font-family="Arial">
                                                                ...
                                                                <xsl:for-each select="mtp:Address">
                                                                    <xsl:for-each select="mtp:Name">
                                                                        <xsl:variable name="value-of-template_065C5A90">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_065C5A90),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_065C5A90"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                                                    ...
                                                                    <xsl:for-each select="mtp:Street">
                                                                        <xsl:variable name="value-of-template_065C5E48">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_065C5E48),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_065C5E48"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                                                    ...
                                                                    <xsl:for-each select="mtp:Postcode">
                                                                        <xsl:variable name="value-of-template_065C62E8">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_065C62E8),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_065C62E8"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                                                    ...
                                                                    <xsl:for-each select="mtp:City">
                                                                        <xsl:variable name="value-of-template_065C66D8">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_065C66D8),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_065C66D8"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="20pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065C6F88" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            ...
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065C8F58" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065CABC0" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065CD630" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065CFB18" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065D1380" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
                                            ...
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065D24D8" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
                                            ...
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065D6BA0" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell number-columns-spanned="5" font-family="Arial" border="solid 1pt gray" padding="2pt" display-align="center">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065DABD0" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
                                            ...
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065DC260" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" font-weight="bold" border="solid 1pt gray" padding="2pt" display-align="center">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065DE578" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065DF600" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            <fo:table-column column-width="30pt"/>
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065E0860" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                                        ...
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                                            <fo:block text-align="left">
                                                                ...
                                                                <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                                                    <fo:table-column column-width="20pt"/>
                                                                    <fo:table-column column-width="proportional-column-width(1)"/>
                                                                    <xsl:variable name="altova:CurrContextGrid_065E1558" select="."/>
                                                                    <fo:table-body font-family="Arial" start-indent="0pt">
                                                                        <xsl:variable name="altova:tablerows">
                                                                            <fo:table-row font-family="Arial">
                                                                                <fo:table-cell font-family="Arial" padding="2pt" display-align="before">
                                    ...
                                    <fo:block font-family="Arial" margin="0pt">
                                        ...
                                        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
                                            ...
                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                            <xsl:variable name="altova:CurrContextGrid_065E3F68" select="."/>
                                            <fo:table-body font-family="Arial" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                    <fo:table-row font-family="Arial">
                                                        <fo:table-cell font-family="Arial" padding="2pt" display-align="center">
                                                        ...
                                                        <fo:table-cell border-bottom="0.01in solid #000" font-family="Arial" padding="2pt" display-align="center">
                                                            <fo:block text-align="left">
                                                                <xsl:for-each select="mtp:Address">
                                                                    <xsl:for-each select="mtp:City">
                                                                        <xsl:variable name="value-of-template_065E4D48">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_065E4D48),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_065E4D48"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                                    ...
                                                    <fo:table-row font-family="Arial">
                                                        ...
                                                        <fo:table-cell border-bottom="0.01in solid #000" font-family="Arial" padding="2pt" display-align="center">
                                                            <fo:block text-align="left">
                                                                <xsl:for-each select="mtp:Address">
                                                                    <xsl:for-each select="mtp:Name">
                                                                        <xsl:variable name="value-of-template_065E5EC0">
                                                                            <xsl:apply-templates/>
                                                                        </xsl:variable>
                                                                        <xsl:choose>
                                                                            <xsl:when test="contains(string($value-of-template_065E5EC0),'&#x200B;')">
                                                                                <fo:block font-family="Arial">
                                                                                    <xsl:copy-of select="$value-of-template_065E5EC0"/>
                                                                                </fo:block>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial">
                                                                ...
                                                                <xsl:for-each select="mtp:Contacts">
                                                                    <xsl:for-each select="mtp:Contact">
                                                                        <xsl:if test="mtp:Person/mtp:Persontype  = &quot;contractmanager&quot;">
                                                                            <xsl:for-each select="mtp:Person">
                                                                                <xsl:for-each select="mtp:Initials">
                                                                                    <xsl:variable name="value-of-template_065E7A90">
                                                                                        <xsl:apply-templates/>
                                                                                    </xsl:variable>
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="contains(string($value-of-template_065E7A90),'&#x200B;')">
                                                                                            <fo:block font-family="Arial">
                                                                                                <xsl:copy-of select="$value-of-template_065E7A90"/>
                                                                                            </fo:block>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <fo:inline font-family="Arial">
                                                                                ...
                                                                                <xsl:for-each select="mtp:Lastname">
                                                                                    <xsl:variable name="value-of-template_065E80D8">
                                                                                        <xsl:apply-templates/>
                                                                                    </xsl:variable>
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="contains(string($value-of-template_065E80D8),'&#x200B;')">
                                                                                            <fo:block font-family="Arial">
                                                                                                <xsl:copy-of select="$value-of-template_065E80D8"/>
                                                                                            </fo:block>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <fo:inline font-family="Arial">
                                                                ...
                                                                <xsl:for-each select="mtp:Contacts">
                                                                    <xsl:for-each select="mtp:Contact">
                                                                        <xsl:if test="mtp:Person/mtp:Persontype  = &quot;contractmanager&quot;">
                                                                            <xsl:for-each select="mtp:Person">
                                                                                <xsl:for-each select="mtp:Occupation">
                                                                                    <xsl:variable name="value-of-template_065E90B0">
                                                                                        <xsl:apply-templates/>
                                                                                    </xsl:variable>
                                                                                    <xsl:choose>
                                                                                        <xsl:when test="contains(string($value-of-template_065E90B0),'&#x200B;')">
                                                                                            <fo:block font-family="Arial">
                                                                                                <xsl:copy-of select="$value-of-template_065E90B0"/>
                                                                                            </fo:block>
                                                                                        </xsl:when>
                                                                                        <xsl:otherwise>
                                                                                            <fo:inline font-family="Arial">
    ...
    <xsl:template name="legacy_footerall">
        ...
        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
            <fo:table-column column-width="proportional-column-width(1)"/>
            <xsl:variable name="altova:CurrContextGrid_065E9748" select="."/>
            <fo:table-body font-family="Arial" start-indent="0pt">
                <xsl:variable name="altova:tablerows">
                    <fo:table-row font-family="Arial">
                        <fo:table-cell font-family="Arial" padding="2pt" display-align="center">
    ...
    <xsl:template name="legacy_headerall">
        ...
        <fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
            <fo:table-column column-width="proportional-column-width(1)"/>
            <xsl:variable name="altova:CurrContextGrid_065E9DF8" select="."/>
            <fo:table-body font-family="Arial" start-indent="0pt">
                <xsl:variable name="altova:tablerows">
                    <fo:table-row font-family="Arial">
                        <fo:table-cell font-family="Arial" padding="2pt" display-align="center">

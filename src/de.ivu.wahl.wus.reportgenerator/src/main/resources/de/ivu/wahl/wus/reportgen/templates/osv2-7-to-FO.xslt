                            ...
                            <xsl:for-each select="$XML">
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:CandidateList">
                                        ...
                                        <fo:block font-family="Arial" font-size="9pt" margin-right="100% - 100%" font-weight="bold" space-before="1.12em" space-after="1.12em" margin="0pt">
                                            <xsl:for-each select="eml:Election">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:text>Bijlage bij proces verbaal I 4, geldigheid en nummering kandidatenlijsten en lijstencombinaties voor </xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$o2-7_010_title"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                        ...
                                        <xsl:for-each select="rg:RG230c">
                                            ...
                                            <fo:block font-family="Arial" font-size="9pt" margin-right="100% - 100%" margin="0pt">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$o2-7_015_DoorDe"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </fo:block>
                                            <xsl:for-each select="rg:ObjectionsByVotersPart2">
                                            ...
                                            <fo:block font-family="Arial" font-size="9pt" margin-right="100% - 100%" margin="0pt">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:text>Deze bezwaren geven het centraal stembureau aanleiding het volgende op te merken:</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$o2-7_020_DezeBezwaren"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </fo:block>
                                                    ...
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:otherwise>
                                                            <xsl:choose>
                                                                ...
                                                                <xsl:otherwise>
                                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                                        <xsl:value-of select="$o2-7_040_emptyLine"/>
                                                                    </fo:inline>
                                                                </xsl:otherwise>
                                                            </xsl:choose>
                                                            <fo:block/>
                                            ...
                                            <fo:block font-family="Arial" font-size="9pt" margin-right="100% - 100%" margin="0pt">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$o2-7_030_ParaafVoorzitter"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </fo:block>

            ...
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:Nomination">
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            <fo:inline font-family="Arial" font-size="9pt">
                                <xsl:text>Bent u nog geen lid van het vertegenwoordigend orgaan? Voeg dan een kopie van een geldig identiteitsbewijs bij.</xsl:text>
                            </fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                            <fo:inline font-family="Arial" font-size="9pt">
                    ...
                    <fo:table-header font-family="Arial" font-size="9pt" start-indent="0pt">
                        <xsl:variable name="altova:tablerows">
                            <fo:table-row font-family="Arial" font-size="9pt">
                                ...
                                <xsl:variable name="bColumnCondition_0xAF2F280">
                                    <xsl:for-each select="$altova:CurrContextGrid_98">
                                        <xsl:value-of select="$showDateOfBirth = 1"/>
                                    </xsl:for-each>
                                </xsl:variable>
                                <xsl:if test="$bColumnCondition_0xAF2F280 = 'true'">
                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="before">
                                        <fo:block text-align="left">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">

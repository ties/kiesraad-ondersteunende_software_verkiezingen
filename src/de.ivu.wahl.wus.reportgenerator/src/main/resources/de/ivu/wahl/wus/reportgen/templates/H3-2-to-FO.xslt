...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altova-xfi altovaext array clitype ds eml fn iso4217 ix java kr link map math rg sps ts xal xbrldi xbrli xff xfi xlink xnl xs xsi">
                                ...
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Nomination">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:text>Model H 3-2</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:value-of select="$H3-2_010_pretitle"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:text>Machtiging om samengevoegde aanduiding boven kandidatenlijst te plaatsen</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:value-of select="$H3-2_010_title"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:text>Met dit formulier geeft u de inleveraar van de kandidatenlijst toestemming om een aanduiding boven de kandidatenlijst te plaatsen, die is gevormd door samenvoeging van de aanduidingen van politieke groeperingen of afkortingen daarvan. U kunt alleen toestemming geven als u hiertoe gemachtigd bent door uw politieke groepering.</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H3-2_020_MetDitFormulier"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H3-2_020_MetDitFormulier_BC"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:call-template name="ChapterElection">
                                            <xsl:with-param name="isH3" select="1"/>
                                        </xsl:call-template>
                                        <fo:block/>
                                        <xsl:call-template name="Line"/>
                                        <fo:block/>
                                        ...
                                        <xsl:if test="eml:ElectionIdentifier/kr:ElectionSubcategory[ text() = &quot;TK&quot; or text() = &quot;EK&quot; or text() = &quot;PS2&quot; ]">
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:text>De machtiging geldt:</xsl:text>
                                                    </fo:inline>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:value-of select="$H3-2_050_DeMachtigingGeldt"/>
                                                    </fo:inline>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                            <fo:block/>
                                        ...
                                        <xsl:call-template name="ChapterPartyName">
                                            <xsl:with-param name="isH3" select="2"/>
                                        </xsl:call-template>
                                        <xsl:call-template name="Line"/>
                                        <fo:block/>
                                        <fo:block>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Toestemming aan de inleveraar</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H3-2_080_Toestemming"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>Ik geef toestemming aan </xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-2_090_1_WijGeven"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text> om de onder punt 3 vermelde aanduiding boven de kandidatenlijst te plaatsen.</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-2_090_2_WijGeven"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H3-2_100_KandidatenOpDeLijst"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Ondertekening door de gemachtigden</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H3-2_110_Ondertekening"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:for-each select="rg:RG210">
                                            <xsl:choose>
                                                <xsl:when test="rg:AuthorisedAgent[@model = &quot;H3-2&quot;]">
                                                    <xsl:for-each select="rg:AuthorisedAgent[@model = &quot;H3-2&quot;]">
                                                        <fo:block>
                                                            <fo:leader leader-pattern="space"/>
                                                        </fo:block>
                                                        <fo:block>
                                                        ...
                                                        <xsl:call-template name="Agent">
                                                            <xsl:with-param name="AuthorisedAgentName" select="rg:AuthorisedAgentName"/>
                                                            <xsl:with-param name="AuthorisedAgentParty" select="rg:AuthorisedAgentParty"/>
                                                            <xsl:with-param name="AuthorisedAgentNumber" select="position()"/>
                                                        </xsl:call-template>
                                                    </xsl:for-each>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="Agent">
                                                        <xsl:with-param name="AuthorisedAgentName" select="&quot;&quot;"/>
                                                        <xsl:with-param name="AuthorisedAgentParty" select="&quot;&quot;"/>
                                                        <xsl:with-param name="AuthorisedAgentNumber" select="1"/>
                                                    </xsl:call-template>
                                                    <fo:block/>
                                                    <fo:block>
                                                        <fo:leader leader-pattern="space"/>
                                                    ...
                                                    <xsl:call-template name="Agent">
                                                        <xsl:with-param name="AuthorisedAgentName" select="rg:AuthorisedAgentName"/>
                                                        <xsl:with-param name="AuthorisedAgentParty" select="rg:AuthorisedAgentParty"/>
                                                        <xsl:with-param name="AuthorisedAgentNumber" select="2"/>
                                                    </xsl:call-template>
                                                    <fo:block/>
                                                </xsl:otherwise>
                                            </xsl:choose>
    ...
    <xsl:template name="Agent">
        <xsl:param name="AuthorisedAgentName"/>
        <xsl:param name="AuthorisedAgentParty"/>
        <xsl:param name="AuthorisedAgentNumber" select="1"/>
        <xsl:choose>
            <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                            <xsl:text>Gemachtigde van politieke groepering</xsl:text>
                        </fo:inline>
                    </xsl:when>
                    <xsl:otherwise>
                        <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                            <xsl:value-of select="$H3-2_115_Gemachtigde"/>
                        </fo:inline>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:when>
            <xsl:otherwise>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                            <xsl:value-of select="$H3-2_115_Gemachtigde_BC"/>
                        </fo:inline>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:otherwise>
        ...
        <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
            <xsl:value-of select="$AuthorisedAgentNumber"/>
        </fo:inline>
        <fo:block/>
        <fo:block>
            <fo:leader leader-pattern="space"/>
            ...
            <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                <xsl:variable name="altova:tablerows">
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                            <fo:block text-align="left">
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="9pt">
                                            <xsl:value-of select="$H3-2_120_datum"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                    ...
                    <fo:table-row font-family="Arial" font-size="9pt">
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                            <fo:block text-align="left">
                                <xsl:if test="string($AuthorisedAgentName) = &quot;&quot;">
                                    <xsl:call-template name="LineBreak"/>
                                </xsl:if>
                                <xsl:choose>
                                    <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>Naam van de gemachtigde van de politieke groepering</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-2_130_NaamGemachtigde"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-2_130_NaamGemachtigde_BC"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:otherwise>
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    <xsl:when test="string($AuthorisedAgentName) = &quot;&quot;">
                                        <xsl:call-template name="LineBreak"/>
                                        <fo:inline color="#a6a6a6" font-family="Arial" font-size="9pt">
                                            <xsl:text>____________________________________________</xsl:text>
                                        </fo:inline>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                                            <xsl:value-of select="$AuthorisedAgentName"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                    ...
                    <fo:table-row font-family="Arial" font-size="9pt">
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                            <fo:block text-align="left">
                                <xsl:if test="string($AuthorisedAgentParty) = &quot;&quot;">
                                    <xsl:call-template name="LineBreak"/>
                                </xsl:if>
                                <xsl:choose>
                                    <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>Volledige statutaire naam van de politieke groepering </xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-2_140_verenigingsnaam"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-2_140_verenigingsnaam_BC"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </xsl:otherwise>
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="1" display-align="center">
                            <fo:block text-align="left">
                                <xsl:choose>
                                    <xsl:when test="string($AuthorisedAgentParty) = &quot;&quot;">
                                        <xsl:call-template name="LineBreak"/>
                                        <fo:inline color="#a6a6a6" font-family="Arial" font-size="9pt">
                                            <xsl:text>____________________________________________</xsl:text>
                                        </fo:inline>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                                            <xsl:value-of select="$AuthorisedAgentParty"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                        ...
                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                            <fo:block text-align="left">
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <fo:inline font-family="Arial" font-size="9pt">
                                            <xsl:value-of select="$H3-2_150_handtekening"/>
                                        </fo:inline>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </fo:block>
                    ...
                    <fo:table-header font-family="Arial" font-size="9pt" start-indent="0pt">
                        <xsl:variable name="altova:tablerows">
                            <fo:table-row font-family="Arial" font-size="9pt">
                                ...
                                <xsl:variable name="bColumnCondition_0x9AA7090">
                                    <xsl:for-each select="$altova:CurrContextGrid_87">
                                        <xsl:value-of select="$showDateOfBirth = 1"/>
                                    </xsl:for-each>
                                </xsl:variable>
                                <xsl:if test="$bColumnCondition_0x9AA7090 = 'true'">
                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="before">
                                        <fo:block text-align="left">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">

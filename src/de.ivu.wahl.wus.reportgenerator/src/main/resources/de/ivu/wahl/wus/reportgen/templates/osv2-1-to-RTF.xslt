...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altova-xfi altovaext array clitype ds eml fn iso4217 ix java kr link map math rg sps ts xal xbrldi xbrli xff xfi xlink xnl xs xsi">
    ...
    <xsl:template name="altova:DocumentSection_0">
        ...
        <xsl:choose>
            <xsl:when test="$XML/eml:EML/eml:CandidateList/rg:RG230c/rg:OmissionLetter">
                                ...
                                <xsl:for-each select="rg:OmissionLetter">
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o2-1_010_Aantekenen"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o2-1_020_Onderwerp"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Verzuim kandidatenlijst voor de verkiezing van de leden van </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o2-1_030_title"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Geachte heer/mevrouw </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o2-1_040_Geachte"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:for-each select="rg:Omissions">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>Hierbij deel ik u mede dat het </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o2-1_050_01_verzuimenMeedelen"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o2-1_050_02_verzuimenMeedelen"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text> voor de verkiezing van de leden van </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o2-1_050_05_verzuimenMeedelen"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text> in zijn vergadering van heden een of meerdere verzuimen heeft geconstateerd met betrekking tot de kandidatenlijst </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o2-1_050_06_verzuimenMeedelen"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:for-each select="rg:CandidateListName">
                                            <xsl:choose>
                                                <xsl:when test="count(eml:ContestIdentifier) = 1">
                                                                    ...
                                                                    <xsl:when test="//eml:ElectionCategory = &apos;EK&apos;">
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                ...
                                                                                <xsl:call-template name="write-text">
                                                                                    <xsl:with-param name="text">
                                                                                        <xsl:value-of select="$o2-1_050_07_EK_verzuimenMeedelen"/>
                                                                                    </xsl:with-param>
                                                                                </xsl:call-template>
                                                                                <xsl:text>}</xsl:text>
                                                                            </xsl:otherwise>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                ...
                                                                                <xsl:call-template name="write-text">
                                                                                    <xsl:with-param name="text">
                                                                                        <xsl:text>voor kieskring </xsl:text>
                                                                                    </xsl:with-param>
                                                                                </xsl:call-template>
                                                                                <xsl:text>}</xsl:text>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                ...
                                                                                <xsl:call-template name="write-text">
                                                                                    <xsl:with-param name="text">
                                                                                        <xsl:value-of select="$o2-1_050_07_verzuimenMeedelen"/>
                                                                                    </xsl:with-param>
                                                                                </xsl:call-template>
                                                                                <xsl:text>}</xsl:text>
                                                                            </xsl:otherwise>
                                                                    ...
                                                                    <xsl:when test="//eml:ElectionCategory = &apos;EK&apos;">
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                ...
                                                                                <xsl:call-template name="write-text">
                                                                                    <xsl:with-param name="text">
                                                                                        <xsl:text>voor alle provincies </xsl:text>
                                                                                    </xsl:with-param>
                                                                                </xsl:call-template>
                                                                                <xsl:text>}</xsl:text>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                ...
                                                                                <xsl:call-template name="write-text">
                                                                                    <xsl:with-param name="text">
                                                                                        <xsl:value-of select="$o2-1_050_08_EK_alle_verzuimenMeedelen"/>
                                                                                    </xsl:with-param>
                                                                                </xsl:call-template>
                                                                                <xsl:text>}</xsl:text>
                                                                            </xsl:otherwise>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                ...
                                                                                <xsl:call-template name="write-text">
                                                                                    <xsl:with-param name="text">
                                                                                        <xsl:text>voor alle kieskringen </xsl:text>
                                                                                    </xsl:with-param>
                                                                                </xsl:call-template>
                                                                                <xsl:text>}</xsl:text>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                ...
                                                                                <xsl:call-template name="write-text">
                                                                                    <xsl:with-param name="text">
                                                                                        <xsl:value-of select="$o2-1_050_08_verzuimenMeedelen"/>
                                                                                    </xsl:with-param>
                                                                                </xsl:call-template>
                                                                                <xsl:text>}</xsl:text>
                                                                            </xsl:otherwise>
                                                ...
                                                <xsl:when test="count(eml:ContestIdentifier) &gt; 1">
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            ...
                                                            <xsl:call-template name="write-text">
                                                                <xsl:with-param name="text">
                                                                    <xsl:text>voor de provincies </xsl:text>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                            <xsl:text>}</xsl:text>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            ...
                                                            <xsl:call-template name="write-text">
                                                                <xsl:with-param name="text">
                                                                    <xsl:value-of select="$o2-1_050_08_EK_verzuimenMeedelen"/>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                            <xsl:text>}</xsl:text>
                                                        </xsl:otherwise>
                                                ...
                                                <xsl:when test="eml:AffiliationIdentifier/eml:RegisteredName[ text() != &quot;&quot; ]">
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            ...
                                                            <xsl:call-template name="write-text">
                                                                <xsl:with-param name="text">
                                                                    <xsl:text>met de aanduiding </xsl:text>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                            <xsl:text>}</xsl:text>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            ...
                                                            <xsl:call-template name="write-text">
                                                                <xsl:with-param name="text">
                                                                    <xsl:value-of select="$o2-1_050_09_verzuimenMeedelen"/>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                            <xsl:text>}</xsl:text>
                                                        </xsl:otherwise>
                                                ...
                                                <xsl:otherwise>
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:otherwise>
                                                            ...
                                                            <xsl:call-template name="write-text">
                                                                <xsl:with-param name="text">
                                                                    <xsl:value-of select="$o2-1_050_10_verzuimenMeedelen"/>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                            <xsl:text>}</xsl:text>
                                                        </xsl:otherwise>
                                        ...
                                        <xsl:text>\par </xsl:text>
                                        <xsl:choose>
                                            <xsl:when test="count( rg:Omission ) = 1">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <xsl:text>{\f1\fs18 </xsl:text>
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>Het betreft het volgende verzuim:</xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o2-1_060_1_HetBetreft"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>Het betreft de volgende verzuimen:</xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o2-1_060_2_HetBetreft"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Dit verzuim kan/deze verzuimen kunnen door de inleveraar van de kandidatenlijst of door een van de andere personen die op de kandidatenlijst gemachtigd zijn om bij verhindering van de inleveraar verzuimen te herstellen, worden hersteld tot en met </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o2-1_080_1_verzuimenHerstellen"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:for-each select="$XML">
                                        <xsl:for-each select="eml:EML">
                                            <xsl:for-each select="eml:CandidateList">
                                                <xsl:for-each select="rg:RG230c">
                                                    <xsl:for-each select="rg:RectificationTime">
                                                        <xsl:text>{\f1\fs18 </xsl:text>
                                                        <xsl:apply-templates>
                                                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                        ...
                                        <xsl:when test="//eml:ElectionCategory = &quot;EK&quot;">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text> (uiterlijk de derde dag na de zitting van het centraal stembureau tot het onderzoeken van de kandidatenlijsten van 9-17 uur), </xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_080_2_EK_verzuimenHerstellen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                        ...
                                        <xsl:otherwise>
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text> (uiterlijk de derde dag na de zitting van het centraal stembureau tot het onderzoeken van de kandidatenlijsten, op de 1e en 2e dag van 9-17 uur en op de 3e dag van 9-15 uur), </xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_080_2_verzuimenHerstellen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="//eml:ElectionCategory = &quot;EP&quot; or //eml:ElectionCategory = &quot;TK&quot;">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <xsl:text>{\f1\fs18 </xsl:text>
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>op het secretariaat van de Kiesraad, Herengracht 21 te ’s-Gravenhage (of op het bestuurskantoor van het openbaar lichaam waar de kandidatenlijst is ingeleverd)</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_080_3_verzuimenHerstellen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                        ...
                                        <xsl:when test="//eml:ElectionCategory = &quot;EK&quot;">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>op het secretariaat van de Kiesraad, Herengracht 21 te ’s-Gravenhage</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_080_3_EK_verzuimenHerstellen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                        ...
                                        <xsl:when test="//eml:ElectionCategory = &quot;ER&quot;">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <xsl:text>{\f1\fs18 </xsl:text>
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>op het bestuurskantoor waar de kandidatenlijst is ingeleverd</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_080_5_verzuimenHerstellen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                        ...
                                        <xsl:when test="//eml:ElectionCategory = &quot;AB&quot;">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <xsl:text>{\f1\fs18 </xsl:text>
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>bij het centraal stembureau van het waterschap</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_080_6_AB_verzuimenHerstellen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                        ...
                                        <xsl:otherwise>
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>ter secretarie van de gemeente waar het centraal stembureau is gevestigd</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_080_4_verzuimenHerstellen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                    ...
                                    <xsl:text>\par </xsl:text>
                                    <xsl:choose>
                                        <xsl:when test="//eml:ElectionCategory = &quot;EP&quot;  or  //eml:ElectionCategory = &quot;EK&quot; or  //eml:ElectionCategory = &quot;TK&quot;">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <xsl:text>{\f1\fs18 </xsl:text>
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>Ik verzoek u van tevoren contact op te nemen (contactgegevens rechtsboven), over het tijdstip waarop degene die het verzuim/de verzuimen komt herstellen verwacht te komen.</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_090_contactOpTeNemen"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                            ...
                                            <xsl:choose>
                                                ...
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_100_Hoogachtend"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                            ...
                                            <xsl:choose>
                                                ...
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_110_DeKiesraad"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                            ...
                                            <xsl:choose>
                                                ...
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_120_voorDeze"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>De voorzitter van het centraal stembureau,</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:value-of select="$o2-1_130_voorzitterHoofdstembureau"/>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                    ...
                                    <xsl:for-each select="$XML">
                                        <xsl:for-each select="eml:EML">
                                            <xsl:for-each select="eml:CandidateList">
                                                <xsl:for-each select="rg:RG230c">
                                                    <xsl:for-each select="rg:LetterOfOmissionSignatures">
                                                        ...
                                                        <xsl:variable name="tablestyle2">
                                                            ...
                                                            <xsl:text>\ts17\trqc\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                                                        </xsl:variable>
                                    ...
                                    <xsl:if test="position()&lt;count(../rg:OmissionLetter)">
            ...
            <xsl:otherwise>
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s0\f0\fs24\qc\sl0\f1\fs18 </xsl:text>
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        <xsl:text>{\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>Wegens technische redenen wordt dit document gegenereerd.</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="$o2-1_140_WegensTechnischeRedenen"/>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                    </xsl:otherwise>
                ...
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>Verzuimbrieven: Er zijn geen verzuimen ingevoerd.</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="$o2-1_150_geenVerzuimen"/>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                    </xsl:otherwise>

                                ...
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Nomination">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:text>Model I 10</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:value-of select="$I10_010_pretitle"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:text>Verbinding kandidatenlijsten tot lijstencombinatie</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:value-of select="$I10_020_title"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>Met dit formulier verklaart u dat u de kandidatenlijst van uw politieke groepering tot een lijstencombinatie wilt verbinden met de kandidatenlijst van één of meer andere politieke groeperingen. U kunt deze verklaring alleen afleggen als u op de kandidatenlijst van uw politieke groepering daarvoor als gemachtigde staat vermeld.</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$I10_030_MetDitFormulier"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:inline font-family="Arial" font-size="9pt">
                                        ...
                                        <xsl:call-template name="ChapterElection">
                                            <xsl:with-param name="isH3" select="0"/>
                                        </xsl:call-template>
                                        <fo:block/>
                                        <fo:block>
                                            <fo:leader leader-pattern="space"/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Te combineren kandidatenlijsten</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$I10_040_TeCombineren"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>De gemachtigden verbinden de volgende kandidatenlijsten tot een lijstencombinatie:</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$I10_050_gemachtigdenVerbinden"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <fo:table font-family="Arial" font-size="9pt" alignment-baseline="before-edge" width="100%" table-layout="fixed" border-spacing="2pt">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="count(rg:RG210/rg:OtherListsInCombinedList)">
                                                <xsl:for-each select="rg:RG210">
                                                    <xsl:for-each select="rg:OtherListsInCombinedList">
                                                        <fo:inline-container>
                                                            <fo:block>
                                                                <xsl:text>&#x200B;</xsl:text>
                                                            </fo:block>
                                                        </fo:inline-container>
                                                        <xsl:if test="rg:OtherListInCombinedList">
                                                            <fo:table font-family="Arial" font-size="9pt" width="100%" table-layout="fixed" border-spacing="2pt">
                                                                ...
                                                                <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                                    <xsl:variable name="altova:tablerows">
                                                                        <xsl:for-each select="rg:OtherListInCombinedList">
                                                                            <fo:table-row font-family="Arial" font-size="9pt">
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <fo:inline font-family="Arial" font-size="9pt" font-style="italic">
                                                                                            <xsl:value-of select="substring( &quot;ABCDEFGHIJKLMNOPQRSTUVWXYZ&quot;,  position()+1, 1)"/>
                                                                                        </fo:inline>
                                                                                    </fo:block>
                                                                                </fo:table-cell>
                                                                                <fo:table-cell font-family="Arial" font-size="9pt" white-space-collapse="false" linefeed-treatment="preserve" wrap-option="wrap" white-space-treatment="ignore-if-surrounding-linefeed" padding="2pt" display-align="center">
                                                                                    <fo:block text-align="left">
                                                                                        <xsl:for-each select="rg:Party">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Ondertekening door de gemachtigden die zijn vermeld op de kandidatenlijst</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$I10_070_Ondertekening"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                                                    <xsl:text>Gemachtigde van kandidatenlijst </xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                                                    <xsl:value-of select="$I10_080_GemachtigdeKandidatenlijst"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                                            ...
                                            <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                <xsl:variable name="altova:tablerows">
                                                        ...
                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="after">
                                                            <fo:block text-align="left">
                                                                ...
                                                                <xsl:choose>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:value-of select="$I10_090_Datum"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                            </fo:block>
                                                    ...
                                                    <fo:table-row font-family="Arial" font-size="9pt">
                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="after">
                                                            <fo:block text-align="left">
                                                                <xsl:if test="count(eml:Nominate/eml:Proposer/eml:JobTitle[text()=&quot;gemachtigde voor het aangaan van lijstencombinaties&quot;]) = 0">
                                                                    <xsl:call-template name="LineBreak"/>
                                                                </xsl:if>
                                                                <xsl:choose>
                                                                    <xsl:when test="$lang=0">
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:text>Naam van de gemachtigde</xsl:text>
                                                                        </fo:inline>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:value-of select="$I10_100_NaamGemachtigde"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                            </fo:block>
                                                            ...
                                                            <fo:block text-align="left">
                                                                ...
                                                                <xsl:for-each select="eml:Nominate">
                                                                    <xsl:for-each select="eml:Proposer">
                                                                        <xsl:if test="./eml:JobTitle[text()=&quot;gemachtigde voor het aangaan van lijstencombinaties&quot;]">
                                                        ...
                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="after">
                                                            <fo:block text-align="left">
                                                                ...
                                                                <xsl:choose>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:value-of select="$I10_110_Handtekening"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                            </fo:block>
                                        ...
                                        <xsl:choose>
                                                    ...
                                                    <xsl:for-each select="rg:OtherListsInCombinedList">
                                                        <xsl:for-each select="rg:OtherListInCombinedList">
                                                            <xsl:call-template name="Agent">
                                                                <xsl:with-param name="agentName" select="rg:Agent"/>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:call-template name="Agent">
                                                    <xsl:with-param name="agentName" select="&quot;&quot;"/>

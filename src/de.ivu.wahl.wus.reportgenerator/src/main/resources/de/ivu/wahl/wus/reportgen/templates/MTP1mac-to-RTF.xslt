...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:mtp="http://www.ivu.de" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com" exclude-result-prefixes="clitype fn iso4217 ix java link mtp xbrldi xbrli xlink xs xsi altova">
    <xsl:import href="D:/projekte/de.ivu.wahl.wus.reportgenerator/src/main/resources/de/ivu/wahl/wus/reportgen/templates/MTP1mac-text.xslt"/>
  <xsl:output method="text" encoding="UTF-8"/>
    ...
    <xsl:template name="altova:DocumentSection_049798B8">
        ...
        <xsl:call-template name="altova:Section_049798B8_HeaderLeft"/>
        <xsl:text>}</xsl:text>
        <xsl:text>{</xsl:text>
        <xsl:text>\headerr </xsl:text>
        <xsl:call-template name="altova:Section_049798B8_HeaderRight"/>
        <xsl:text>}</xsl:text>
        <xsl:text>{</xsl:text>
        <xsl:text>\footerl </xsl:text>
        <xsl:call-template name="altova:Section_049798B8_FooterLeft"/>
        <xsl:text>}</xsl:text>
        <xsl:text>{</xsl:text>
        <xsl:text>\footerr </xsl:text>
        <xsl:call-template name="altova:Section_049798B8_FooterRight"/>
        <xsl:text>}</xsl:text>
        ...
        <xsl:for-each select="$XML">
            <xsl:for-each select="mtp:Registration">
                ...
                <xsl:variable name="altova:CurrContextGrid_04986220" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_0498C720" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_0498E8C0" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_049902E0" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_04992CD8" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_04995270" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_04996BB8" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_04997DC0" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_0499C5C8" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_049A0918" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_049A1F38" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_049A42C0" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_049A5340" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_049A6580" select="."/>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>\par </xsl:text>
                <xsl:variable name="altova:CurrContextGrid_049A7278" select="."/>
                ...
                <xsl:variable name="altova:CurrContextGrid_049A9CC0" select="."/>
    ...
    <xsl:template name="legacy_footerall">
        ...
        <xsl:variable name="altova:CurrContextGrid_049AF488" select="."/>
    ...
    <xsl:template name="legacy_headerall">
        <xsl:param name="altova:nMaxWidthIn" select="7.06944"/>
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:variable name="altova:CurrContextGrid_049AFB38" select="."/>
    ...
    <xsl:template name="altova:Section_049798B8_FooterRight">
    ...
    <xsl:template name="altova:Section_049798B8_FooterLeft">
        <xsl:variable name="altova:nMaxWidthIn" select="7.07"/>
        <xsl:variable name="templatetablelevel" select="0"/>
        <xsl:call-template name="legacy_footerall">
            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
    ...
    <xsl:template name="altova:Section_049798B8_HeaderRight">
        <xsl:variable name="altova:nMaxWidthIn" select="7.07"/>
        <xsl:variable name="templatetablelevel" select="0"/>
    ...
    <xsl:template name="altova:Section_049798B8_HeaderLeft">
        <xsl:variable name="altova:nMaxWidthIn" select="7.07"/>
        <xsl:variable name="templatetablelevel" select="0"/>
        <xsl:call-template name="legacy_headerall">
            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altova-xfi altovaext array clitype ds eml fn iso4217 ix java kr link map math rg sps ts xal xbrldi xbrli xff xfi xlink xnl xs xsi">
    ...
    <xsl:template match="/">
        ...
        <xsl:text>{\s428\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s429\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s430\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s431\sl0\fs22\snext0 p;}</xsl:text>
        ...
        <xsl:text>{\*\ts479\tsrowd\ql\f1\fs22\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts480\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>}</xsl:text>
                    ...
                    <xsl:choose>
                        ...
                        <xsl:when test=".=&quot;PS&quot;">
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs407\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_provincialeStaten"/>
                                        </xsl:with-param>
    ...
    <xsl:template name="LineBreak">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\fs22\s428\s429\sl0\f1\fs22 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="SmallLineBreak">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\fs22\s430\s431\sl0\f1\fs22 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
        ...
        <xsl:if test="$isBold=1 and $font-size=&apos;medium&apos;">
            <xsl:for-each select="eml:ElectionIdentifier">
                <xsl:choose>
                    <xsl:when test="./eml:ElectionCategory[text()=&quot;PS&quot; or text()=&quot;AB&quot; or text()=&quot;GR&quot; or text()=&quot;ER&quot;]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:text>{\cs451\f1\fs26\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs452\f1\fs26\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                    ...
                    <xsl:when test="./eml:ElectionCategory[ text()=&quot;BC&quot; or text()=&quot;GC&quot; ]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:choose>
                                <xsl:when test=". != &quot;Rotterdam - Centrum&quot;  and  . != &quot;Rotterdam - Pernis&quot;">
                                    <xsl:text>{\cs453\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs454\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="substring( text() , 13 )"/>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs455\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs456\f1\fs26\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
    ...
    <xsl:template name="ContestIdentifier">
            ...
            <xsl:if test="$isBold=0">
                <xsl:for-each select="eml:ContestIdentifier">
                    <xsl:for-each select="@Id">
                        <xsl:text>{\cs457\f1\fs22 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                    ...
                    <xsl:text>{\cs460\f1\fs22 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>)</xsl:text>
                        </xsl:with-param>
        ...
        <xsl:if test="$fontSize = &apos;medium&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="eml:ContestIdentifier">
                    <xsl:for-each select="@Id">
                        <xsl:text>{\cs465\f1\fs26 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="string(.)"/>
                            </xsl:with-param>
                    ...
                    <xsl:text>{\cs466\f1\fs26 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text> (</xsl:text>
                        </xsl:with-param>
                    ...
                    <xsl:text>}</xsl:text>
                    <xsl:for-each select="eml:ContestName">
                        <xsl:text>{\cs467\f1\fs26 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:text>{\cs468\f1\fs26 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>)</xsl:text>
                        </xsl:with-param>
    ...
    <xsl:template name="Initials">
        ...
        <xsl:for-each select="xnl:PersonName">
            <xsl:for-each select="xnl:NameLine">
                ...
                <xsl:text>{\cs474\f1\fs22 </xsl:text>
                <xsl:apply-templates>
                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                </xsl:apply-templates>
    ...
    <xsl:template name="Line">
        ...
        <xsl:text>{\cs476\f1\fs22 </xsl:text>
        <xsl:call-template name="write-text">
            <xsl:with-param name="text">
    ...
    <xsl:template name="FooterLine">
        ...
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
            <xsl:text>{\cs477\f1\fs22 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="tablestyle1">
            ...
            <xsl:text>\ts479\ts480\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
        </xsl:variable>
        ...
        <xsl:if test="$isPagenumber=1">
            ...
            <xsl:text>}</xsl:text>
            <xsl:text>{\field{\*\fldinst{\cs485\f1\fs18 NUMPAGES }}{\fldrslt }}</xsl:text>
        </xsl:if>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend1"/>
        <xsl:if test="$templatetablelevel + 1 > 1">
                    ...
                    <xsl:for-each select="kr:Contest">
                        ...
                        <xsl:if test="$isBold = 1">
                            <xsl:choose>
                                <xsl:when test="$separator=&apos;comma&apos; and position()!=last()">
                                    <xsl:text>{\cs486\f1\fs22\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs487\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>, </xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:when test="$separator=&apos;newline&apos;">
                                    <xsl:text>{\cs488\f1\fs22\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs489\f1\fs22\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                        ...
                        <xsl:if test="$isBold = 0">
                            <xsl:choose>
                                ...
                                <xsl:when test="$separator=&apos;newline&apos;">
                                    <xsl:text>{\cs492\f1\fs22 </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
            ...
            <xsl:for-each select="eml:MailingAddress">
                ...
                <xsl:for-each select="xal:Country">
                    ...
                    <xsl:for-each select="xal:CountryNameCode">
                        ...
                        <xsl:if test="$fontSize = &apos;normal&apos;">
                            <xsl:if test="$isBold = 0">
                                <xsl:text>{\cs494\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>(</xsl:text>
                                    </xsl:with-param>
                                ...
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs495\f1\fs22 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:apply-templates>
                            ...
                            <xsl:if test="$isBold = 1">
                                <xsl:text>{\cs497\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>(</xsl:text>
                                    </xsl:with-param>
                                ...
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs498\f1\fs22\b </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs499\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>)</xsl:text>
                                    </xsl:with-param>
                ...
                <xsl:for-each select="xal:CountryNameCode">
                    ...
                    <xsl:if test="$fontSize = &apos;normal&apos;">
                        <xsl:if test="$isBold = 0">
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs507\f1\fs22 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs508\f1\fs22 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                        ...
                        <xsl:if test="$isBold = 1">
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs511\f1\fs22\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:if test="$fontSize = &apos;smaller&apos;">
                        <xsl:if test="$isBold = 0">
                            <xsl:text>{\cs512\f1\fs20 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs513\f1\fs20 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs514\f1\fs20 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                        ...
                        <xsl:if test="$isBold = 1">
                            <xsl:text>{\cs515\f1\fs20\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs516\f1\fs20\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs517\f1\fs20\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:if test="$fontSize = &apos;x-small&apos;">
                        <xsl:if test="$isBold = 0">
                            <xsl:text>{\cs518\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs519\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs520\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:when test="$isBold = 0">
                        <xsl:choose>
                            <xsl:when test="$contestId = 2">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs524\f1\fs26 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs525\f1\fs26 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                            ...
                            <xsl:when test="$contestId = 9 or $contestId = 10 or $contestId = 11">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs526\f1\fs26 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs527\f1\fs26 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                            ...
                            <xsl:when test="$contestId = 12 or $contestId = 13 or $contestId = 14">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs528\f1\fs26 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs529\f1\fs26 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                    ...
                    <xsl:otherwise>
                        <xsl:choose>
                            <xsl:when test="$contestId = 2">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs532\f1\fs26\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>wetterskip</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs533\f1\fs26\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_WaterschapTypeName_Wetterskip"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test="$contestId = 9 or $contestId = 10 or $contestId = 11">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs534\f1\fs26\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>hoogheemraadschap</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs535\f1\fs26\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_WaterschapTypeName_Hoogheemraadschap"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test="$contestId = 12 or $contestId = 13 or $contestId = 14">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs536\f1\fs26\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>hoogheemraadschap van</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs537\f1\fs26\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_WaterschapTypeName_Hoogheemraadschap_van"/>
                                            </xsl:with-param>
                        ...
                        <xsl:choose>
                            ...
                            <xsl:when test="$contestId = 9 or $contestId = 10 or $contestId = 11">
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs551\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_WaterschapTypeName_Hoogheemraadschap"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test="$contestId = 12 or $contestId = 13 or $contestId = 14">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs552\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>hoogheemraadschap van</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs553\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_WaterschapTypeName_Hoogheemraadschap_van"/>
                                            </xsl:with-param>

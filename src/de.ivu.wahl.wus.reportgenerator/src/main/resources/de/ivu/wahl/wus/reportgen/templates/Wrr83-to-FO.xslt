                ...
                <x:xmpmeta xmlns:x="adobe:ns:meta/">
                    <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                        <rdf:Description rdf:about="" xmlns:dc="http://purl.org/dc/elements/1.1/">
                            <dc:title>Model Wrr 83</dc:title>
                            <dc:creator/>
                            <dc:description/>
                        </rdf:Description>
                                        ...
                                        <xsl:for-each select="rg:RG510">
                                            ...
                                            <xsl:for-each select="rg:PresenceVotes">
                                                ...
                                                <xsl:if test="rg:AffiliationVotes">
                                                    <fo:table font-family="Arial" font-size="9pt" width="300pt" table-layout="fixed" border-spacing="2pt">
                                                        ...
                                                        <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                            <xsl:variable name="altova:tablerows">
                                                                <xsl:for-each select="rg:AffiliationVotes">
                                                                    <fo:table-row font-family="Arial" font-size="9pt" height="20pt">
                                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                                                                            <fo:block text-align="left">
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                ...
                                                                <fo:table-row font-family="Arial" font-size="9pt">
                                                                    ...
                                                                    <fo:table-cell border-bottom-color="black" border-bottom-style="solid" border-bottom-width="0.01in" font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                                                                        <fo:block text-align="left"/>
                                                                    </fo:table-cell>
                                                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                                                                        <fo:block text-align="left">
                                                ...
                                                <xsl:if test="rg:AffiliationVotes">
                                                    <fo:table font-family="Arial" font-size="9pt" width="350pt" table-layout="fixed" border-spacing="2pt">
                                                        ...
                                                        <fo:table-body font-family="Arial" font-size="9pt" start-indent="0pt">
                                                            <xsl:variable name="altova:tablerows">
                                                                <xsl:for-each select="rg:AffiliationVotes">
                                                                    <fo:table-row font-family="Arial" font-size="9pt" height="20pt">
                                                                        <fo:table-cell number-columns-spanned="2" font-family="Arial" font-size="9pt" padding="2pt" display-align="center">
                                                                            <fo:block text-align="left">
                                                                                <fo:inline font-family="Arial" font-size="9pt">

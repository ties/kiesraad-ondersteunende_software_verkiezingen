                                    ...
                                    <xsl:for-each select="eml:Nomination">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:text>Model H 3-1</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:value-of select="$H3-1_010_pretitle"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:text>Machtiging om aanduiding boven kandidatenlijst te plaatsen</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:value-of select="$H3-1_010_title"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:text>Met dit formulier geeft u de inleveraar van de kandidatenlijst toestemming om de aanduiding die door uw politieke groepering is geregistreerd boven de kandidatenlijst te plaatsen. U kunt alleen toestemming geven als u hiertoe gemachtigd bent door uw politieke groepering.</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H3-1_020_MetDitFormulier"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H3-1_020_MetDitFormulier_BC"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:if test="eml:ElectionIdentifier/kr:ElectionSubcategory[ text() = &quot;TK&quot; or text() = &quot;EK&quot; or text() = &quot;PS2&quot; ]">
                                            ...
                                            <xsl:choose>
                                                ...
                                                <xsl:otherwise>
                                                    <fo:inline font-family="Arial" font-size="9pt">
                                                        <xsl:value-of select="$H3-1_050_DeMachtigingGeldt"/>
                                                    </fo:inline>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                            <fo:block/>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H3-1_080_Toestemming"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-1_090_1_IkGeef"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H3-1_090_2_IkGeef"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H3-1_100_KandidatenOpDeLijst"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                            <xsl:text>Ondertekening door de gemachtigde van de politieke groepering</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                            <xsl:value-of select="$H3-1_110_Ondertekening"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                            <xsl:value-of select="$H3-1_110_Ondertekening_BC"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:otherwise>
                                                ...
                                                <xsl:variable name="altova:tablerows">
                                                        ...
                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                            <fo:block text-align="left">
                                                                ...
                                                                <xsl:choose>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:value-of select="$H3-1_120_datum"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                            </fo:block>
                                                    ...
                                                    <fo:table-row font-family="Arial" font-size="9pt">
                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                            <fo:block text-align="left">
                                                                <xsl:choose>
                                                                    <xsl:when test="rg:RG210/rg:AuthorisedAgent[@model = &quot;H3-1&quot;]/rg:AuthorisedAgentName != &quot;&quot;"/>
                                                                    <xsl:otherwise>
                                                                        <xsl:call-template name="LineBreak"/>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <xsl:choose>
                                                                    <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H3-1_130_NaamGemachtigde"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H3-1_130_NaamGemachtigde_BC"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </xsl:otherwise>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="rg:RG210/rg:AuthorisedAgent[@model = &quot;H3-1&quot;]/rg:AuthorisedAgentName != &quot;&quot;">
                                                                        <xsl:for-each select="rg:RG210">
                                                                            <xsl:for-each select="rg:AuthorisedAgent">
                                                                                <xsl:if test="./@model = &quot;H3-1&quot;">
                                                                                    <xsl:for-each select="rg:AuthorisedAgentName">
                                                    ...
                                                    <fo:table-row font-family="Arial" font-size="9pt">
                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                            <fo:block text-align="left">
                                                                <xsl:choose>
                                                                    <xsl:when test="rg:RG210/rg:AuthorisedAgent[@model = &quot;H3-1&quot;]/rg:AuthorisedAgentParty != &quot;&quot;"/>
                                                                    <xsl:otherwise>
                                                                        <xsl:call-template name="LineBreak"/>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                                <xsl:choose>
                                                                    <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H3-1_140_verenigingsnaam"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </xsl:when>
                                                                    <xsl:otherwise>
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H3-1_140_verenigingsnaam_BC"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </xsl:otherwise>
                                                                ...
                                                                <xsl:choose>
                                                                    <xsl:when test="rg:RG210/rg:AuthorisedAgent[@model = &quot;H3-1&quot;]/rg:AuthorisedAgentParty != &quot;&quot;">
                                                                        <xsl:for-each select="rg:RG210">
                                                                            <xsl:for-each select="rg:AuthorisedAgent">
                                                                                <xsl:if test="./@model = &quot;H3-1&quot;">
                                                                                    <xsl:for-each select="rg:AuthorisedAgentParty">
                                                        ...
                                                        <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                            <fo:block text-align="left">
                                                                ...
                                                                <xsl:choose>
                                                                    ...
                                                                    <xsl:otherwise>
                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                            <xsl:value-of select="$H3-1_150_handtekening"/>
                                                                        </fo:inline>
                                                                    </xsl:otherwise>
                                                                </xsl:choose>
                                                            </fo:block>
                    ...
                    <fo:table-header font-family="Arial" font-size="9pt" start-indent="0pt">
                        <xsl:variable name="altova:tablerows">
                            <fo:table-row font-family="Arial" font-size="9pt">
                                ...
                                <xsl:variable name="bColumnCondition_0xB501E48">
                                    <xsl:for-each select="$altova:CurrContextGrid_89">
                                        <xsl:value-of select="$showDateOfBirth = 1"/>
                                    </xsl:for-each>
                                </xsl:variable>
                                <xsl:if test="$bColumnCondition_0xB501E48 = 'true'">
                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="before">
                                        <fo:block text-align="left">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">

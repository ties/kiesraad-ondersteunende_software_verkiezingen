...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype ds eml fn iso4217 ix java kr link rg sps ts xal xbrldi xbrli xlink xnl xs xsi">
            ...
            <xsl:for-each select="eml:EML">
                ...
                <xsl:for-each select="eml:Count">
                    <xsl:for-each select="eml:Election">
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>Het gaat om de kandidaten voor de verkiezing van:</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                        <xsl:text>\par </xsl:text>
                    ...
                    <xsl:for-each select="rg:RG510">
                        <xsl:for-each select="rg:PresenceVotes">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>2. Aantal stemmen per lijst en kandidaat</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>3. Aantal blanco en ongeldige stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>4. Verschil toegelaten kiezers en getelde stembiljetten</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_1_0" select="round($altova:nTableWidthTw_1 * 0.70 * $altova:TableWidthFactor_1)"/>
                            <xsl:variable name="altova:nColumnWidthTw_1_1" select="round($altova:nTableWidthTw_1 * 0.30 * $altova:TableWidthFactor_1)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:for-each select="rg:BallotPaperNotReturned">
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_1 div 1440) - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
                        ...
                        <xsl:for-each select="rg:PostalVotes">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> (alleen in te vullen door gemeente ’s-Gravenhage)</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="AffiliationVotes">
        ...
        <xsl:for-each select="rg:AffiliationVotes">
            ...
            <xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(9001.00)"/>
            ...
            <xsl:variable name="altova:nColumnWidthTw_6_0" select="round(2.22 * 1440 * $altova:TableWidthFactor_6)"/>
            <xsl:variable name="altova:nColumnWidthTw_6_1" select="round(4.03 * 1440 * $altova:TableWidthFactor_6)"/>
            ...
            <xsl:variable name="tablestyle6">
                ...
                <xsl:text>\ts21\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
            </xsl:variable>
                ...
                <xsl:when test="$SV_OutputFormat = &apos;RTF&apos;">
                    <xsl:for-each select="eml:AffiliationIdentifier">
                        <xsl:for-each select="eml:RegisteredName">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_6_1 div 1440) - 0.01042 - 0.01042 - 0.01042"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                        </xsl:for-each>
            ...
            <xsl:choose>
                <xsl:when test="rg:CandidateVotes">
                    ...
                    <xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(9001.50)"/>
                    ...
                    <xsl:variable name="altova:nColumnWidthTw_7_0" select="round(0.83 * 1440 * $altova:TableWidthFactor_7)"/>
                    <xsl:variable name="altova:nColumnWidthTw_7_1" select="round(4.33 * 1440 * $altova:TableWidthFactor_7)"/>
                    <xsl:variable name="altova:nColumnWidthTw_7_2" select="round(1.08 * 1440 * $altova:TableWidthFactor_7)"/>
                    <xsl:text>\pard\f0\fs24</xsl:text>
                    <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 1"/>
                    ...
                    <xsl:for-each select="rg:CandidateVotes">
                        ...
                        <xsl:for-each select="eml:Candidate">
                            <xsl:for-each select="eml:CandidateFullName">
                                <xsl:call-template name="LastNameH1">
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_1 div 1440) - 0.01042 - 0.01042 - 0.01042 - 0.01042"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:call-template>
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                        ...
                        <xsl:for-each select="rg:ValidVotes">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_2 div 1440) - 0.01042 - 0.01042 - 0.01042 - 0.01042"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                        </xsl:for-each>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(0.00)"/>
                    ...
                    <xsl:variable name="altova:nDefaultColumnWidthTw_8">
                        <xsl:value-of select="$altova:nTableWidthTw_8 div $altova:nColumnsWithDefaultWidthNotZero_8"/>
                    </xsl:variable>
                    ...
                    <xsl:variable name="tablestyle8">
                        ...
                        <xsl:text>\ts23\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf142\brdrw15\trbrdrl\brdrs\brdrcf142\brdrw15\trbrdrb\brdrs\brdrcf142\brdrw15\trbrdrr\brdrs\brdrcf142\brdrw15</xsl:text>
                    </xsl:variable>
                    ...
                    <xsl:for-each select="rg:ValidVotes">
                        <xsl:text>{\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_1 div 1440) - 0.01042 - 0.01042 - 0.02083 - 0.02083"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                    </xsl:for-each>

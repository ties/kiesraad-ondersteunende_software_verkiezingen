...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altova-xfi altovaext array clitype ds eml fn iso4217 ix java kr link map math rg sps ts xal xbrldi xbrli xff xfi xlink xnl xs xsi">
    ...
    <xsl:template name="altova:DocumentSection_0">
        ...
        <xsl:for-each select="$XML">
            <xsl:for-each select="eml:EML">
                <xsl:variable name="isBesIsland" select="count(eml:Count/eml:Election/eml:ElectionIdentifier/eml:ElectionCategory[ text() = &quot;ER&quot; ]) &gt; 0 or count(eml:Count/eml:Election/eml:Contests/eml:Contest/eml:ContestIdentifier/eml:ContestName[text() = &quot;Bonaire&quot; or text() = &quot;Sint Eustatius&quot; or text() = &quot;Saba&quot;]) &gt; 0 or count(eml:ManagingAuthority/eml:AuthorityIdentifier[text() = &quot;Bonaire&quot; or text() = &quot;Sint Eustatius&quot; or text() = &quot;Saba&quot;]) &gt; 0"/>
                <xsl:for-each select="eml:Count">
                    <xsl:variable name="isElection" select="count (eml:Election/eml:ElectionIdentifier/eml:ElectionCategory[text() = &apos;EP&apos; or text() = &apos;TK&apos; or text() = &apos;EK&apos; or text() = &apos;PS&apos; or text() = &apos;GR&apos; or text() = &apos;GC&apos; or text() = &apos;BC&apos; or text() = &apos;IR&apos;]) = 1"/>
                    <xsl:for-each select="eml:Election">
                        ...
                        <xsl:for-each select="eml:ElectionIdentifier">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Vaststelling aantal stemmen in</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Met dit formulier stelt de </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:choose>
                                ...
                                <xsl:when test="eml:ElectionCategory[ text() != &quot;BC&quot; and text() != &quot;GC&quot; ]">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>burgemeester</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:when>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> de uitkomst vast voor zijn </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:choose>
                    ...
                    <xsl:for-each select="rg:RG510">
                        <xsl:for-each select="rg:PresenceVotes">
                            <xsl:choose>
                                <xsl:when test="$isElection">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>2. Aantal stemmen</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    <xsl:text>{\f1\fs18\animtext0\strike0\ul </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Aantal stemmen per lijst en kandidaat:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Aantal blanco en ongeldige stemmen:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    <xsl:variable name="altova:CurrContextGrid_1" select="."/>
                                    <xsl:variable name="altova:nTableWidthIn_0" select="$altova:nMaxWidthIn * 0.52000"/>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_0" select="round(4401.00)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_0_0" select="round(2.50 * 1440 * $altova:TableWidthFactor_0)"/>
                                    <xsl:variable name="altova:nColumnWidthTw_0_1" select="round(0.56 * 1440 * $altova:TableWidthFactor_0)"/>
                                ...
                                <xsl:otherwise>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>2. Aantal kiesgerechtigden en stemmen</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Aantal kiesgerechtigden:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Het aantal kiesgerechtigden in </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:for-each select="$XML">
                                                    ...
                                                    <xsl:for-each select="eml:ElectionIdentifier">
                                                        <xsl:choose>
                                                            <xsl:when test="$isBesIsland">
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:text>het openbaar lichaam</xsl:text>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:when>
                                                            ...
                                                            <xsl:when test="count( eml:ElectionCategory[ text() = &quot;BC&quot; ] ) &gt; 0">
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:text>het stadsdeel</xsl:text>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:when>
                                                            <xsl:otherwise>
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:text>de deelgemeente</xsl:text>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:otherwise>
                                    ...
                                    <xsl:variable name="altova:nTableWidthIn_1" select="$altova:nMaxWidthIn * 0.52000"/>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(5801.00)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_1_0" select="round(3.47 * 1440 * $altova:TableWidthFactor_1)"/>
                                    <xsl:variable name="altova:nColumnWidthTw_1_1" select="round(0.56 * 1440 * $altova:TableWidthFactor_1)"/>
                                    <xsl:text>\pard\s0\f0\fs24</xsl:text>
                                    <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 1"/>
                                    ...
                                    <xsl:for-each select="rg:AffiliationVotes">
                                        ...
                                        <xsl:text>}</xsl:text>
                                        <xsl:choose>
                                            <xsl:when test="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Voor&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;voor&quot;">
                                                <xsl:text>{\f1\fs18 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>aantal stemmen voor de wet / het verdrag</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:when test="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Tegen&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;tegen&quot;">
                                                <xsl:text>{\f1\fs18 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>aantal stemmen tegen de wet / het verdrag</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>aantal stemmen voor het antwoord &quot;</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                                <xsl:for-each select="eml:AffiliationIdentifier">
                                                    <xsl:for-each select="eml:RegisteredName">
                                                        <xsl:text>{\f1\fs18 </xsl:text>
                                                        <xsl:apply-templates>
                                                            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_0 div 1440) - 0.02083 - 0.02083"/>
                                                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                                        </xsl:apply-templates>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:for-each>
                                        ...
                                        <xsl:for-each select="rg:ValidVotes">
                                            <xsl:text>{\f1\fs18 </xsl:text>
                                            <xsl:apply-templates>
                                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_1 div 1440) - 0.02083 - 0.02083"/>
                                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                            </xsl:apply-templates>
                                            <xsl:text>}</xsl:text>
                                        </xsl:for-each>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>3. Verschil tussen het aantal toegelaten kiezers en het aantal getelde stembiljetten</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par</xsl:text>
                            ...
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 0"/>
                            <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s1\f0\fs24\sl-270\f1\fs18 </xsl:text>
                            <xsl:text>{\f1\fs18\i </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>In de processen-verbaal van de stembureaus is vastgesteld of er:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Voor beide categorieën afzonderlijk stelt u het aantal voor </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:for-each select="$XML">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Welke verschillen zijn in de processen-verbaal vastgesteld tussen het aantal toegelaten kiezers en het aantal getelde stembiljetten?</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_2_0" select="round($altova:nTableWidthTw_2 * 0.70 * $altova:TableWidthFactor_2)"/>
                            <xsl:variable name="altova:nColumnWidthTw_2_1" select="round($altova:nTableWidthTw_2 * 0.30 * $altova:TableWidthFactor_2)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:variable name="altova:RowStyle5">
                                ...
                                <xsl:text>\clvertalt\clpadl30\clpadfl3\clpadb30\clpadfb3\clpadt0\clpadft3\clpadr30\clpadfr3</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Mogelijke reden voor het verschil</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:variable name="altova:RowStyle6">
                                <xsl:text>\trrh0</xsl:text>
                                <xsl:variable name="altova:CurrGridPos_Tbl2" select="$altova:nTableIndentTw_2"/>
                                <xsl:text>\clvertalc\clpadl30\clpadfl3\clpadb30\clpadfb3\clpadt0\clpadft3\clpadr30\clpadfr3</xsl:text>
                                <xsl:if test="$altova:nColumnWidthTw_2_0 = $altova:nDefaultColumnWidthTw_2">
                                    <xsl:text>\clftsWidth1</xsl:text>
                                </xsl:if>
                                <xsl:text>\cellx</xsl:text>
                            ...
                            <xsl:for-each select="rg:BallotPaperNotReturned">
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_2_1 div 1440) - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>4. Aantal kiezers dat bij volmacht mocht stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal kiezers dat mocht stemmen met een geldig volmachtbewijs (schriftelijk of via ingevulde achterkant van de stempas of kiezerspas), bedraagt </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>5. Aantal kiezers dat met een kiezerspas mocht stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par\par</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal kiezers dat mocht stemmen met een kiezerspas bedraagt </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:for-each select="rg:VotersWithPollingCard">
                                <xsl:text>{\f1\fs18\b </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        ...
                        <xsl:for-each select="rg:PostalVotes">
                            <xsl:text>\page </xsl:text>
                        </xsl:for-each>
                        <xsl:call-template name="Line">
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                        ...
                        <xsl:for-each select="rg:PostalVotes">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>5a. Stemmen uitgebracht per brief</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:choose>
                                <xsl:when test="$isElection">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>a. Aantal stemmen per lijst en kandidaat</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Bij de briefstembureaus zijn de volgende stemmen uitgebracht:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>b. Aantal blanco en ongeldige stemmen</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:variable name="altova:nTableWidthIn_3" select="$altova:nMaxWidthIn * 0.52000"/>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(4401.00)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_3_0" select="round(2.50 * 1440 * $altova:TableWidthFactor_3)"/>
                                    <xsl:variable name="altova:nColumnWidthTw_3_1" select="round(0.56 * 1440 * $altova:TableWidthFactor_3)"/>
                                    <xsl:text>\pard\s0\f0\fs24</xsl:text>
                                    <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 1"/>
                                ...
                                <xsl:otherwise>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>a. Aantal stemmen</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:variable name="altova:nTableWidthIn_4" select="$altova:nMaxWidthIn * 0.52000"/>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(5801.00)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_4_0" select="round(3.47 * 1440 * $altova:TableWidthFactor_4)"/>
                                    <xsl:variable name="altova:nColumnWidthTw_4_1" select="round(0.56 * 1440 * $altova:TableWidthFactor_4)"/>
                                    <xsl:text>\pard\s0\f0\fs24</xsl:text>
                                    <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 1"/>
                                    ...
                                    <xsl:for-each select="rg:AffiliationVotes">
                                        ...
                                        <xsl:for-each select="rg:ValidVotes">
                                            <xsl:text>{\f1\fs18 </xsl:text>
                                            <xsl:apply-templates>
                                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_4_1 div 1440) - 0.02083 - 0.02083"/>
                                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                            </xsl:apply-templates>
                                            <xsl:text>}</xsl:text>
                                        </xsl:for-each>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>b. Aantal kiesgerechtigden</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Het aantal op grond van artikel 21 Wrr geregistreerde kiesgerechtigde personen met een woonplaats buiten Nederland bedraagt </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:for-each select="rg:Cast">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>c. Verschil tussen het aantal toegelaten kiezers en het aantal getelde stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>   In briefstembureaus zijn </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:for-each select="rg:MoreValidVotesThanAdmittedVoters">
                            ...
                            <xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(0.00 + 1.00 * $altova:nTableWidthTw_5)"/>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_5_0" select="round($altova:nTableWidthTw_5 * 0.70 * $altova:TableWidthFactor_5)"/>
                            <xsl:variable name="altova:nColumnWidthTw_5_1" select="round($altova:nTableWidthTw_5 * 0.30 * $altova:TableWidthFactor_5)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:for-each select="rg:EmptyPostalVotes">
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_1 div 1440) - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>6. Ondertekening</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                        <xsl:call-template name="LineBreakPdf">
                        ...
                        <xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(3150.50)"/>
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_6_0" select="round(2.19 * 1440 * $altova:TableWidthFactor_6)"/>
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="altova:nColumnWidthTw_7_0" select="round($altova:nTableWidthTw_7 * 0.83 * $altova:TableWidthFactor_7)"/>
        <xsl:variable name="altova:nColumnWidthTw_7_1" select="round($altova:nTableWidthTw_7 * 0.17 * $altova:TableWidthFactor_7)"/>
        <xsl:text>\pard</xsl:text>
        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 1"/>
        ...
        <xsl:call-template name="FooterLine">
            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_0 div 1440) + ($altova:nColumnWidthTw_7_1 div 1440)"/>
            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
        </xsl:call-template>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend7"/>
        ...
        <xsl:if test="$isHashcode=1">
            <xsl:call-template name="FooterWithHashcode">
                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_0 div 1440)"/>
                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
            </xsl:call-template>
        </xsl:if>
    ...
    <xsl:template name="AffiliationVotes">
        ...
        <xsl:for-each select="rg:AffiliationVotes">
            ...
            <xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(9001.00)"/>
            ...
            <xsl:variable name="altova:nColumnWidthTw_8_0" select="round(2.22 * 1440 * $altova:TableWidthFactor_8)"/>
            <xsl:variable name="altova:nColumnWidthTw_8_1" select="round(4.03 * 1440 * $altova:TableWidthFactor_8)"/>
            ...
            <xsl:variable name="tablestyle8">
                ...
                <xsl:text>\ts23\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
            </xsl:variable>
                ...
                <xsl:when test="$SV_OutputFormat = &apos;RTF&apos;">
                    <xsl:for-each select="eml:AffiliationIdentifier">
                        <xsl:for-each select="eml:RegisteredName">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_1 div 1440) - 0.01042 - 0.01042 - 0.01042"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                        </xsl:for-each>
            ...
            <xsl:choose>
                <xsl:when test="rg:CandidateVotes">
                    ...
                    <xsl:variable name="altova:nSumColumnWidthsTw_9" select="round(9001.50)"/>
                    ...
                    <xsl:variable name="altova:nColumnWidthTw_9_0" select="round(0.83 * 1440 * $altova:TableWidthFactor_9)"/>
                    <xsl:variable name="altova:nColumnWidthTw_9_1" select="round(4.33 * 1440 * $altova:TableWidthFactor_9)"/>
                    <xsl:variable name="altova:nColumnWidthTw_9_2" select="round(1.08 * 1440 * $altova:TableWidthFactor_9)"/>
                    <xsl:text>\pard\f0\fs24</xsl:text>
                    <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 1"/>
                    <xsl:variable name="tablestyle9">
                        ...
                        <xsl:text>\ts24\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                    </xsl:variable>
                    ...
                    <xsl:for-each select="rg:CandidateVotes">
                        ...
                        <xsl:for-each select="eml:Candidate">
                            <xsl:for-each select="eml:CandidateFullName">
                                <xsl:call-template name="LastNameH1">
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_9_1 div 1440) - 0.01042 - 0.01042 - 0.01042 - 0.01042"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:call-template>
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                        ...
                        <xsl:for-each select="rg:ValidVotes">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_9_2 div 1440) - 0.01042 - 0.01042 - 0.01042 - 0.01042"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                        </xsl:for-each>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:variable name="altova:nSumColumnWidthsTw_10" select="round(0.00)"/>
                    ...
                    <xsl:variable name="altova:nDefaultColumnWidthTw_10">
                        <xsl:value-of select="$altova:nTableWidthTw_10 div $altova:nColumnsWithDefaultWidthNotZero_10"/>
                    </xsl:variable>
                    ...
                    <xsl:variable name="tablestyle10">
                        ...
                        <xsl:text>\ts25\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf142\brdrw15\trbrdrl\brdrs\brdrcf142\brdrw15\trbrdrb\brdrs\brdrcf142\brdrw15\trbrdrr\brdrs\brdrcf142\brdrw15</xsl:text>
                    </xsl:variable>
                    ...
                    <xsl:for-each select="rg:ValidVotes">
                        <xsl:text>{\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_10_1 div 1440) - 0.01042 - 0.01042 - 0.02083 - 0.02083"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                    </xsl:for-each>

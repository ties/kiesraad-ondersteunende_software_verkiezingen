            ...
            <xsl:for-each select="n1:EML">
                <xsl:for-each select="n1:OptionsList">
                    <xsl:for-each select="n1:Election">
                        ...
                        <xsl:variable name="altova:nSumColumnWidthsTw_0" select="round(1700.50)"/>
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_0_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_0)"/>
                        ...
                        <xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(1700.50)"/>
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_1_0" select="round(1.18 * 1440 * $altova:TableWidthFactor_1)"/>
                        ...
                        <xsl:variable name="tablestyle1">
                            ...
                            <xsl:text>\ts16\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                        </xsl:variable>
                        ...
                        <xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(1700.50)"/>
                        ...
                        <xsl:variable name="tablestyle2">
                            ...
                            <xsl:text>\ts17\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                        </xsl:variable>
                        ...
                        <xsl:for-each select="n1:Proposal">
                            <xsl:for-each select="n1:Options">
                                <xsl:for-each select="n1:ReferendumOptionIdentifier">
                                    ...
                                    <xsl:text>{\f1\fs18 </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_2_1 div 1440) - 0.01042 - 0.01042"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                    </xsl:apply-templates>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>

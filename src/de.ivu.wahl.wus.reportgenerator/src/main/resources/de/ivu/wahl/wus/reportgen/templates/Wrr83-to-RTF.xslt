        ...
        <xsl:for-each select="$XML">
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:Count">
                    <xsl:variable name="includesPostalVotes" select="count (//eml:ElectionCategory[text() = &quot;TK&quot; or text() = &quot;EP&quot; or text() = &quot;NR&quot;]) &gt; 0 and count(eml:Election/eml:Contests/eml:Contest/eml:ContestIdentifier[@Id = 12]) &gt; 0"/>
                    <xsl:variable name="isElection" select="count(//eml:ElectionCategory[.!=&quot;NR&quot; and .!=&quot;PR&quot; and .!= &quot;LR&quot;])"/>
                            ...
                            <xsl:for-each select="eml:ElectionCategory">
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Model Wrr 83</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:text>\par </xsl:text>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Proces-verbaal van de uitslag van het referendum</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:text>\par </xsl:text>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Met dit formulier doet het centraal stembureau verslag van de zitting waarin de uitslag is vastgesteld van het referendum.</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:text>\par </xsl:text>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>1. Referendum</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:text>\par </xsl:text>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Het gaat om het referendum over </xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
                    ...
                    <xsl:for-each select="rg:RG510">
                        ...
                        <xsl:for-each select="rg:PresenceVotes">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>3. Aantal stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="altova:nTableWidthIn_1">
                                <xsl:choose>
                                    <xsl:when test="4.16667 &gt; $altova:nMaxWidthIn">
                                        <xsl:value-of select="$altova:nMaxWidthIn"/>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:value-of select="4.16667"/>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </xsl:variable>
                            ...
                            <xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(7301.50)"/>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_1_0" select="round(4.17 * 1440 * $altova:TableWidthFactor_1)"/>
                            <xsl:variable name="altova:nColumnWidthTw_1_1" select="round(0.69 * 1440 * $altova:TableWidthFactor_1)"/>
                            <xsl:variable name="altova:nColumnWidthTw_1_2" select="round(0.21 * 1440 * $altova:TableWidthFactor_1)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:for-each select="rg:AffiliationVotes">
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Het totaal aantal stemmen </xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:choose>
                                    <xsl:when test="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Voor&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;voor&quot;">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>voor de wet / het verdrag</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:when test="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Tegen&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;tegen&quot;">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>tegen de wet / het verdrag</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>voor het antwoord </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het totaal aantal blanco stemmen bedraagt</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het totaal aantal geldig uitgebrachte stemmen bedraagt</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="rg:TotalCounted + rg:BlancVotes"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het totaal aantal ongeldige stemmen bedraagt</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>4. Aantal kiesgerechtigden</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                                            ...
                                            <xsl:for-each select="eml:Contests">
                                                <xsl:for-each select="eml:Contest">
                                                    <xsl:for-each select="eml:TotalVotes">
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>Het totaal aantal kiesgerechtigden voor het referendum bedraagt </xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>5. Vaststelling van de opkomst van het referendum</xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                        <xsl:text>\par </xsl:text>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>Het opkomstpercentage bedraagt </xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                        <xsl:call-template name="Fraction">
                                                            <xsl:with-param name="x" select="100 * (eml:TotalCounted + eml:RejectedVotes[@ReasonCode=&quot;blanco&quot;] + eml:RejectedVotes[@ReasonCode=&quot;ongeldig&quot;])"/>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>6. Vaststelling van de uitslag van het referendum</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="altova:nTableWidthIn_2">
                                <xsl:choose>
                                    <xsl:when test="4.86111 &gt; $altova:nMaxWidthIn">
                                        <xsl:value-of select="$altova:nMaxWidthIn"/>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <xsl:value-of select="4.86111"/>
                                    </xsl:otherwise>
                                </xsl:choose>
                            </xsl:variable>
                            ...
                            <xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(7001.00)"/>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_2_0" select="round(2.08 * 1440 * $altova:TableWidthFactor_2)"/>
                            <xsl:variable name="altova:nColumnWidthTw_2_1" select="round(2.78 * 1440 * $altova:TableWidthFactor_2)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:for-each select="rg:AffiliationVotes">
                                <xsl:variable name="altova:RowStyle7">
                                    ...
                                    <xsl:text>\clvertalt\clmgf\clpadl30\clpadfl3\clpadb30\clpadfb3\clpadt30\clpadft3\clpadr30\clpadfr3</xsl:text>
                                    ...
                                    <xsl:text>\clvertalt\clmrg\clpadl30\clpadfl3\clpadb30\clpadfb3\clpadt30\clpadft3\clpadr30\clpadfr3</xsl:text>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>Van het aantal kiezers dat een </xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\f1\fs18\b </xsl:text>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text> stem heeft uitgebracht, heeft</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:text>\f0\fs24</xsl:text>
                                ...
                                <xsl:text>\ql\sl0\f1\fs18 </xsl:text>
                                <xsl:for-each select="rg:ValidVotes">
                                    <xsl:variable name="validVotes" select="."/>
                                    <xsl:for-each select="$XML">
                                        <xsl:for-each select="eml:EML">
                                            <xsl:for-each select="eml:Count">
                                                <xsl:for-each select="eml:Election">
                                                        ...
                                                        <xsl:for-each select="eml:Contest">
                                                            <xsl:for-each select="eml:TotalVotes">
                                                                <xsl:call-template name="Fraction">
                                                                    ...
                                                                    <xsl:with-param name="y" select="eml:TotalCounted + eml:RejectedVotes[@ReasonCode=&quot;blanco&quot;]"/>
                                ...
                                <xsl:choose>
                                    <xsl:when test="eml:AffiliationIdentifier/eml:RegisteredName=&quot;Voor&quot; or eml:AffiliationIdentifier/eml:RegisteredName=&quot;voor&quot;">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>de wet/het verdrag gestemd.</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>7. Verschil tussen het aantal toegelaten kiezers en het aantal getelde stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par</xsl:text>
                            ...
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 0"/>
                            <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s1\f0\fs24\sl-480\f1\fs18 </xsl:text>
                            <xsl:text>{\f1\fs18\i </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>In de processen-verbaal van de stembureaus is vastgesteld in hoeverre er:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Voor beide categorieën afzonderlijk stelt u het aantal voor het referendum vast.</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                            ...
                            <xsl:for-each select="rg:BallotPaperNotReturned">
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_1 div 1440) - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>8. Aantal kiezers dat bij volmacht mocht stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>9. Bezwaren van aanwezige kiezers</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(901.00)"/>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_4_1" select="round(0.21 * 1440 * $altova:TableWidthFactor_4)"/>
                            ...
                            <xsl:variable name="tablestyle4">
                                ...
                                <xsl:text>\ts19\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                            </xsl:variable>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>10. Geschillen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Tijdens het onderzoeken van de geldigheid van de stemming en de juistheid van de vaststelling van de uitkomsten van de stemming door de stembureaus en de hoofdstembureaus, zijn te dien aanzien:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="tablestyle5">
                                ...
                                <xsl:text>\ts20\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                            </xsl:variable>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>geen geschillen gerezen.</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>geschillen gerezen: zie gewaarmerkte bijlage met opmerkingen van het centraal stembureau.</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>11. Ondertekening</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het proces-verbaal wordt ondertekend door alle aanwezige leden van het centraal stembureau.</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>

                        ...
                        <xsl:for-each select="rg:OverviewOfElectedCandidates">
                            <xsl:for-each select="rg:ElectedCandidate">
                                ...
                                <xsl:for-each select="eml:Candidate">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>, dient u daarnaast nog een gewaarmerkt afschrift van gegevens uit de basisregistratie personen te overleggen, waaruit blijkt dat u niet bent uitgesloten van het kiesrecht en waar verder uw woonplaats, datum en plaats van geboorte </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>

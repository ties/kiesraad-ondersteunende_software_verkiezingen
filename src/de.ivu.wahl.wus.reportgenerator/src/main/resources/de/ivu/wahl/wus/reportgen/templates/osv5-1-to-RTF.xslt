...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altova-xfi altovaext array clitype ds eml fn iso4217 ix java kr link map math rg sps ts xal xbrldi xbrli xff xfi xlink xnl xs xsi">
    ...
    <xsl:template match="*" priority="-1.0">
        <xsl:param name="altova:nMaxWidthIn" select="6.31944"/>
    ...
    <xsl:template match="/">
        <xsl:variable name="altova:nMaxWidthIn" select="6.31944"/>
        ...
        <xsl:call-template name="altova:DocumentSection_0">
            <xsl:with-param name="altova:nMaxWidthIn" select="6.32"/>
            <xsl:with-param name="templatetablelevel" select="$templatetablelevel"/>
        </xsl:call-template>
        <xsl:text>}</xsl:text>
    </xsl:template>
    <xsl:template name="altova:DocumentSection_0">
        ...
        <xsl:text>\sectd\facingp\pgwsxn11900\pghsxn16820\margtsxn1400\marglsxn1400\margbsxn1120\margrsxn1400\headery700\footery700\cols1\colsx720\pgndec\ftnbj\ftnrstcont\ftnnar</xsl:text>
        <xsl:text>{</xsl:text>
                        ...
                        <xsl:for-each select="rg:OverviewOfElectedCandidates">
                            <xsl:for-each select="rg:ElectedCandidate">
                                ...
                                <xsl:for-each select="eml:Candidate">
                                    ...
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 0"/>
                                    <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s0\f0\fs24\ql\sl0\f1\fs18 </xsl:text>
                                    ...
                                    <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                                        ...
                                        <xsl:text>\itap</xsl:text>
                                        <xsl:value-of select="$templatetablelevel + 0"/>
                                        <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s0\f0\fs24\qr\sl0\sb1999\f1\fs18 </xsl:text>
                                    ...
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 0"/>
                                    <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s0\f0\fs24\qr\sl0\f1\fs18 </xsl:text>
                                    <xsl:for-each select="$XML">
                                        <xsl:for-each select="eml:EML">
                                            <xsl:for-each select="eml:Result">
                                                <xsl:for-each select="rg:RG520">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Het centraal stembureau voor de verkiezing van de leden van </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:for-each select="$XML">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> de verkiezingsuitslag vastgesteld. Hierbij stel ik u ervan in kennis dat </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:for-each>
                                    <xsl:choose>
                                        <xsl:when test="$hasAgent">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text> op grond van deze uitslag is benoemd tot lid van </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>u op grond van deze uitslag bent benoemd tot lid van </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>. Graag informeer ik u over de verdere gang van zaken op grond van de artikelen V 1 tot en met V 3 van de Kieswet.</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> wenst aan te nemen, dient u hiervan uiterlijk  op de 10</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\f1\fs20\super </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>e</xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> dag na dagtekening van deze brief mededeling te doen aan de voorzitter van </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:for-each select="$XML">
                                        <xsl:for-each select="eml:EML">
                                            <xsl:for-each select="eml:Result">
                                                <xsl:for-each select="eml:Election">
                                                    <xsl:call-template name="ElectionNameAcceptanceShort">
                                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                                    </xsl:call-template>
                                                </xsl:for-each>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>. Hiervoor kunt u gebruik maken van het formulier dat als bijlage bij deze brief is gevoegd. Heeft de voorzitter van </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:for-each select="$XML">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> uw mededeling niet binnen de genoemde termijn ontvangen, dan wordt </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:choose>
                                        <xsl:when test="$hasAgent">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>de kandidaat geacht de benoeming niet te hebben aangenomen. Indien </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                            <xsl:choose>
                                                ...
                                                <xsl:otherwise>
                                                    ...
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text>hij zijn / zij haar</xsl:text>
                                                        </xsl:with-param>
                                                    </xsl:call-template>
                                                    <xsl:text>}</xsl:text>
                                                </xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text> benoeming niet aan wenst te nemen,</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>u geacht de benoeming niet te hebben aangenomen. Wilt u de benoeming niet aannemen,</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> dan verzoek ik u hiervan aan ondergetekende mededeling te doen, eveneens uiterlijk op de 10</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\f1\fs20\super </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> dag na dagtekening van deze brief. Ook hiervoor kunt u gebruik maken van het bijgevoegde formulier.</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Bij de mededeling omtrent de aanneming van de benoeming dient u een door </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:choose>
                                        <xsl:when test="$hasAgent">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>de benoemd verklaarde kandidaat ondertekende verklaring te overleggen, waarin alle openbare betrekkingen vermeld zijn die deze bekleedt. Indien de kandidaat thans geen zitting heeft in </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>u ondertekende verklaring te overleggen, waarin alle openbare betrekkingen worden vermeld die u bekleedt. Indien u thans geen zitting hebt in </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>, dient u daarnaast nog een gewaarmerkt afschrift van gegevens uit de basisregistratie personen te overleggen, waaruit blijkt dat </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:choose>
                                        <xsl:when test="$hasAgent">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>kandidaat niet is uitgesloten van het kiesrecht en waar verder de woonplaats, datum en plaats van geboorte </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                            <xsl:if test="//eml:ElectionCategory[ text() =&quot;TK&quot; or text() =&quot;EK&quot; or text() =&quot;EP&quot; or text() =&quot;PS&quot; ]">
                                                <xsl:text>{\f1\fs18 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>en Nederlanderschap </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:if>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>van kandidaat uit blijken.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>u niet bent uitgesloten van het kiesrecht en waar verder uw woonplaats, datum en plaats van geboorte </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                            <xsl:if test="//eml:ElectionCategory[ text() =&quot;TK&quot; or text() =&quot;EK&quot; or text() =&quot;EP&quot; or text() =&quot;PS&quot; ]">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>en uw Nederlanderschap </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:if>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Met vriendelijke groet, </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Formulier voor het al dan niet aannemen van de benoeming</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Met dit formulier geeft de benoemde, of diens gemachtigde, aan of hij de benoeming aanneemt. Deze mededeling wordt gedaan aan de voorzitter van het vertegenwoordigend orgaan of, indien de benoeming niet wordt aangenomen, aan de voorzitter van het centraal stembureau. </xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Indien u aangeeft de benoeming aan te nemen, kunt u bij brief aan het vertegenwoordigend orgaan op deze benoeming terugkomen. Dit kan zolang nog niet tot toelating is besloten. U wordt dan geacht de benoeming niet te hebben aangenomen.</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Bij het aannemen van de benoeming moeten tegelijk met deze mededeling op grond van artikel V 3 van de Kieswet enkele aanvullende stukken worden overgelegd. Het gaat hierbij om de volgende stukken:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Ondertekende verklaring, vermeldende alle openbare betrekkingen die de benoemde bekleedt;</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Gewaarmerkt afschrift uit de basisregistratie personen, waaruit de woonplaats, datum en plaats van de geboorte van de benoemde blijken, alsmede, indien het betreft een benoeming tot lid van de Tweede of Eerste Kamer of provinciale staten, het Nederlanderschap van de benoemde (alleen als u niet reeds op het moment van benoeming lid bent van het desbetreffende vertegenwoordigend orgaan).</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="//eml:ElectionCategory[ text() =&quot;GR&quot; ]">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Indien u tot lid van de gemeenteraad bent benoemd, en geen onderdaan van een lidstaat van de Europese Unie bent, legt u een gewaarmerkt afschrift over uit de basisregistratie personen, waaruit blijkt of u voldoet aan de vereisten, bedoeld in artikel 10, tweede lid, van de Gemeentewet.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                            <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>1. Mededeling</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Hierbij verklaar ik de benoeming:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> aan te nemen.</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> niet aan te nemen.</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>2. Ondertekening</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(1800.50)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_1_0" select="round(1.25 * 1440 * $altova:TableWidthFactor_1)"/>
                                    ...
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 1"/>
                                    <xsl:text>\ql\sl0\f1\fs18\s0\f0\fs24\sl0\f1\fs18 </xsl:text>
                                    <xsl:text>{\f1\fs18 </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>3. Deze mededeling toezenden aan:</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par\par</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Bij aanneming van de benoeming</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Bij niet-aanneming van de benoeming</xsl:text>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="ElectionNameAcceptanceShort">
        <xsl:param name="altova:nMaxWidthIn" select="6.31944"/>
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:if test="0=1">
            <xsl:text>{\f1\fs18 </xsl:text>
                    ...
                    <xsl:when test=".= &quot;TK&quot; or .= &quot;EP&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_tweedeKamer"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:when test=".=&quot;EK&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>de Eerste Kamer</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:when>
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_eersteKamer"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:when test=".=&quot;PS&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_provincialeStaten"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:when test=".=&quot;AB&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>het algemeen bestuur</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:when>
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_algemeen_bestuur"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:when test=".=&quot;GR&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_raadVanDeGemeente"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:when test=".=&quot;BC&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_bestuurscommissie"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:when test=".=&quot;GC&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_gebiedscommissie"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>
                    ...
                    <xsl:when test=".=&quot;ER&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_ElectionNameAcceptanceShort_eilandsraad"/>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                            </xsl:otherwise>

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype ds eml fn iso4217 ix java kr link rg sps ts xal xbrldi xbrli xlink xnl xs xsi">
    ...
    <xsl:template match="/">
        ...
        <xsl:text>{\s21\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s22\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s174\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s175\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s206\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s207\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s210\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s211\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s214\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s215\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s218\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s219\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s222\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s223\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s226\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s227\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s230\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s231\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s234\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s235\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s239\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s240\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s251\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s252\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s261\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s262\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s263\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s264\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s594\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s595\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s596\sl0\f1\fs22\snext0 *;}</xsl:text>
        <xsl:text>{\s597\sl0\fs22\snext0 p;}</xsl:text>
        ...
        <xsl:text>{\*\cs35\f1\fs22\snext0 Character *;}</xsl:text>
        ...
        <xsl:text>{\*\cs662\f1\fs22\snext0 Character *;}</xsl:text>
        ...
        <xsl:text>{\*\ts205\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts265\tsrowd\ql\f1\fs22\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts266\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts270\tsrowd\ql\f1\fs22\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts271\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts280\tsrowd\ql\f1\fs22\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts281\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts645\tsrowd\ql\f1\fs22\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts646\tsrowd\ql\f1\fs18\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>}</xsl:text>
                    ...
                    <xsl:for-each select="rg:RG520">
                        <xsl:for-each select="rg:OverviewOfElectedCandidates">
                            <xsl:for-each select="eml:Candidate">
                                <xsl:variable name="hasAgent" select="count( eml:Agent ) &gt; 0"/>
                                <xsl:variable name="livesOutsideNL" select="count( eml:QualifyingAddress/xal:Country/xal:CountryNameCode[text() != &quot;NL&quot;] ) &gt; 0"/>
                                ...
                                <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                                    ...
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 0"/>
                                    <xsl:text>\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s19\s20\qr\sl0\sb1999\f1\fs22 </xsl:text>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 0"/>
                                <xsl:text>\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s21\s22\qr\sl0\f1\fs22 </xsl:text>
                                <xsl:for-each select="$XML">
                                    <xsl:for-each select="eml:EML">
                                        <xsl:for-each select="eml:Result">
                                            <xsl:for-each select="rg:RG520">
                                                <xsl:for-each select="rg:CandidateLetter">
                                                    ...
                                                    <xsl:if test="count(rg:DateLetter[text() != &quot;&quot;]) &gt; 0 and count(rg:PlaceLetter[text() != &quot;&quot;]) &gt; 0">
                                                    ...
                                                    <xsl:for-each select="rg:DateLetter">
                                ...
                                <xsl:text>\par\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$hasAgent">
                                        <xsl:for-each select="eml:Agent">
                                            <xsl:for-each select="eml:AgentIdentifier">
                                                <xsl:for-each select="eml:AgentName">
                                                    <xsl:call-template name="AddressBlock1">
                                                        <xsl:with-param name="gender" select="&quot;agent&quot;"/>
                                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                                    </xsl:call-template>
                                                </xsl:for-each>
                                            </xsl:for-each>
                                            <xsl:call-template name="AddressBlock2">
                                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                            </xsl:call-template>
                                        </xsl:for-each>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_030_Geachte"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$hasAgent">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>heer/mevrouw</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_060_heerMevrouw"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            <xsl:when test="eml:Gender = &quot;male&quot;">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <xsl:text>{\cs30\f1\fs22 </xsl:text>
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>heer</xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_040_heer"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender = &quot;female&quot;">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_050_mevrouw"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender = &quot;unknown&quot;">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                    ...
                                                    <xsl:otherwise>
                                                        <xsl:text>{\cs35\f1\fs22 </xsl:text>
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_050_mevrouw"/>
                                                            </xsl:with-param>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_070_1_deelIkUMee"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:if test="//eml:ElectionCategory =&quot;EP&quot;">
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_070_2_deelIkUMee"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> artikel V 1, eerste lid, van de Kieswet deel ik u mee, dat </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_070_3_deelIkUMee"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                    ...
                                    <xsl:when test="$hasAgent">
                                                ...
                                                <xsl:when test=".=&quot;male&quot;">
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:otherwise>
                                                            ...
                                                            <xsl:call-template name="write-text">
                                                                <xsl:with-param name="text">
                                                                    <xsl:value-of select="$o5-1_005_1_Geslacht"/>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                            <xsl:text>}</xsl:text>
                                                        </xsl:otherwise>
                                                ...
                                                <xsl:when test=".=&quot;female&quot;">
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:otherwise>
                                                            ...
                                                            <xsl:call-template name="write-text">
                                                                <xsl:with-param name="text">
                                                                    <xsl:value-of select="$o5-1_005_2_Geslacht"/>
                                                                </xsl:with-param>
                                                            </xsl:call-template>
                                                            <xsl:text>}</xsl:text>
                                                        </xsl:otherwise>
                                        ...
                                        <xsl:for-each select="eml:CandidateFullName">
                                            <xsl:for-each select="xnl:PersonName">
                                                <xsl:for-each select="xnl:NameLine[@NameType=&quot;Initials&quot;]">
                                                ...
                                                <xsl:if test="count(xnl:NameLine[@NameType=&quot;Initials&quot; and text() != &quot;&quot;]) &gt; 0">
                                                    <xsl:text>{\cs53\f1\fs22 </xsl:text>
                                                    <xsl:call-template name="write-text">
                                                        <xsl:with-param name="text">
                                                            <xsl:text> </xsl:text>
                                                        </xsl:with-param>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text> benoemd is tot lid van </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_070_5_deelIkUMee"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>u benoemd bent tot lid van </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_070_4_deelIkUMee"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>. Onderstaand informeer ik u nader omtrent de verdere gang van zaken.</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_075_OnderstaandInformeer"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender = &quot;male&quot;">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>Indien hij zijn benoeming tot lid van </xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_080_1a_benoemingAanneemt"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender = &quot;female&quot;">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>Indien zij haar benoeming tot lid van </xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_080_1b_benoemingAanneemt"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>Indien hij zijn / zij haar benoeming tot lid van </xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_080_1c_benoemingAanneemt"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>Indien u uw benoeming tot lid van </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_080_1_benoemingAanneemt"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> aanneemt, dient u hiervan uiterlijk </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_080_2_benoemingAanneemt"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:for-each select="$XML">
                                    <xsl:for-each select="eml:EML">
                                        <xsl:for-each select="eml:Result">
                                            <xsl:for-each select="rg:RG520">
                                                <xsl:for-each select="rg:CandidateLetter">
                                                    <xsl:for-each select="rg:DateFeedback">
                                                        <xsl:call-template name="Date">
                                                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                                        </xsl:call-template>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (uiterlijk 10e dag na dagtekening) mededeling te doen aan de voorzitter van </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_080_3_benoemingAanneemt"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:text>}</xsl:text>
                                <xsl:if test="//eml:ElectionCategory =&quot;TK&quot;">
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            <xsl:text>{\cs75\f1\fs22 </xsl:text>
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>In verband met de eerste samenkomst van de nieuwgekozen kamer op </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_080_4_benoemingAanneemt"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text> (datum eerste samenkomst) is het echter raadzaam deze mededeling zo spoedig mogelijk aan de voorzitter te doen toekomen. </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_080_5_benoemingAanneemt"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>Voor de mededeling kunt u gebruik maken van het formulier dat als bijlage bij deze brief is gevoegd. Heeft de voorzitter van </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_090_1_VoorDeMededeling"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> de mededeling niet op </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_090_2_VoorDeMededeling"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                    ...
                                    <xsl:when test="$hasAgent">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text> (uiterlijk 10e dag na dagtekening) ontvangen, dan wordt de kandidaat geacht de benoeming niet aan te nemen.</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_090_4_VoorDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text> (uiterlijk 10e dag na dagtekening) ontvangen, dan wordt u geacht de benoeming niet aan te nemen.</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_090_3_VoorDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:when test="$hasAgent">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>Bij de mededeling omtrent de aanneming van de benoeming dient u te overleggen een door de kandidaat ondertekende verklaring, waarin alle openbare betrekkingen vermeld zijn die deze bekleedt. Indien de kandidaat thans geen zitting heeft in </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_100_1_BijDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>Bij de mededeling omtrent de aanneming van de benoeming dient u te overleggen een door u ondertekende verklaring, waarin u alle openbare betrekkingen vermeldt, die u bekleedt. Indien u thans geen zitting hebt in </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:text>{\cs90\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_100_2_BijDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$hasAgent and not($livesOutsideNL)">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <xsl:text>{\cs91\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>, dient u daarnaast te overleggen een gewaarmerkt afschrift van gegevens uit de basisadministratie persoonsgegevens van de gemeente waar de kandidaat woonachtig is, waaruit </xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_100_3_BijDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender = &quot;male&quot;">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_100_3b_BijDeMededeling"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender = &quot;female&quot;">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_100_3c_BijDeMededeling"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_100_3d_BijDeMededeling"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <xsl:text>{\cs101\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text> woonplaats, datum en plaats van geboorte</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_100_3e_BijDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:when test="$hasAgent and $livesOutsideNL">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <xsl:text>{\cs103\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>, dient u daarnaast te overleggen een uittreksel uit het geboorteregister, waaruit datum en plaats van de geboorte van de kandidaat blijken</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:text>{\cs104\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_100_3a_BijDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>, dient u daarnaast te overleggen een gewaarmerkt afschrift van gegevens uit de basisadministratie persoonsgegevens van de gemeente waar u woonachtig bent, waaruit uw woonplaats, datum en plaats van geboorte</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_100_4_BijDeMededeling"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="//eml:ElectionCategory[ text() =&quot;TK&quot; or text() =&quot;EK&quot; or text() =&quot;PS&quot; ]">
                                        <xsl:choose>
                                            <xsl:when test="$hasAgent and not($livesOutsideNL)">
                                                <xsl:choose>
                                                    <xsl:when test="eml:Gender = &quot;male&quot;">
                                                        <xsl:choose>
                                                            <xsl:when test="$lang=0">
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:text>, alsmede zijn Nederlanderschap blijkt</xsl:text>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:when>
                                                            <xsl:otherwise>
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:value-of select="$o5-1_100_5b_BijDeMededeling"/>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:otherwise>
                                                    ...
                                                    <xsl:when test="eml:Gender = &quot;female&quot;">
                                                        <xsl:choose>
                                                            <xsl:when test="$lang=0">
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:text>, alsmede haar Nederlanderschap blijkt</xsl:text>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:when>
                                                            <xsl:otherwise>
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:value-of select="$o5-1_100_5c_BijDeMededeling"/>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:otherwise>
                                                    ...
                                                    <xsl:when test="eml:Gender = &quot;unknown&quot;">
                                                        <xsl:choose>
                                                            ...
                                                            <xsl:otherwise>
                                                                <xsl:text>{\cs112\f1\fs22 </xsl:text>
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:value-of select="$o5-1_100_5c_BijDeMededeling"/>
                                                                    </xsl:with-param>
                                                    ...
                                                    <xsl:otherwise>
                                                        <xsl:choose>
                                                            <xsl:when test="$lang=0">
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:text>, alsmede zijn / haar Nederlanderschap blijkt</xsl:text>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:when>
                                                            <xsl:otherwise>
                                                                ...
                                                                <xsl:call-template name="write-text">
                                                                    <xsl:with-param name="text">
                                                                        <xsl:value-of select="$o5-1_100_5_BijDeMededeling"/>
                                                                    </xsl:with-param>
                                                                </xsl:call-template>
                                                                <xsl:text>}</xsl:text>
                                                            </xsl:otherwise>
                                            ...
                                            <xsl:when test="$hasAgent and $livesOutsideNL">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>, alsmede een bewijs van het Nederlanderschap</xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_100_5a_BijDeMededeling"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:text>, alsmede uw Nederlanderschap blijkt</xsl:text>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_100_6_BijDeMededeling"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="$hasAgent and not($livesOutsideNL)">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_100_7_BijDeMededeling"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                    ...
                                    <xsl:when test="$hasAgent">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>Wil de kandidaat</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_110_1_nietAannemen"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_110_2_nietAannemen"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> de benoeming niet aannemen, dan dient u hiervan aan ondergetekende mededeling te doen, eveneens uiterlijk op </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_110_3_nietAannemen"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (uiterlijk 10e dag na dagtekening). Ook hiervoor kunt u gebruik maken van het bijgevoegde formulier. </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_110_4_nietAannemen"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:text>\par </xsl:text>
                                <xsl:text>\par </xsl:text>
                                <xsl:if test="//eml:ElectionCategory [ text() != &quot;GR&quot; and text() != &quot;BC&quot; and text() != &quot;GC&quot; and text() != &quot;ER&quot; ]">
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            <xsl:text>{\cs132\f1\fs22 </xsl:text>
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>De tekst van de relevante bepalingen uit de Kieswet treft u bijgaand aan.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_110_1_tekstKieswet"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_120_DeVoorzitter"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:if test="//eml:ElectionCategory [ text() != &quot;GR&quot; and text() != &quot;BC&quot; and text() != &quot;GC&quot; and text() != &quot;ER&quot; ]">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            <xsl:text>{\cs138\f1\fs22 </xsl:text>
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Relevante bepalingen uit de Kieswet</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_130_RelevanteBepalingen"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            <xsl:text>{\cs140\f1\fs22 </xsl:text>
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Artikel V 1</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_140_ArtikelV1"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_150_ArtikelV1-1"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>2. Indien de benoemde een gemachtigde heeft aangewezen, geschiedt de toezending of uitreiking aan die gemachtigde.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_160_ArtikelV1-2"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>3. De voorzitter geeft tegelijkertijd schriftelijk kennis van de benoeming aan het vertegenwoordigend orgaan. Deze kennisgeving strekt de benoemde tot geloofsbrief.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_170_ArtikelV1-3"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_180_ArtikelV2"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_190_ArtikelV2-1"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>2. Is binnen die tijd de mededeling niet ontvangen, dan wordt hij geacht de benoeming niet aan te nemen.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_200_ArtikelV2-2"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>3. De voorzitter van het vertegenwoordigend orgaan deelt aan de voorzitter van het centraal stembureau onverwijld mede, dat de benoemde de benoeming heeft aangenomen, dan wel dat hij geacht wordt de benoeming niet aan te nemen.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_210_ArtikelV2-3"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>4. Indien de benoemde de benoeming niet aanneemt, doet hij of zijn gemachtigde daarvan binnen de in het eerste lid bedoelde termijn bij brief mededeling aan de voorzitter van het centraal stembureau. Deze geeft hiervan kennis aan het vertegenwoordigend orgaan.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_220_ArtikelV2-4"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_230_ArtikelV2-5"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Artikel V 3, eerste t/m derde lid</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_240_ArtikelV3"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>1. Tegelijk met de mededeling dat hij zijn benoeming aanneemt, legt de benoemde, onderscheidenlijk zijn gemachtigde, aan het vertegenwoordigend orgaan een door hem ondertekende verklaring over, vermeldende alle openbare betrekkingen die de benoemde bekleedt.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_250_ArtikelV3-1"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>2. Tenzij de benoemde op het tijdstip van benoeming reeds lid van het vertegenwoordigend orgaan was, legt hij tevens een gewaarmerkt afschrift van gegevens uit de basisadministratie persoonsgegevens van de gemeente waar hij als ingezetene is ingeschreven over, waaruit zijn woonplaats, datum en plaats van de geboorte, alsmede, indien het betreft een benoeming tot lid van de Tweede of Eerste Kamer of provinciale staten, zijn Nederlanderschap blijken.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_260_ArtikelV3-2"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>3. De gemachtigde van de benoemde die buiten Nederland woonplaats heeft, legt in plaats van het afschrift, bedoeld in het tweede lid, een uittreksel uit de geboorteregisters over, waaruit datum en plaats van de geboorte van de benoemde blijken, alsmede een bewijs van Nederlanderschap betreffende de benoemde.</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o5-1_270_ArtikelV3-3"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:if test="//eml:ElectionCategory =&quot;EP&quot;">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>Artikel Y 25</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_280_ArtikelY25"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>1. De Tweede Kamer onderzoekt zo spoedig mogelijk of de benoemde op grond van de nationale bepalingen als lid van het Europees Parlement kan worden toegelaten.</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:text>{\cs171\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_290_ArtikelY25-1"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <xsl:text>{\cs172\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:text>2. De artikelen V 1 tot en met V 10 zijn daarbij van overeenkomstige toepassing, met dien verstande dat waar in deze artikelen sprake is van het vertegenwoordigend orgaan of het orgaan waarvoor de benoeming is geschied, daarvoor de Tweede Kamer in de plaats treedt.</xsl:text>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:text>{\cs173\f1\fs22 </xsl:text>
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_300_ArtikelY25-2"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 0"/>
                                <xsl:text>\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s174\s175\ql\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs176\f1\fs22 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>Hierbij verklaar ik dat </xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_310_1_benoemingAanneem"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$hasAgent">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="eml:Gender[ text() =&quot;male&quot; ]">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_310_2a_benoemingAanneem"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender[ text() = &quot;female&quot; ]">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_310_2b_benoemingAanneem"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                            ...
                                            <xsl:when test="eml:Gender[ text() = &quot;unknown&quot; ]">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                            ...
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        ...
                                                        <xsl:call-template name="write-text">
                                                            <xsl:with-param name="text">
                                                                <xsl:value-of select="$o5-1_310_2c_benoemingAanneem"/>
                                                            </xsl:with-param>
                                                        </xsl:call-template>
                                                        <xsl:text>}</xsl:text>
                                                    </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_310_2_benoemingAanneem"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_310_3_benoemingAanneem"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_310_4_benoemingAanneem"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                    ...
                                    <xsl:when test="$hasAgent">
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_310_5_benoemingAanneem"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                ...
                                                <xsl:call-template name="write-text">
                                                    <xsl:with-param name="text">
                                                        <xsl:value-of select="$o5-1_310_6_benoemingAanneem"/>
                                                    </xsl:with-param>
                                                </xsl:call-template>
                                                <xsl:text>}</xsl:text>
                                            </xsl:otherwise>
                                ...
                                <xsl:variable name="altova:nSumColumnWidthsTw_0" select="round(1800.50)"/>
                                ...
                                <xsl:variable name="altova:nColumnWidthTw_0_0" select="round(1.25 * 1440 * $altova:TableWidthFactor_0)"/>
                                <xsl:variable name="altova:nColumnWidthTw_0_1" select="$altova:nDefaultColumnWidthTw_0"/>
                                <xsl:text>\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                                ...
                                <xsl:variable name="tablestyle0">
                                    ...
                                    <xsl:text>\ts204\ts205\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                                </xsl:variable>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s206\s207\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_320_Datum"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s210\s211\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_330_gestippeldeLijn"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s214\s215\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_340_Plaats"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s218\s219\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s222\s223\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_350_Naam"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s226\s227\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s230\s231\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_360_Handtekening"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s234\s235\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                ...
                                <xsl:value-of select="$altova:RowStyle3"/>
                                <xsl:value-of select="$rowend0"/>
                                <xsl:text>\pard\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s174\s175\ql\sl0\f1\fs22</xsl:text>
                                <xsl:if test="$templatetablelevel + 0 &gt; 0">\intbl</xsl:if>
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 0"/>
                                <xsl:text> </xsl:text>
                                ...
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>________________________________________________________________</xsl:text>
                                    </xsl:with-param>
                                </xsl:call-template>
                                <xsl:text>}</xsl:text>
                                <xsl:text>\par\par</xsl:text>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 0"/>
                                <xsl:text>\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s239\s240\ql\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs241\f1\fs22 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>Zenden aan:</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_370_ZendenAan"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>bij aanneming</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_380_bijAanneming"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_390_voorzitter"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                        ...
                                        <xsl:for-each select="eml:Result">
                                            <xsl:for-each select="rg:RG520">
                                                <xsl:for-each select="rg:CandidateLetter">
                                                    ...
                                                    <xsl:text>\par </xsl:text>
                                                    <xsl:if test="rg:PostalCodeForAcceptance[text() != &quot;&quot;]">
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 0"/>
                                <xsl:text>\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s251\s252\ql\sl0\f1\fs22 </xsl:text>
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs253\f1\fs22 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>bij niet-aanneming</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_400_bijNietAanneming"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_410_voorzitterCSB"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
                                ...
                                <xsl:for-each select="$XML">
                                    <xsl:for-each select="eml:EML">
                                        <xsl:for-each select="eml:Result">
                                            <xsl:for-each select="rg:RG520">
                                                <xsl:for-each select="rg:CandidateLetter">
                                                    <xsl:for-each select="rg:AddressLineForRejection">
                                                    ...
                                                    <xsl:text>\par </xsl:text>
                                                    <xsl:if test="rg:PostalCodeForRejection[text() != &quot;&quot;]">
                                                        <xsl:for-each select="rg:PostalCodeForRejection">
                                                    ...
                                                    <xsl:for-each select="rg:LocationForRejection">
                                ...
                                <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                                    ...
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 0"/>
                                    <xsl:text>\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s261\s262\ql\sl0\f1\fs22 </xsl:text>
                                    <xsl:text>\s0\f0\fs24\f0\fs24</xsl:text>
                                </xsl:if>
                                <xsl:text>\par\par</xsl:text>
                                <xsl:text>\pard</xsl:text>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 0"/>
                                <xsl:text>\s1\f0\fs24\sl0\fs22\s15\s16\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s263\s264\sl0\f1\fs22 </xsl:text>
                                <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                                <xsl:if test="$templatetablelevel + 0 &gt; 0">\intbl</xsl:if>
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 0"/>
                                ...
                                <xsl:variable name="altova:nTableWidthIn_1" select="$altova:nMaxWidthIn * 0.90000"/>
                                ...
                                <xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(0.00 + 1.03 * $altova:nTableWidthTw_1)"/>
                                ...
                                <xsl:variable name="altova:nColumnWidthTw_1_0" select="round($altova:nTableWidthTw_1 * 0.03 * $altova:TableWidthFactor_1)"/>
                                <xsl:variable name="altova:nColumnWidthTw_1_1" select="round($altova:nTableWidthTw_1 * 1.00 * $altova:TableWidthFactor_1)"/>
                                ...
                                <xsl:variable name="tablestyle1">
                                    ...
                                    <xsl:text>\ts265\ts266\trpaddt0\trpaddl0\trpaddb0\trpaddr0\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
                                </xsl:variable>
                                ...
                                <xsl:text>\itap</xsl:text>
                                <xsl:value-of select="$templatetablelevel + 1"/>
                                <xsl:text>\ql\sl0\f1\fs16 </xsl:text>
                                ...
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text>Doorhalen wat niet van toepassing is.</xsl:text>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        ...
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$o5-1_420_Doorhalen"/>
                                            </xsl:with-param>
                                        </xsl:call-template>
                                        <xsl:text>}</xsl:text>
                                    </xsl:otherwise>
    ...
    <xsl:template name="AddressBlock1">
        <xsl:param name="altova:nMaxWidthIn" select="6.26389"/>
        <xsl:param name="templatetablelevel" select="0"/>
        ...
        <xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(0.00 + 0.40 * $altova:nTableWidthTw_2)"/>
        ...
        <xsl:variable name="altova:nColumnWidthTw_2_0" select="round($altova:nTableWidthTw_2 * 0.40 * $altova:TableWidthFactor_2)"/>
        ...
        <xsl:variable name="tablestyle2">
            ...
            <xsl:text>\ts270\ts271\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
        </xsl:variable>
    ...
    <xsl:template name="AddressBlock2">
        <xsl:param name="altova:nMaxWidthIn" select="6.26389"/>
        <xsl:param name="templatetablelevel" select="0"/>
        ...
        <xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(0.00 + 0.40 * $altova:nTableWidthTw_3)"/>
        ...
        <xsl:variable name="altova:nColumnWidthTw_3_0" select="round($altova:nTableWidthTw_3 * 0.40 * $altova:TableWidthFactor_3)"/>
        ...
        <xsl:variable name="tablestyle3">
            ...
            <xsl:text>\ts280\ts281\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
        </xsl:variable>
        ...
        <xsl:for-each select="eml:Contact">
            <xsl:for-each select="eml:MailingAddress">
                <xsl:call-template name="PostalCodeCity">
                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_0 div 1440) - 0.02083 - 0.02083"/>
                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                </xsl:call-template>
                <xsl:for-each select="xal:Country">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                ...
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="$o5-1_010_Onderwerp"/>
                    </xsl:with-param>
                </xsl:call-template>
                <xsl:text>}</xsl:text>
            </xsl:otherwise>
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                ...
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="$o5-1_020_BenoemingTotLid"/>
                    </xsl:with-param>
                </xsl:call-template>
                <xsl:text>}</xsl:text>
            </xsl:otherwise>
    ...
    <xsl:template name="Salutation">
        ...
        <xsl:if test="$isBold=0">
            <xsl:if test="0=1">
                <xsl:text>{\cs305\f1\fs22 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
            ...
            <xsl:for-each select="eml:Gender">
                <xsl:choose>
                    <xsl:when test=".=&quot;male&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs306\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>dhr. </xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs307\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
            ...
            <xsl:for-each select="eml:Gender">
                <xsl:choose>
                    <xsl:when test=".=&quot;male&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs311\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>dhr. </xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs312\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Salutation_dhr"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test=".=&quot;female&quot; or .=&quot;unknown&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs313\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>mevr. </xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs314\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Salutation_mevr"/>
                                    </xsl:with-param>
    ...
    <xsl:template name="Address">
        ...
        <xsl:if test="$isBold=1">
            <xsl:for-each select="xal:Locality">
                <xsl:for-each select="xal:AddressLine">
                    <xsl:text>{\cs317\f1\fs22\b </xsl:text>
                    <xsl:apply-templates>
                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                    </xsl:apply-templates>
    ...
    <xsl:template name="LastNameH1">
        ...
        <xsl:if test="$fontSize=&apos;smaller&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NamePrefix">
                        <xsl:text>{\cs326\f1\fs20 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:LastName">
                        <xsl:text>{\cs327\f1\fs20 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NamePrefix">
                        <xsl:text>{\cs328\f1\fs20\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:LastName">
                        <xsl:text>{\cs329\f1\fs20\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
        ...
        <xsl:if test="$fontSize=&apos;x-small&apos;">
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NamePrefix">
                        <xsl:text>{\cs332\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:LastName">
                        <xsl:text>{\cs333\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
    ...
    <xsl:template name="FirstNameH1">
        ...
        <xsl:if test="$fontSize=&apos;normal&apos;">
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NameLine">
                        <xsl:text>{\cs339\f1\fs22\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        <xsl:text>{\cs340\f1\fs22\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>(</xsl:text>
                            </xsl:with-param>
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs341\f1\fs22\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs342\f1\fs22\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
        ...
        <xsl:if test="$fontSize=&apos;smaller&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NameLine">
                        <xsl:text>{\cs343\f1\fs20 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        <xsl:text>{\cs344\f1\fs20 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>(</xsl:text>
                            </xsl:with-param>
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs345\f1\fs20 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs346\f1\fs20 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xnl:PersonName">
                    <xsl:for-each select="xnl:NameLine">
                        <xsl:text>{\cs347\f1\fs20\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xnl:FirstName">
                        <xsl:text>{\cs348\f1\fs20\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>(</xsl:text>
                            </xsl:with-param>
                        ...
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs349\f1\fs20\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs350\f1\fs20\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>)</xsl:text>
                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            <xsl:when test=".=&quot;male&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs366\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (m)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs367\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_m"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;female&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs368\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (v)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs369\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_v"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs370\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs371\f1\fs22\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            <xsl:when test=".=&quot;male&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs372\f1\fs20 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (m)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs373\f1\fs20 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_m"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;female&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs374\f1\fs20 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (v)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs375\f1\fs20 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_v"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs376\f1\fs20 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs377\f1\fs20 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            <xsl:when test=".=&quot;male&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs378\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (m)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs379\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_m"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;female&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs380\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (v)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs381\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_v"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs382\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs383\f1\fs20\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            <xsl:when test=".=&quot;male&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs384\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (m)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs385\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_m"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;female&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs386\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (v)</xsl:text>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs388\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs389\f1\fs18 </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
                    ...
                    <xsl:for-each select="eml:Gender">
                        <xsl:choose>
                            <xsl:when test=".=&quot;male&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs390\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (m)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs391\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_m"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;female&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs392\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (v)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs393\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_v"/>
                                            </xsl:with-param>
                            ...
                            <xsl:when test=".=&quot;unknown&quot;">
                                <xsl:choose>
                                    <xsl:when test="$lang=0">
                                        <xsl:text>{\cs394\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:text> (f)</xsl:text>
                                            </xsl:with-param>
                                    ...
                                    <xsl:otherwise>
                                        <xsl:text>{\cs395\f1\fs18\b </xsl:text>
                                        <xsl:call-template name="write-text">
                                            <xsl:with-param name="text">
                                                <xsl:value-of select="$RP_Gender_unknown"/>
                                            </xsl:with-param>
    ...
    <xsl:template name="CompleteAddress">
        ...
        <xsl:if test="$fontSize = &apos;normal&apos;">
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xal:Locality">
                    <xsl:for-each select="xal:AddressLine">
                        <xsl:text>{\cs402\f1\fs22\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs403\f1\fs22\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>, </xsl:text>
                            </xsl:with-param>
                    ...
                    <xsl:for-each select="xal:PostalCode">
                        <xsl:text>{\cs404\f1\fs22\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:if test=".!=&quot;&quot;">
                            <xsl:text>{\cs405\f1\fs22\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:for-each select="xal:LocalityName">
                        <xsl:text>{\cs406\f1\fs22\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
        ...
        <xsl:if test="$fontSize = &apos;x-small&apos;">
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="xal:Locality">
                    <xsl:for-each select="xal:AddressLine">
                        <xsl:text>{\cs412\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:text>{\cs413\f1\fs18\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>, </xsl:text>
                            </xsl:with-param>
                    ...
                    <xsl:for-each select="xal:PostalCode">
                        <xsl:text>{\cs414\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                        <xsl:if test=".!=&quot;&quot;">
                            <xsl:text>{\cs415\f1\fs18\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:for-each select="xal:LocalityName">
                        <xsl:text>{\cs416\f1\fs18\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
    ...
    <xsl:template name="City">
        ...
        <xsl:if test="$fontSize = &apos;x-small&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="xal:Locality">
                    <xsl:for-each select="xal:LocalityName">
                        <xsl:text>{\cs420\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
    ...
    <xsl:template name="Date">
        ...
        <xsl:if test="$fontSize = &apos;normal&apos;">
            <xsl:if test="$isBold=0">
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs424\f1\fs22 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:choose>
                    <xsl:when test="substring(text(),6, 2) = &quot;01&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs425\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;05&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs434\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;06&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs435\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs436\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;07&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs437\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
            ...
            <xsl:if test="$isBold=1">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;02&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs457\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_februari"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;03&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs458\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>maart</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs459\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_maart"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;04&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs460\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>april</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs461\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_april"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;05&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs462\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>mei</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs463\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_mei"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;06&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs464\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juni</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs465\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_juni"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;07&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs466\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juli</xsl:text>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;09&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs471\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_september"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;10&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs472\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>oktober</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs473\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_oktober"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;11&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs474\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>november</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs475\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_november"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs476\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>december</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs477\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_december"/>
                                    </xsl:with-param>
                ...
                <xsl:text>{\cs478\f1\fs22\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs479\f1\fs22\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="substring(text(),1, 4)"/>
                    </xsl:with-param>
            ...
            <xsl:if test="$isBold=0">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;04&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs489\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>april</xsl:text>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;05&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs491\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>mei</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs492\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_mei"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;06&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs493\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juni</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs494\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_juni"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;07&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs495\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juli</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs496\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_juli"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;08&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs497\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>augustus</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs498\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_augustus"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;09&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs499\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>september</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs500\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_september"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;10&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs501\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>oktober</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs502\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_oktober"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;11&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs503\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>november</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs504\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_november"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs505\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>december</xsl:text>
                                    </xsl:with-param>
            ...
            <xsl:if test="$isBold=1">
                ...
                <xsl:choose>
                    <xsl:when test="substring(text(),6, 2) = &quot;01&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs512\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>januari</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs513\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_januari"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;02&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs514\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>februari</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs515\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_februari"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;03&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs516\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>maart</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs517\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_maart"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;04&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs518\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>april</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs519\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_april"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;05&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs520\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>mei</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs521\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_mei"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;06&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs522\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juni</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs523\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_juni"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;07&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs524\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>juli</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs525\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_juli"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;08&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs526\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>augustus</xsl:text>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;10&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs530\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>oktober</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs531\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_oktober"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;11&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs532\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>november</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs533\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_november"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs534\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>december</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs535\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_december"/>
                                    </xsl:with-param>
                ...
                <xsl:text>{\cs536\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs537\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="substring(text(),1, 4)"/>
                    </xsl:with-param>
    ...
    <xsl:template name="GenerateDate">
        <xsl:param name="altova:nMaxWidthIn" select="6.26389"/>
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:text>{\cs538\f1\fs16 </xsl:text>
        <xsl:call-template name="write-text">
            <xsl:with-param name="text">
    ...
    <xsl:template name="HashCode">
        <xsl:param name="altova:nMaxWidthIn" select="6.26389"/>
        <xsl:param name="templatetablelevel" select="0"/>
        <xsl:text>{\cs539\f1\fs16 </xsl:text>
        <xsl:call-template name="write-text">
            <xsl:with-param name="text">
    ...
    <xsl:template name="FooterWithoutHashcode">
        ...
        <xsl:if test="$isDraft=&quot;true&quot;">
            <xsl:choose>
                <xsl:when test="$lang=0">
                    <xsl:text>{\cs540\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                ...
                <xsl:otherwise>
                    <xsl:text>{\cs541\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
        ...
        <xsl:choose>
            <xsl:when test="$lang=0">
                <xsl:text>{\cs542\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text>Datum: </xsl:text>
                    </xsl:with-param>
            ...
            <xsl:otherwise>
                <xsl:text>{\cs543\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
    ...
    <xsl:template name="FooterWithHashcode">
        ...
        <xsl:choose>
            <xsl:when test="$isDraft=&quot;true&quot;">
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        <xsl:text>{\cs544\f1\fs18 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>(Concept) | </xsl:text>
                            </xsl:with-param>
            ...
            <xsl:otherwise>
                <xsl:choose>
                    <xsl:when test="$lang=0">
                        <xsl:text>{\cs546\f1\fs16 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                    ...
                    <xsl:otherwise>
                        <xsl:text>{\cs547\f1\fs16 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                ...
                <xsl:text>{\cs548\f1\fs16 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> | </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:if test="$isBold=1">
                    <xsl:choose>
                        <xsl:when test=".= &quot;TK&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs570\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Tweede Kamer der Staten-Generaal</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs571\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_tweedeKamer"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;EK&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs572\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Eerste Kamer der Staten-Generaal</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs573\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_eersteKamer"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;PS&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs574\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs575\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_provincialeStaten"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;EP&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs576\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>Europees Parlement</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs577\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_hetEuropeesParlement"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;GR&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs578\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>gemeenteraad</xsl:text>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;ER&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs580\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>eilandsraad</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs581\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_eilandsraad"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;BC&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs582\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>algemeen bestuur van de bestuurscommissie</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs583\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_bestuurscommissie"/>
                                        </xsl:with-param>
                        ...
                        <xsl:when test=".=&quot;GC&quot;">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <xsl:text>{\cs584\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>gebiedscommissie</xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs585\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$RP_ElectionNameSimple_gebiedscommissie"/>
                                        </xsl:with-param>
    ...
    <xsl:template name="LineBreak">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\fs22\s594\s595\sl0\f1\fs22 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="SmallLineBreak">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\fs22\s596\s597\sl0\f1\fs22 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
        ...
        <xsl:if test="$isBold=1 and $font-size=&apos;small&apos;">
            <xsl:for-each select="eml:ElectionIdentifier">
                <xsl:choose>
                    <xsl:when test="./eml:ElectionCategory[text()=&quot;PS&quot; or text()=&quot;GR&quot; or text()=&quot;ER&quot;]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:text>{\cs611\f1\fs22\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
        ...
        <xsl:if test="$isBold=1 and $font-size=&apos;medium&apos;">
            <xsl:for-each select="eml:ElectionIdentifier">
                <xsl:choose>
                    <xsl:when test="./eml:ElectionCategory[text()=&quot;PS&quot; or text()=&quot;GR&quot; or text()=&quot;ER&quot;]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:text>{\cs617\f1\fs26\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> </xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs618\f1\fs26\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                    ...
                    <xsl:when test="./eml:ElectionCategory[ text()=&quot;BC&quot; or text()=&quot;GC&quot; ]">
                        <xsl:for-each select="kr:ElectionDomain">
                            <xsl:choose>
                                <xsl:when test=". != &quot;Rotterdam - Centrum&quot;  and  . != &quot;Rotterdam - Pernis&quot;">
                                    <xsl:text>{\cs619\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs620\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="substring( text() , 13 )"/>
                                        </xsl:with-param>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs621\f1\fs26\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text> </xsl:text>
                                        </xsl:with-param>
                                    ...
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs622\f1\fs26\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
    ...
    <xsl:template name="ContestIdentifier">
        ...
        <xsl:if test="$fontSize = &apos;normal&apos;">
            ...
            <xsl:if test="$isBold=1">
                <xsl:for-each select="eml:ContestIdentifier">
                    <xsl:for-each select="@Id">
                        <xsl:text>{\cs627\f1\fs22\b </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="string(.)"/>
                            </xsl:with-param>
                    ...
                    <xsl:text>{\cs628\f1\fs22\b </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text> (</xsl:text>
                        </xsl:with-param>
                    ...
                    <xsl:text>}</xsl:text>
                    <xsl:for-each select="eml:ContestName">
                        <xsl:text>{\cs629\f1\fs22\b </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:text>{\cs630\f1\fs22\b </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>)</xsl:text>
                        </xsl:with-param>
        ...
        <xsl:if test="$fontSize = &apos;medium&apos;">
            <xsl:if test="$isBold=0">
                <xsl:for-each select="eml:ContestIdentifier">
                    <xsl:for-each select="@Id">
                        <xsl:text>{\cs631\f1\fs26 </xsl:text>
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:value-of select="string(.)"/>
                            </xsl:with-param>
                    ...
                    <xsl:text>{\cs632\f1\fs26 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text> (</xsl:text>
                        </xsl:with-param>
                    ...
                    <xsl:text>}</xsl:text>
                    <xsl:for-each select="eml:ContestName">
                        <xsl:text>{\cs633\f1\fs26 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                        </xsl:apply-templates>
                    ...
                    <xsl:text>{\cs634\f1\fs26 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>)</xsl:text>
                        </xsl:with-param>
    ...
    <xsl:template name="Space">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$fontSize=&quot;smaller&quot;">
                <xsl:text>{\cs636\f1\fs20 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="&apos; &apos;"/>
                    </xsl:with-param>
            ...
            <xsl:when test="$fontSize=&apos;x-small&apos;">
                <xsl:text>{\cs637\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="&apos; &apos;"/>
                    </xsl:with-param>
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="altova:nColumnWidthTw_4_0" select="round($altova:nTableWidthTw_4 * 0.83 * $altova:TableWidthFactor_4)"/>
        <xsl:variable name="altova:nColumnWidthTw_4_1" select="round($altova:nTableWidthTw_4 * 0.17 * $altova:TableWidthFactor_4)"/>
        <xsl:text>\pard</xsl:text>
        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 1"/>
        <xsl:variable name="tablestyle4">
            ...
            <xsl:text>\ts645\ts646\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
        </xsl:variable>
        ...
        <xsl:call-template name="FooterLine">
            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_4_0 div 1440) + ($altova:nColumnWidthTw_4_1 div 1440)"/>
            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
        </xsl:call-template>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend4"/>
        ...
        <xsl:if test="$isHashcode=1">
            <xsl:call-template name="FooterWithHashcode">
                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_4_0 div 1440)"/>
                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
            </xsl:call-template>
        </xsl:if>
        ...
        <xsl:if test="$isPagenumber=1">
            <xsl:choose>
                <xsl:when test="$lang=0">
                    <xsl:text>{\cs647\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                ...
                <xsl:otherwise>
                    <xsl:text>{\cs648\f1\fs18 </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
            ...
            <xsl:text>\cs649</xsl:text>
            <xsl:text>\chpgn</xsl:text>
            <xsl:text>{\cs650\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
                    <xsl:text> / </xsl:text>
                </xsl:with-param>
            ...
            <xsl:text>}</xsl:text>
            <xsl:text>{\field{\*\fldinst{\cs651\f1\fs18 NUMPAGES }}{\fldrslt }}</xsl:text>
        </xsl:if>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend4"/>
        <xsl:if test="$templatetablelevel + 1 > 1">
                        ...
                        <xsl:if test="$isBold = 1">
                            <xsl:choose>
                                <xsl:when test="$separator=&apos;comma&apos; and position()!=last()">
                                    <xsl:text>{\cs652\f1\fs22\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>{\cs653\f1\fs22\b </xsl:text>
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:text>, </xsl:text>
                                        </xsl:with-param>
                                ...
                                <xsl:when test="$separator=&apos;newline&apos;">
                                    <xsl:text>{\cs654\f1\fs22\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                                ...
                                <xsl:otherwise>
                                    <xsl:text>{\cs655\f1\fs22\b </xsl:text>
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    </xsl:apply-templates>
                    ...
                    <xsl:for-each select="xal:CountryNameCode">
                        ...
                        <xsl:if test="$fontSize = &apos;normal&apos;">
                            <xsl:if test="$isBold = 0">
                                ...
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs662\f1\fs22 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>)</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:if test="$isBold = 1">
                                <xsl:text>{\cs663\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>(</xsl:text>
                                    </xsl:with-param>
                                ...
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs664\f1\fs22\b </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs665\f1\fs22\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>)</xsl:text>
                                    </xsl:with-param>
                        ...
                        <xsl:if test="$fontSize = &apos;x-small&apos;">
                            <xsl:if test="$isBold = 0">
                                <xsl:text>{\cs666\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>(</xsl:text>
                                    </xsl:with-param>
                                ...
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs667\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs668\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>)</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:if test="$isBold = 1">
                                <xsl:text>{\cs669\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>(</xsl:text>
                                    </xsl:with-param>
                                ...
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs670\f1\fs18\b </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                                <xsl:text>{\cs671\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>)</xsl:text>
                                    </xsl:with-param>
            ...
            <xsl:for-each select="xal:Country">
                ...
                <xsl:for-each select="xal:CountryNameCode">
                    ...
                    <xsl:if test="$fontSize = &apos;normal&apos;">
                        ...
                        <xsl:if test="$isBold = 1">
                            <xsl:text>{\cs675\f1\fs22\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs676\f1\fs22\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs677\f1\fs22\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:if test="$fontSize = &apos;smaller&apos;">
                        <xsl:if test="$isBold = 0">
                            <xsl:text>{\cs678\f1\fs20 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs679\f1\fs20 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs680\f1\fs20 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                        ...
                        <xsl:if test="$isBold = 1">
                            <xsl:text>{\cs681\f1\fs20\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs682\f1\fs20\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs683\f1\fs20\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                    ...
                    <xsl:if test="$fontSize = &apos;x-small&apos;">
                        <xsl:if test="$isBold = 0">
                            <xsl:text>{\cs684\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs685\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs686\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>
                        ...
                        <xsl:if test="$isBold = 1">
                            <xsl:text>{\cs687\f1\fs18\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>(</xsl:text>
                                </xsl:with-param>
                            ...
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs688\f1\fs18\b </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                            </xsl:apply-templates>
                            <xsl:text>}</xsl:text>
                            <xsl:text>{\cs689\f1\fs18\b </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>)</xsl:text>
                                </xsl:with-param>

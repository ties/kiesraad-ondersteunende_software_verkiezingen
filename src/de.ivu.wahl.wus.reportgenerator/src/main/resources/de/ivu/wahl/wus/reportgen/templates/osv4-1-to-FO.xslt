...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="altova altovaext clitype ds eml fn iso4217 ix java kr link rg sps ts xal xbrldi xbrli xlink xnl xs xsi">
                ...
                <x:xmpmeta xmlns:x="adobe:ns:meta/">
                    <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                        <rdf:Description rdf:about="" xmlns:dc="http://purl.org/dc/elements/1.1/">
                            <dc:title>Model osv 4-1</dc:title>
                            <dc:creator/>
                            <dc:description/>
                        </rdf:Description>
            ...
            <fo:page-sequence force-page-count="no-force" master-reference="page-master-0" initial-page-number="auto" format="1">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block font-family="Arial" font-size="13pt">
                        ...
                        <fo:block font-family="Arial" font-size="13pt" margin="0" padding="0" text-align="center" margin-right="0 + 100% - 100%" space-before="0" space-after="0">
                                ...
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Count">
                                        <xsl:for-each select="eml:Election">
                                            ...
                                            <fo:block font-family="Arial" font-size="13pt" margin-right="100% - 100%" font-weight="bold" space-before="1.12em" space-after="1.12em" margin="0pt">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:text>Voor </xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:value-of select="$o3-4_010_Voor"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                    ...
                                    <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                                        ...
                                        <fo:block font-family="Arial" font-size="13pt" margin-right="100% - 100%" margin="0pt"/>
                                    </xsl:if>
                                    <xsl:for-each select="eml:ManagingAuthority">
                                        ...
                                        <fo:block font-family="Arial" font-size="13pt" margin-right="100% - 100%" font-weight="bold" space-before="1.12em" space-after="1.12em" margin="0pt">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">
                                                    <fo:inline font-family="Arial" font-size="13pt">
                                                        <xsl:text>Managing autoriteit: </xsl:text>
                                                    </fo:inline>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <fo:inline font-family="Arial" font-size="13pt">
                                                        <xsl:value-of select="$o3-4_020_ManagingAutoriteit"/>
                                                    </fo:inline>
                                                </xsl:otherwise>
                                            </xsl:choose>
                                        ...
                                        <xsl:for-each select="kr:CreatedByAuthority">
                                            <fo:inline-container>
                                                <fo:block>
                                                    <xsl:text>&#x200B;</xsl:text>
                                                </fo:block>
                                            ...
                                            <fo:block font-family="Arial" font-size="13pt" margin-right="100% - 100%" font-weight="bold" space-before="1.12em" space-after="1.12em" margin="0pt">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:text>Aangemaakt door autoriteit: </xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:value-of select="$o3-4_030_AangemaaktDoor"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                    ...
                                    <fo:block font-family="Arial" font-size="13pt" margin-right="100% - 100%" margin="0pt">
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="13pt">
                                                    <xsl:value-of select="$o3-4_040_omTechnischeRedenen"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </fo:block>
                                    ...
                                    <fo:block font-family="Arial" font-size="13pt" margin-right="100% - 100%" margin="0pt">
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="13pt">
                                                    <xsl:text>De SHA1 hashcode van het EML </xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="13pt">
                                                    <xsl:value-of select="$o3-4_050_1_hashcode"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <xsl:for-each select="@Id">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="13pt">
                                                    <xsl:text> bestand genaamd </xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="13pt">
                                                    <xsl:value-of select="$o3-4_050_2_hashcode"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <xsl:choose>
                                            <xsl:when test="@Id != &quot;510d&quot;">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:text>Telling</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:value-of select="$o3-4_050_3_hashcode"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:text>Totaaltelling</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                                            <xsl:value-of select="$o3-4_050_4_hashcode"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="13pt">
                                                    <xsl:value-of select="$o3-4_050_5_hashcode"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                    </fo:block>
    ...
    <xsl:template name="Date">
        ...
        <xsl:if test="$fontSize = &apos;normal&apos;">
            ...
            <xsl:if test="$isBold=1">
                <xsl:if test="substring(text(),9, 1) != &quot;0&quot;">
                    <fo:inline font-family="Arial" font-size="13pt" font-weight="bold">
                        <xsl:value-of select="substring(text(),9, 1)"/>
                    </fo:inline>
                </xsl:if>
                <fo:inline font-family="Arial" font-size="13pt" font-weight="bold">
    ...
    <xsl:template name="FooterLine">
        <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
            <fo:inline font-family="Arial" font-size="13pt" margin-bottom="6pt" display-align="after">
    ...
    <xsl:template name="LegacyFooter">
        ...
        <fo:table font-family="Arial" font-size="13pt" table-layout="fixed" width="100%" border-spacing="2pt">
            <fo:table-column column-width="83%"/>
            <fo:table-column column-width="17%"/>
            <xsl:variable name="altova:CurrContextGrid_12" select="."/>
            <fo:table-body font-family="Arial" font-size="13pt" start-indent="0pt">
                <xsl:variable name="altova:tablerows">
                    <fo:table-row font-family="Arial" font-size="13pt" height="30pt">
                        <fo:table-cell number-columns-spanned="2" font-family="Arial" font-size="13pt" padding="0" display-align="center">
                            <fo:block-container overflow="hidden">
                                <fo:block text-align="left"/>
                            </fo:block-container>
                        </fo:table-cell>
                    </fo:table-row>
                    <fo:table-row font-family="Arial" font-size="13pt">
                        <fo:table-cell number-columns-spanned="2" font-family="Arial" font-size="13pt" padding="0" display-align="after">
                            <fo:block-container overflow="hidden">
                                <fo:block text-align="left">

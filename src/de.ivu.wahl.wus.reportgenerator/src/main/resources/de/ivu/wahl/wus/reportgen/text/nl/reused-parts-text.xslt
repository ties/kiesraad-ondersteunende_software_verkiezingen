...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:param name="RP_ElectionNameSimple_deelraad" select="'de deelraad - deprecated'" />
    <xsl:param name="RP_ElectionNameSimple_deelgemeenteraad" select="'de deelgemeenteraad - deprecated'" />

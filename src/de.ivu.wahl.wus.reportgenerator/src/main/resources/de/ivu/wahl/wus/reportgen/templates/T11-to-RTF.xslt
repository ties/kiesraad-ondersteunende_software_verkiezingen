...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altova-xfi altovaext array clitype ds eml fn iso4217 ix java kr link map math rg sps ts xal xbrldi xbrli xff xfi xlink xnl xs xsi">
            ...
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:Count">
                    <xsl:for-each select="eml:Election">
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>Proces-verbaal van het stembureau voor de verkiezing van de Eerste Kamer</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                        <xsl:text>\par </xsl:text>
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>Met dit formulier doet het stembureau verslag van de zitting waar is gestemd voor de verkiezing van de Eerste Kamer.</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                        <xsl:text>\par </xsl:text>
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>Het gaat om de verkiezing van de leden van de Eerste Kamer der Staten-Generaal op:</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                        <xsl:text>\par </xsl:text>
                    ...
                    <xsl:for-each select="rg:RG510">
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>3. Stembureau</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                        <xsl:text>\par </xsl:text>
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>Het stembureau bestaat uit de volgende leden van de statenvergadering:</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
                        <xsl:text>\par </xsl:text>
                        ...
                        <xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(6801.00)"/>
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_2_0" select="round(1.39 * 1440 * $altova:TableWidthFactor_2)"/>
                        <xsl:variable name="altova:nColumnWidthTw_2_1" select="round(3.33 * 1440 * $altova:TableWidthFactor_2)"/>
                        <xsl:text>\pard\s0\f0\fs24</xsl:text>
                        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 1"/>
                        ...
                        <xsl:text>\ql\sl0\f1\fs18 </xsl:text>
                        <xsl:for-each select="rg:MemberOfElectoralCommittee[position() = 1]">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                        ...
                        <xsl:value-of select="$cellend2"/>
                        <xsl:text>\ql\sl0\f1\fs18 </xsl:text>
                        <xsl:for-each select="rg:MemberOfElectoralCommittee[position() = 2]">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_2_1 div 1440) - 0.02083 - 0.02083"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                        ...
                        <xsl:value-of select="$cellend2"/>
                        <xsl:text>\ql\sl0\f1\fs18 </xsl:text>
                        <xsl:for-each select="rg:MemberOfElectoralCommittee[position() = 3]">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_2_1 div 1440) - 0.02083 - 0.02083"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                        ...
                        <xsl:value-of select="$cellend2"/>
                        <xsl:text>\ql\sl0\f1\fs18 </xsl:text>
                        <xsl:for-each select="rg:MemberOfElectoralCommittee[position() = 4]">
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:apply-templates>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_2_1 div 1440) - 0.02083 - 0.02083"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                        ...
                        <xsl:for-each select="rg:PresenceVotes">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>4. Toegelaten kiezers en uitgebrachte stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>a. Het aantal toegelaten kiezers</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(8641.50)"/>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_3_0" select="round(4.44 * 1440 * $altova:TableWidthFactor_3)"/>
                            <xsl:variable name="altova:nColumnWidthTw_3_1" select="round(1.39 * 1440 * $altova:TableWidthFactor_3)"/>
                            <xsl:variable name="altova:nColumnWidthTw_3_2" select="round(0.17 * 1440 * $altova:TableWidthFactor_3)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal aanwezige leden dat aan de stemming heeft deelgenomen:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal leden dat als gemachtigde voor een ander statenlid stemt:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal toegelaten kiezers:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>b. Het aantal uitgebrachte stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="altova:nSumColumnWidthsTw_4" select="round(8401.00)"/>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_4_0" select="round(4.44 * 1440 * $altova:TableWidthFactor_4)"/>
                            <xsl:variable name="altova:nColumnWidthTw_4_1" select="round(1.39 * 1440 * $altova:TableWidthFactor_4)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            <xsl:text>\ql\sl0\f1\fs22\s1\f0\fs24\sl-270\f1\fs18 </xsl:text>
                            <xsl:text>{\f1\fs18 </xsl:text>
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal uitgebrachte stemmen bedraagt</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Zijn er meer stemmen uitgebracht dan het aantal toegelaten kiezers? </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text> Ja, dan is de stemming nietig en moet er opnieuw worden gestemd. </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>5. Blanco en ongeldige stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="altova:nTableWidthIn_5" select="$altova:nMaxWidthIn * 0.52000"/>
                            ...
                            <xsl:variable name="altova:nSumColumnWidthsTw_5" select="round(6601.00)"/>
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_5_0" select="round(4.03 * 1440 * $altova:TableWidthFactor_5)"/>
                            <xsl:variable name="altova:nColumnWidthTw_5_1" select="round(0.56 * 1440 * $altova:TableWidthFactor_5)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal blanco stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal ongeldige stemmen</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Het aantal geldige stemmen op kandidaten</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>6. Stemmen per kandidaat en lijst</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                            <xsl:text>\par </xsl:text>
                        ...
                        <xsl:variable name="altova:nSumColumnWidthsTw_6" select="round(7201.50)"/>
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_6_0" select="round(1.94 * 1440 * $altova:TableWidthFactor_6)"/>
                        <xsl:variable name="altova:nColumnWidthTw_6_1" select="round(1.39 * 1440 * $altova:TableWidthFactor_6)"/>
                        <xsl:variable name="altova:nColumnWidthTw_6_2" select="round(1.67 * 1440 * $altova:TableWidthFactor_6)"/>
                        <xsl:text>\pard\s0\f0\fs24</xsl:text>
                        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 1"/>
                        ...
                        <xsl:call-template name="write-text">
                            <xsl:with-param name="text">
                                <xsl:text>_____________________________________</xsl:text>
                            </xsl:with-param>
                        </xsl:call-template>
                        <xsl:text>}</xsl:text>
    ...
    <xsl:template name="AffiliationVotes">
        ...
        <xsl:for-each select="rg:AffiliationVotes">
            ...
            <xsl:variable name="altova:nSumColumnWidthsTw_7" select="round(9001.00)"/>
            ...
            <xsl:variable name="altova:nColumnWidthTw_7_0" select="round(1.53 * 1440 * $altova:TableWidthFactor_7)"/>
            <xsl:variable name="altova:nColumnWidthTw_7_1" select="round(4.72 * 1440 * $altova:TableWidthFactor_7)"/>
            <xsl:text>\pard</xsl:text>
            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
            <xsl:text>\itap</xsl:text>
            <xsl:value-of select="$templatetablelevel + 1"/>
            <xsl:variable name="tablestyle7">
                ...
                <xsl:text>\ts22\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
            </xsl:variable>
            ...
            <xsl:for-each select="eml:AffiliationIdentifier">
                <xsl:for-each select="eml:RegisteredName">
                    <xsl:text>{\f1\fs18 </xsl:text>
                    <xsl:apply-templates>
                        <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_7_1 div 1440) - 0.01042 - 0.01042 - 0.01042"/>
                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                    </xsl:apply-templates>
                    <xsl:text>}</xsl:text>
                </xsl:for-each>
            ...
            <xsl:choose>
                <xsl:when test="rg:CandidateVotes">
                    ...
                    <xsl:variable name="altova:nSumColumnWidthsTw_8" select="round(9001.50)"/>
                    ...
                    <xsl:variable name="altova:nColumnWidthTw_8_0" select="round(0.76 * 1440 * $altova:TableWidthFactor_8)"/>
                    <xsl:variable name="altova:nColumnWidthTw_8_1" select="round(4.44 * 1440 * $altova:TableWidthFactor_8)"/>
                    <xsl:variable name="altova:nColumnWidthTw_8_2" select="round(1.04 * 1440 * $altova:TableWidthFactor_8)"/>
                    <xsl:text>\pard</xsl:text>
                    <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 1"/>
                    ...
                    <xsl:for-each select="rg:CandidateVotes">
                        ...
                        <xsl:variable name="altova:RowStyle23">
                            <xsl:text>\trrh320</xsl:text>
                            <xsl:variable name="altova:CurrGridPos_Tbl8" select="$altova:nTableIndentTw_8"/>
                            <xsl:text>\clvertalc\clbrdrt\brdrs\brdrcf74\brdrw15\clbrdrb\brdrs\brdrcf74\brdrw15\clbrdrl\brdrs\brdrcf74\brdrw15\clbrdrr\brdrs\brdrcf74\brdrw15\clpadl15\clpadfl3\clpadb15\clpadfb3\clpadt15\clpadft3\clpadr15\clpadfr3</xsl:text>
                            <xsl:if test="$altova:nColumnWidthTw_8_0 = $altova:nDefaultColumnWidthTw_8">
                                <xsl:text>\clftsWidth1</xsl:text>
                            </xsl:if>
                            <xsl:text>\cellx</xsl:text>
                        ...
                        <xsl:for-each select="eml:Candidate">
                            <xsl:for-each select="eml:CandidateFullName">
                                <xsl:call-template name="LastNameH1">
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_8_1 div 1440) - 0.01042 - 0.01042 - 0.01042 - 0.01042"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:call-template>
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                    ...
                    <xsl:variable name="altova:RowStyle24">
                        ...
                        <xsl:variable name="altova:CurrGridPos_Tbl8_Col0_AfterColumn" select="$altova:CurrGridPos_Tbl8 + $altova:nColumnWidthTw_8_0"/>
                        <xsl:value-of select="ceiling($altova:CurrGridPos_Tbl8_Col0_AfterColumn)"/>
                        <xsl:text>\clvertalc\clbrdrt\brdrs\brdrcf74\brdrw15\clbrdrb\brdrs\brdrcf74\brdrw15\clbrdrl\brdrs\brdrcf74\brdrw15\clbrdrr\brdrs\brdrcf74\brdrw15\clpadl15\clpadfl3\clpadb15\clpadfb3\clpadt15\clpadft3\clpadr100\clpadfr3</xsl:text>
                        <xsl:if test="$altova:nColumnWidthTw_8_1 = $altova:nDefaultColumnWidthTw_8">
                            <xsl:text>\clftsWidth1</xsl:text>
                        </xsl:if>
                        <xsl:text>\cellx</xsl:text>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:variable name="altova:nTableIndentTw_9" select="15"/>
                    <xsl:variable name="altova:nSumColumnWidthsTw_9" select="round(0.00)"/>
                    <xsl:variable name="altova:nColumnsWithDefaultWidth_9" select="round(2)"/>
                    ...
                    <xsl:variable name="tablestyle9">
                        ...
                        <xsl:text>\ts24\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf142\brdrw15\trbrdrl\brdrs\brdrcf142\brdrw15\trbrdrb\brdrs\brdrcf142\brdrw15\trbrdrr\brdrs\brdrcf142\brdrw15</xsl:text>
                    </xsl:variable>
                    ...
                    <xsl:for-each select="rg:ValidVotes">
                        <xsl:text>{\f1\fs18 </xsl:text>
                        <xsl:apply-templates>
                            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_9_1 div 1440) - 0.01042 - 0.01042 - 0.02083 - 0.02083"/>
                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                        </xsl:apply-templates>
                        <xsl:text>}</xsl:text>
                    </xsl:for-each>
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="altova:nSumColumnWidthsTw_10" select="round(0.00 + 1.00 * $altova:nTableWidthTw_10)"/>
        ...
        <xsl:variable name="altova:nColumnWidthTw_10_0" select="round($altova:nTableWidthTw_10 * 0.83 * $altova:TableWidthFactor_10)"/>
        <xsl:variable name="altova:nColumnWidthTw_10_1" select="round($altova:nTableWidthTw_10 * 0.17 * $altova:TableWidthFactor_10)"/>
        <xsl:text>\pard</xsl:text>
        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 1"/>
        ...
        <xsl:call-template name="FooterLine">
            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_10_0 div 1440) + ($altova:nColumnWidthTw_10_1 div 1440)"/>
            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
        </xsl:call-template>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend10"/>
        ...
        <xsl:if test="$isHashcode=1">
            <xsl:call-template name="FooterWithHashcode">
                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_10_0 div 1440)"/>
                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
            </xsl:call-template>
        </xsl:if>

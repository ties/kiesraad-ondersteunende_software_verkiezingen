        ...
        <xsl:for-each select="$XML">
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:Nomination">
                    ...
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 0"/>
                    <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s11\f1\fs22\b\qc\sl0\f1\fs26 </xsl:text>
                    ...
                    <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                        ...
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 0"/>
                        <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s11\f1\fs22\b\qc\sl0\f1\fs26\s0\f0\fs24\qc\sl0\f1\fs26 </xsl:text>
                        <xsl:text>\s0\s0\f0\fs24\f0\fs24\b0\f0\fs24\f0\fs24</xsl:text>
                    </xsl:if>
                    <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24\b0\f0\fs24</xsl:text>
                    <xsl:if test="$templatetablelevel + 0 &gt; 0">\intbl</xsl:if>
                    <xsl:text>\itap</xsl:text>
                    <xsl:value-of select="$templatetablelevel + 0"/>
                    ...
                    <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                        ...
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 0"/>
                        <xsl:text>\s1\f0\fs24\sl0\f1\fs18\s11\f1\fs22\b\qc\sl0\f1\fs26\s0\f0\fs24\sl0\f1\fs26 </xsl:text>
                        <xsl:text>\s0\s0\f0\fs24\f0\fs24\b0\f0\fs24\f0\fs24</xsl:text>
                    </xsl:if>
                    <xsl:text>\par\pard\s0\s0\f0\fs24\f0\fs24\b0\f0\fs24</xsl:text>
                    <xsl:if test="$templatetablelevel + 0 &gt; 0">\intbl</xsl:if>

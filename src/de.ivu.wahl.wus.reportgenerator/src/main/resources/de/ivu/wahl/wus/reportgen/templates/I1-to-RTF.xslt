        ...
        <xsl:for-each select="$XML">
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:CandidateList">
                    ...
                    <xsl:for-each select="rg:RG230c">
                        <xsl:choose>
                            <xsl:when test="count(//kr:ElectionSubcategory[ text() = &quot;EP&quot; or text() = &quot;GR1&quot; or text() = &quot;GR2&quot; or text() = &quot;PS1&quot; or text() = &quot;ER1&quot; or text() = &quot;BC&quot; or text() = &quot;GC&quot;]) &gt; 0">
                                <xsl:choose>
                        ...
                        <xsl:if test="./rg:OmissionLetter/rg:Omissions">
                            ...
                            <xsl:variable name="altova:nColumnWidthTw_2_0" select="round($altova:nTableWidthTw_2 * 0.30 * $altova:TableWidthFactor_2)"/>
                            <xsl:variable name="altova:nColumnWidthTw_2_1" select="round($altova:nTableWidthTw_2 * 0.70 * $altova:TableWidthFactor_2)"/>
                            <xsl:text>\pard\s0\f0\fs24</xsl:text>
                            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                            <xsl:text>\itap</xsl:text>
                            <xsl:value-of select="$templatetablelevel + 1"/>

            ...
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:CandidateList">
                    ...
                    <xsl:for-each select="rg:RG230c">
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_0_1" select="round($altova:nTableWidthTw_0 * 0.75 * $altova:TableWidthFactor_0)"/>
                    ...
                    <xsl:variable name="altova:nSumColumnWidthsTw_3" select="round(3150.50)"/>
                    ...
                    <xsl:variable name="altova:nColumnWidthTw_3_0" select="round(2.19 * 1440 * $altova:TableWidthFactor_3)"/>
            ...
            <xsl:for-each select="eml:EML">
                <xsl:for-each select="eml:CandidateList">
                    <xsl:for-each select="rg:RG230c">
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_4_0" select="round($altova:nTableWidthTw_4 * 0.05 * $altova:TableWidthFactor_4)"/>
                        <xsl:variable name="altova:nColumnWidthTw_4_1" select="round($altova:nTableWidthTw_4 * 0.35 * $altova:TableWidthFactor_4)"/>
                        <xsl:variable name="altova:nColumnWidthTw_4_2" select="round($altova:nTableWidthTw_4 * 0.35 * $altova:TableWidthFactor_4)"/>
                        <xsl:variable name="altova:nColumnWidthTw_4_3" select="round($altova:nTableWidthTw_4 * 0.25 * $altova:TableWidthFactor_4)"/>
                        <xsl:text>\pard</xsl:text>
                        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 1"/>
...
($contestId = &quot;alle&quot; and (count(./rg:CandidateListName/eml:ContestIdentifier) = 0) )]">
                            ...
                            <xsl:for-each select="rg:CandidateListName">
                                <xsl:call-template name="FirstCandidateName">
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_4_2 div 1440) - 0.02083 - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:call-template>
                            </xsl:for-each>
                            <xsl:text>\f0\fs24</xsl:text>
                            ...
                            <xsl:for-each select="rg:NumberOfCandidatesOnList">
                                <xsl:text>{\f1\fs18 </xsl:text>
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_4_3 div 1440) - 0.02083 - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="altova:nColumnWidthTw_5_0" select="round($altova:nTableWidthTw_5 * 0.83 * $altova:TableWidthFactor_5)"/>
        <xsl:variable name="altova:nColumnWidthTw_5_1" select="round($altova:nTableWidthTw_5 * 0.17 * $altova:TableWidthFactor_5)"/>
        <xsl:text>\pard</xsl:text>
        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 1"/>
        ...
        <xsl:call-template name="FooterLine">
            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_0 div 1440) + ($altova:nColumnWidthTw_5_1 div 1440)"/>
            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
        </xsl:call-template>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend5"/>
        ...
        <xsl:if test="$isHashcode=1">
            <xsl:call-template name="FooterWithHashcode">
                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_5_0 div 1440)"/>
                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
            </xsl:call-template>
        </xsl:if>

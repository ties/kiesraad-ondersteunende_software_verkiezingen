...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altovaext clitype ds eml fn iso4217 ix java kr link rg sps ts xal xbrldi xbrli xlink xnl xs xsi">
    ...
    <xsl:template name="CandidatesOnListTable">
        ...
        <xsl:for-each select="eml:Affiliation">
            ...
            <xsl:variable name="altova:nSumColumnWidthsTw_21" select="round(8722.50)"/>
            <xsl:variable name="altova:TableWidthFactor_21">
                <xsl:choose>
                    <xsl:when test="$altova:nSumColumnWidthsTw_21 &gt; $altova:nTableWidthTw_21">
                        <xsl:value-of select="$altova:nTableWidthTw_21 div $altova:nSumColumnWidthsTw_21"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:value-of select="1"/>
                    </xsl:otherwise>
            ...
            <xsl:variable name="altova:nDefaultColumnWidthTw_21" select="0"/>
            <xsl:variable name="altova:nColumnWidthTw_21_0" select="round(0.28 * 1440 * $altova:TableWidthFactor_21)"/>
            <xsl:variable name="altova:nColumnWidthTw_21_1" select="round(1.81 * 1440 * $altova:TableWidthFactor_21)"/>
            <xsl:variable name="altova:nColumnWidthTw_21_2" select="round(1.25 * 1440 * $altova:TableWidthFactor_21)"/>
            <xsl:variable name="altova:nColumnWidthTw_21_3" select="round(1.06 * 1440 * $altova:TableWidthFactor_21)"/>
            <xsl:variable name="altova:nColumnWidthTw_21_4" select="round(1.67 * 1440 * $altova:TableWidthFactor_21)"/>
            <xsl:text>\pard</xsl:text>
            <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
            <xsl:text>\itap</xsl:text>
            <xsl:value-of select="$templatetablelevel + 1"/>
            <xsl:variable name="tablestyle21">
                ...
                <xsl:text>\ts36\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
            </xsl:variable>
            ...
            <xsl:variable name="altova:RowStyle45">
                ...
                <xsl:text>\clvertalt\clpadl30\clpadfl3\clpadb30\clpadfb3\clpadt30\clpadft3\clpadr30\clpadfr3</xsl:text>
                <xsl:if test="$altova:nColumnWidthTw_21_3 = $altova:nDefaultColumnWidthTw_21">
                    <xsl:text>\clftsWidth1</xsl:text>
                </xsl:if>
                <xsl:text>\cellx</xsl:text>
                <xsl:variable name="altova:CurrGridPos_Tbl21_Col3_AfterColumn" select="$altova:CurrGridPos_Tbl21_Col2_AfterColumn + $altova:nColumnWidthTw_21_3"/>
                <xsl:value-of select="ceiling($altova:CurrGridPos_Tbl21_Col3_AfterColumn)"/>
                <xsl:text>\clvertalt\clpadl30\clpadfl3\clpadb30\clpadfb3\clpadt30\clpadft3\clpadr30\clpadfr3</xsl:text>
                <xsl:if test="$altova:nColumnWidthTw_21_4 = $altova:nDefaultColumnWidthTw_21">
                    <xsl:text>\clftsWidth1</xsl:text>
                </xsl:if>
                <xsl:text>\cellx</xsl:text>
                <xsl:variable name="altova:CurrGridPos_Tbl21_Col4_AfterColumn" select="$altova:CurrGridPos_Tbl21_Col3_AfterColumn + $altova:nColumnWidthTw_21_4"/>
                <xsl:value-of select="ceiling($altova:CurrGridPos_Tbl21_Col4_AfterColumn)"/>
            </xsl:variable>
            <xsl:if test="$templatetablelevel + 1 = 1">
            ...
            <xsl:for-each select="eml:Candidate">
                ...
                <xsl:for-each select="eml:CandidateFullName">
                    <xsl:call-template name="LastNameH1">
                        ...
                        <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_21_1 div 1440) - 0.02083 - 0.02083"/>
                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                    </xsl:call-template>
                </xsl:for-each>
                <xsl:text>\f0\fs24</xsl:text>
                ...
                <xsl:for-each select="eml:CandidateFullName">
                    <xsl:call-template name="FirstNameH1">
                        <xsl:with-param name="fontSize" select="&apos;x-small&apos;"/>
                        <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_21_2 div 1440) - 0.02083 - 0.02083"/>
                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                    </xsl:call-template>
                </xsl:for-each>
                <xsl:call-template name="Gender">
                ...
                <xsl:choose>
                    <xsl:when test="eml:DateOfBirth">
                        <xsl:for-each select="eml:DateOfBirth">
                            <xsl:call-template name="Date">
                                <xsl:with-param name="fontSize" select="&apos;x-small&apos;"/>
                                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_21_3 div 1440) - 0.02083 - 0.02083"/>
                                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                ...
                <xsl:call-template name="QualifyingAddressCity">
                    <xsl:with-param name="fontSize" select="&apos;x-small&apos;"/>
                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_21_4 div 1440) - 0.02083 - 0.02083"/>
                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                </xsl:call-template>
                <xsl:text>\f0\fs24</xsl:text>
                <xsl:value-of select="$cellend21"/>

                            ...
                            <xsl:for-each select="$XML">
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Nomination">
                                        <xsl:choose>
                                            <xsl:when test="eml:ElectionIdentifier/eml:ElectionCategory[text() = &apos;EK&apos;]">
                                                        ...
                                                        <xsl:for-each select="kr:Contests">
                                                            <xsl:for-each select="kr:Contest">
                                                                ...
                                                                <xsl:call-template name="AAA">
                                                                    <xsl:with-param name="province" select="."/>
                                                                </xsl:call-template>
                                                            </xsl:for-each>
                                                        </xsl:for-each>
                                                    </xsl:for-each>
...
eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;TK&quot; or text() = &quot;EP&quot; or text() = &quot;EK&quot;] and (eml:ContestIdentifier/@Id = &quot;20&quot; or eml:ContestIdentifier/@Id = &quot;alle&quot;)"/>
                    <xsl:variable name="isMayor" select="eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;PS&quot; or text() = &quot;AB&quot; or text() = &quot;GR&quot; or text() = &quot;BC&quot; or text() = &quot;GC&quot;] or
eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;TK&quot; or text() = &quot;EP&quot; or text() = &quot;EK&quot;] and (eml:ContestIdentifier/@Id != &quot;20&quot; or eml:ContestIdentifier/@Id = &quot;alle&quot;)"/>
                    ...
                    <xsl:call-template name="ChapterElection">
                        <xsl:with-param name="province" select="$province"/>
                    </xsl:call-template>
                    <fo:block/>
                    <xsl:call-template name="Line"/>
                    <fo:block/>
                    ...
                    <xsl:choose>
                        <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                            <xsl:choose>
                                <xsl:when test="$lang=0">
                                    <fo:inline font-family="Arial" font-size="9pt">
                                        <xsl:text>De aanduiding van de politieke groepering waarvan u de kandidatenlijst ondersteunt: </xsl:text>
                                    </fo:inline>
                                </xsl:when>
                                <xsl:otherwise>
                                    <fo:inline font-family="Arial" font-size="9pt">
                    ...
                    <fo:table-header font-family="Arial" font-size="9pt" start-indent="0pt">
                        <xsl:variable name="altova:tablerows">
                            <fo:table-row font-family="Arial" font-size="9pt">
                                ...
                                <xsl:variable name="bColumnCondition_0xB42CE38">
                                    <xsl:for-each select="$altova:CurrContextGrid_88">
                                        <xsl:value-of select="$showDateOfBirth = 1"/>
                                    </xsl:for-each>
                                </xsl:variable>
                                <xsl:if test="$bColumnCondition_0xB42CE38 = 'true'">
                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="before">
                                        <fo:block text-align="left">
                                            <xsl:choose>
                                                <xsl:when test="$lang=0">

                            ...
                            <xsl:for-each select="$XML">
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:Nomination">
                                        <xsl:variable name="isGovernor" select="eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;ER&quot;] or
eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;TK&quot; or text() = &quot;EP&quot; or text() = &quot;EK&quot;] and (eml:ContestIdentifier/@Id = &quot;20&quot; or eml:ContestIdentifier/@Id = &quot;alle&quot;)"/>
                                        <xsl:variable name="isMayor" select="eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;PS&quot; or text() = &quot;GR&quot; or text() = &quot;BC&quot; or text() = &quot;GC&quot;] or
eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;TK&quot; or text() = &quot;EP&quot; or text() = &quot;EK&quot;] and (eml:ContestIdentifier/@Id != &quot;20&quot; or eml:ContestIdentifier/@Id = &quot;alle&quot;)"/>
                                        <xsl:variable name="isVoorzitter" select="count(//eml:ElectionCategory[.=&quot;BC&quot;]) &gt; 0"/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:text>Model H 4</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold">
                                                    <xsl:value-of select="$H4_010_pretitle"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:text>Ondersteuningsverklaring</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="16pt" font-weight="bold">
                                                    <xsl:value-of select="$H4_010_title"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:text>Met dit formulier verklaart u dat u een kandidatenlijst ondersteunt van een politieke groepering. Dit betekent dat u de deelname van de betreffende groepering aan de verkiezing mogelijk maakt. Deze verklaring wordt ter inzage gelegd.</xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H4_020_MetDitFormulier"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H4_020_MetDitFormulier_BC"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt" font-weight="bold">
                                                    <xsl:value-of select="$H4_040_LetOp"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>U mag zich niet laten omkopen tot het afleggen van deze ondersteuningsverklaring. Degene die u omkoopt of u hiertoe anderszins dwingt, is tevens strafbaar. Op beide misdrijven staat een gevangenisstraf van maximaal zes maanden of een geldboete. </xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H4_050_UMagZich"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                            <xsl:value-of select="$H4_060_PolitiekeGroepering"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                            <xsl:value-of select="$H4_060_PolitiekeGroepering_BC"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="//eml:ElectionCategory[.!=&quot;BC&quot;]">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:text>De politieke groepering waarvan u de kandidatenlijst ondersteunt: </xsl:text>
                                                        </fo:inline>
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H4_070_DePolitiekeGroeperingUOndersteunt"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <xsl:choose>
                                                    ...
                                                    <xsl:otherwise>
                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                            <xsl:value-of select="$H4_070_DePolitiekeGroeperingUOndersteunt_BC"/>
                                                        </fo:inline>
                                                    </xsl:otherwise>
                                                </xsl:choose>
                                            </xsl:otherwise>
                                        ...
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H4_080_KandidatenOpDeLijst"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Ondertekening door de kiezer</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H4_100_Ondertekening"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:text>Ik verklaar dat ik de bovengenoemde kandidatenlijst ondersteun.</xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt">
                                                    <xsl:value-of select="$H4_110_IkVerklaar"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                                            ...
                                                            <fo:block-container overflow="hidden">
                                                                <fo:block text-align="left">
                                                                    ...
                                                                    <xsl:choose>
                                                                        ...
                                                                        <xsl:otherwise>
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:value-of select="$H4_120_Datum"/>
                                                                            </fo:inline>
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                </fo:block>
                                                            ...
                                                            <fo:block-container overflow="hidden">
                                                                <fo:block text-align="left">
                                                                    ...
                                                                    <xsl:choose>
                                                                        ...
                                                                        <xsl:otherwise>
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:value-of select="$H4_130_Naam"/>
                                                                            </fo:inline>
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                </fo:block>
                                                            ...
                                                            <fo:block-container overflow="hidden">
                                                                <fo:block text-align="left">
                                                                    ...
                                                                    <xsl:choose>
                                                                        ...
                                                                        <xsl:otherwise>
                                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                                <xsl:value-of select="$H4_140_Handtekening"/>
                                                                            </fo:inline>
                                                                        </xsl:otherwise>
                                                                    </xsl:choose>
                                                                </fo:block>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$lang=0">
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:text>Verklaring van de </xsl:text>
                                                </fo:inline>
                                            </xsl:when>
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                                    <xsl:value-of select="$H4_146_VerklaringVanDe"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <xsl:call-template name="BurgemeesterGezaghebber">
                                            <xsl:with-param name="isMayor" select="$isMayor"/>
                                            <xsl:with-param name="isGovernor" select="$isGovernor"/>
                                            <xsl:with-param name="isBoldAndItalic" select="1"/>
                                            <xsl:with-param name="isVoorzitter" select="$isVoorzitter"/>
                                        </xsl:call-template>
                                        <fo:inline font-family="Arial" font-size="11pt" font-weight="bold" margin-bottom="6pt">
                                            <xsl:text>&#160;</xsl:text>
                                        </fo:inline>
                                        <xsl:choose>
                                            ...
                                            <xsl:otherwise>
                                                <fo:inline font-family="Arial" font-size="9pt" font-style="italic">
                                                    <xsl:value-of select="$H4_148_nietEK"/>
                                                </fo:inline>
                                            </xsl:otherwise>
                                        </xsl:choose>
                                        <fo:block/>
                                        ...
                                        <xsl:if test="count(eml:ElectionIdentifier/eml:ElectionCategory[text() = &quot;EK&quot;]) = 0">
                                            <xsl:choose>
                                                <xsl:when test="//eml:ElectionCategory[.!=&quot;GC&quot;]">
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                        ...
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:value-of select="$H4_150_1_DeBurgemeesterVerklaart"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                    <xsl:call-template name="BurgemeesterGezaghebber">
                                                    ...
                                                    <xsl:choose>
                                                        ...
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:value-of select="$H4_150_2_DeBurgemeesterVerklaart"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                    <xsl:if test="$isVoorzitter">
                                                        <xsl:choose>
                                                            <xsl:when test="$lang=0">
                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                            ...
                                                            <xsl:otherwise>
                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                    <xsl:value-of select="$H4_150_5_stadsdeel"/>
                                                                </fo:inline>
                                                            </xsl:otherwise>
                                                        </xsl:choose>
                                                    </xsl:if>
                                                    ...
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:text> verklaart dat de ondersteuner in zijn </xsl:text>
                                                            </fo:inline>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:value-of select="$H4_150_3_DeBurgemeesterVerklaart"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                    <xsl:call-template name="GemeenteOpenbaarLichaam">
                                                        <xsl:with-param name="isMayor" select="$isMayor"/>
                                                        <xsl:with-param name="isGovernor" select="$isGovernor"/>
                                                        <xsl:with-param name="isVoorzitter" select="$isVoorzitter"/>
                                                    </xsl:call-template>
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:text> als kiezer is geregistreerd.</xsl:text>
                                                            </fo:inline>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:value-of select="$H4_150_4_DeBurgemeesterVerklaart"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:text>De burgemeester van Rotterdam verklaart dat de ondersteuner in het betreffende gebied als kiezer is geregistreerd.</xsl:text>
                                                            </fo:inline>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="9pt">
                                                                <xsl:value-of select="$H4_155_DeBurgemeesterVerklaart_GC"/>
                                                            </fo:inline>
                                                        </xsl:otherwise>
                                                    </xsl:choose>
                                                </xsl:otherwise>
                                                                        ...
                                                                        <fo:block-container overflow="hidden">
                                                                            <fo:block text-align="left">
                                                                                ...
                                                                                <xsl:choose>
                                                                                    <xsl:when test="$lang=0">
                                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                                            <xsl:text>De kiezer behoort tot kieskring</xsl:text>
                                                                                        </fo:inline>
                                                                                    </xsl:when>
                                                                                    <xsl:otherwise>
                                                                                        <fo:inline font-family="Arial" font-size="9pt">
                                                                                            <xsl:value-of select="$H4_160_kiezerBehoort"/>
                                                                                        </fo:inline>
                                                                                    </xsl:otherwise>
                                                                                </xsl:choose>
                                                                            </fo:block>
                                                                    ...
                                                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="1" display-align="center">
                                                                        <fo:block-container overflow="hidden">
                                                                            <fo:block text-align="left">
                                                                                <xsl:call-template name="LineBreak"/>
                                                                                <fo:inline color="#a6a6a6" font-family="Arial" font-size="9pt">
                                                                                    <xsl:text>________________________________________________________</xsl:text>
                                                                                </fo:inline>
                                                                            </fo:block>
                                                                        </fo:block-container>
                                                                    </fo:table-cell>
                                                                ...
                                                                <fo:block-container overflow="hidden">
                                                                    <fo:block text-align="left">
                                                                        ...
                                                                        <xsl:choose>
                                                                            ...
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H4_170_Datum"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
                                                                ...
                                                                <fo:block-container overflow="hidden">
                                                                    <fo:block text-align="left">
                                                                        ...
                                                                        <xsl:choose>
                                                                            <xsl:when test="$lang=0">
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:text>Ondertekening of gemeentestempel</xsl:text>
                                                                                </fo:inline>
                                                                            </xsl:when>
                                                                            <xsl:otherwise>
                                                                                <fo:inline font-family="Arial" font-size="9pt">
                                                                                    <xsl:value-of select="$H4_180_OndertekeningGemeentestempel"/>
                                                                                </fo:inline>
                                                                            </xsl:otherwise>
                                                                        </xsl:choose>
                                                                    </fo:block>
    ...
    <xsl:template name="BurgemeesterGezaghebber">
        <xsl:param name="isBoldAndItalic" select="0"/>
        <xsl:param name="isMayor" select="false()"/>
        <xsl:param name="isGovernor" select="false()"/>
        <xsl:param name="isVoorzitter" select="false()"/>
        <xsl:if test="$isBoldAndItalic=0">
            <xsl:choose>
                <xsl:when test="not($isVoorzitter)">
                    <xsl:if test="$isMayor">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <fo:inline font-family="Arial" font-size="9pt">
                            ...
                            <xsl:otherwise>
                                <fo:inline font-family="Arial" font-size="9pt">
                                    <xsl:value-of select="$H4_091_Burgemeester"/>
                                </fo:inline>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:if>
                    <xsl:if test="$isMayor and $isGovernor">
                        <fo:inline font-family="Arial" font-size="9pt">
                            <xsl:text> / </xsl:text>
                        </fo:inline>
                    </xsl:if>
                    <xsl:if test="$isGovernor">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <fo:inline font-family="Arial" font-size="9pt">
                            ...
                            <xsl:otherwise>
                                <fo:inline font-family="Arial" font-size="9pt">
                                    <xsl:value-of select="$H4_092_Gezaghebber"/>
                                </fo:inline>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:if>
                ...
                <xsl:otherwise>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <fo:inline font-family="Arial" font-size="9pt">
                                <xsl:value-of select="$H4_093_Voorzitter"/>
                            </fo:inline>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:otherwise>
        ...
        <xsl:if test="$isBoldAndItalic=1">
            <xsl:choose>
                <xsl:when test="not($isVoorzitter)">
                    ...
                    <xsl:if test="$isMayor and $isGovernor">
                        <fo:inline font-family="Arial" font-size="9pt" font-style="italic" font-weight="bold">
                            <xsl:text> / </xsl:text>
                        </fo:inline>
                    </xsl:if>
                    <xsl:if test="$isGovernor">
    ...
    <xsl:template name="GemeenteOpenbaarLichaam">
        <xsl:param name="isMayor" select="false()"/>
        <xsl:param name="isGovernor" select="false()"/>
        <xsl:param name="isVoorzitter" select="false()"/>
        <xsl:choose>
            <xsl:when test="not($isVoorzitter)">
                <xsl:if test="$isMayor">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <fo:inline font-family="Arial" font-size="9pt">
                                <xsl:value-of select="$H4_101_Gemeente"/>
                            </fo:inline>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:if>
                ...
                <xsl:if test="$isGovernor">
                    <xsl:if test="not($isVoorzitter)">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <fo:inline font-family="Arial" font-size="9pt">
                                    <xsl:value-of select="$H4_102_OpenbaarLichaam"/>
                                </fo:inline>
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:if>
            ...
            <xsl:otherwise>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <fo:inline font-family="Arial" font-size="9pt">
                            <xsl:value-of select="$H4_103_stadsdeel"/>
                        </fo:inline>
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:otherwise>
        ...
        <xsl:for-each select="eml:ElectionIdentifier">
            <xsl:for-each select="kr:ElectionSubcategory">
                <xsl:if test=".=&quot;TK&quot; or .=&quot;EK&quot; or .=&quot;PS2&quot;">
                    ...
                    <fo:table font-family="Arial" font-size="9pt" display-align="before" width="90%" table-layout="fixed" border-spacing="0">
                    ...
                    <fo:table-header font-family="Arial" font-size="9pt" start-indent="0pt">
                        <xsl:variable name="altova:tablerows">
                            <fo:table-row font-family="Arial" font-size="9pt">
                                ...
                                <xsl:variable name="bColumnCondition_0x7BF95A8">
                                    <xsl:for-each select="$altova:CurrContextGrid_76">
                                        <xsl:value-of select="$showDateOfBirth = 1"/>
                                    </xsl:for-each>
                                </xsl:variable>
                                <xsl:if test="$bColumnCondition_0x7BF95A8 = 'true'">
                                    <fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" display-align="before">
                                        <fo:block-container overflow="hidden">
                                            <fo:block text-align="left">
                                                <xsl:choose>

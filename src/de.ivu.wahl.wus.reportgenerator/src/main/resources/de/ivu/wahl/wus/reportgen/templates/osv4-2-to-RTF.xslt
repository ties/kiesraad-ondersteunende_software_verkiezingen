                ...
                <xsl:for-each select="eml:Count">
                        ...
                        <xsl:for-each select="eml:Contests">
                            <xsl:for-each select="eml:Contest">
                                <xsl:for-each select="eml:TotalVotes">
                                    <xsl:variable name="validOrBlank" select="eml:TotalCounted +  eml:RejectedVotes[ @ReasonCode = &quot;blanco&quot; ]"/>
                                    <xsl:variable name="totalVotes" select="eml:TotalCounted +  eml:RejectedVotes[ @ReasonCode = &quot;blanco&quot; ] +  eml:RejectedVotes[ @ReasonCode = &quot;ongeldig&quot; ]"/>
                                    ...
                                    <xsl:variable name="tablestyle0">
                                        ...
                                        <xsl:text>\ts15\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf141\brdrw15\trbrdrl\brdrs\brdrcf141\brdrw15\trbrdrb\brdrs\brdrcf141\brdrw15\trbrdrr\brdrs\brdrcf141\brdrw15</xsl:text>
                                    </xsl:variable>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Aantal in de stembus aangetroffen stemmen (opkomst)</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="translate( format-number( 100 * $totalVotes div  eml:Cast , &apos;##0.0&apos; ), &quot;.&quot;, &quot;,&quot; )"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Aantal geldige stemmen op een antwoord</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="translate( format-number( 100 * eml:TotalCounted div $validOrBlank , &apos;##0.0&apos; ), &quot;.&quot;, &quot;,&quot; )"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="translate (format-number( 100 * eml:RejectedVotes[ @ReasonCode = &quot;blanco&quot; ] div $validOrBlank , &apos;##0.0&apos; ), &quot;.&quot;, &quot;,&quot; )"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Aantal geldige stemmen</xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o4-2_105_AantalGeldige"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="$validOrBlank"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="translate( format-number( 100 * $validOrBlank div $totalVotes , &apos;##0.0&apos; ), &quot;.&quot;, &quot;,&quot; )"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="translate( format-number( 100 * eml:RejectedVotes[ @ReasonCode = &quot;ongeldig&quot; ] div $totalVotes , &apos;##0.0&apos; ), &quot;.&quot;, &quot;,&quot; )"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                    <xsl:text>\f0\fs24</xsl:text>
                    ...
                    <xsl:for-each select="rg:RG510">
                        <xsl:for-each select="rg:PresenceVotes">
                            <xsl:variable name="validOrBlank" select="rg:TotalCounted + rg:BlancVotes"/>
                            <xsl:text>\par </xsl:text>
                            ...
                            <xsl:variable name="tablestyle1">
                                ...
                                <xsl:text>\ts16\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf141\brdrw15\trbrdrl\brdrs\brdrcf141\brdrw15\trbrdrb\brdrs\brdrcf141\brdrw15\trbrdrr\brdrs\brdrcf141\brdrw15</xsl:text>
                            </xsl:variable>
                            ...
                            <xsl:for-each select="rg:AffiliationVotes">
                                ...
                                <xsl:for-each select="rg:ValidVotes">
                                    ...
                                    <xsl:call-template name="write-text">
                                        <xsl:with-param name="text">
                                            <xsl:value-of select="translate( format-number( 100 * . div $validOrBlank , &apos;##0.0&apos; ), &quot;.&quot;, &quot;,&quot; )"/>
                                        </xsl:with-param>
                                    </xsl:call-template>
                                    <xsl:text>}</xsl:text>
                                </xsl:for-each>

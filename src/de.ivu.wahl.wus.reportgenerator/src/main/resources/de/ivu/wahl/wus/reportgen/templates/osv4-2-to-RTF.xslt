...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com" exclude-result-prefixes="clitype ds eml fn iso4217 ix java kr link rg ts xal xbrldi xbrli xlink xnl xs xsi altova">
    ...
    <xsl:template match="/">
        ...
        <xsl:text>{\s19\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s20\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s21\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s22\sl0\fs22\snext0 div;}</xsl:text>
        <xsl:text>{\s60\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s61\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s202\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s203\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\s204\sl0\f1\snext0 *;}</xsl:text>
        <xsl:text>{\s205\sl0\fs22\snext0 p;}</xsl:text>
        <xsl:text>{\*\cs17\f1\snext0 Character *;}</xsl:text>
        ...
        <xsl:text>{\*\ts33\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts34\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts62\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts63\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts216\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>{\*\ts217\tsrowd\ql\f1\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil\snext0 Table *;}</xsl:text>
        <xsl:text>}</xsl:text>
    ...
    <xsl:template name="altova:DocumentSection_0659C2F8">
        ...
        <xsl:call-template name="altova:Section_0659C2F8_FooterLeft"/>
        <xsl:text>}</xsl:text>
        <xsl:text>{</xsl:text>
        <xsl:text>\footerr </xsl:text>
        <xsl:call-template name="altova:Section_0659C2F8_FooterRight"/>
        <xsl:text>}</xsl:text>
        ...
        <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
            ...
            <xsl:text>\itap</xsl:text>
            <xsl:value-of select="$templatetablelevel + 0"/>
            <xsl:text>\s11\f1\fs22\b\sl0\fs26\b\s15\s16\sl0\f1\fs26\b\s0\f0\fs24\sl0\fs22\s19\s20\sl0\f1\fs22 </xsl:text>
        ...
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 0"/>
        <xsl:text>\s1\f0\fs24\sl0\fs22\s21\s22\sl0\f1\fs22 </xsl:text>
            ...
            <xsl:for-each select="eml:EML">
                ...
                <xsl:for-each select="eml:Count">
                        ...
                        <xsl:for-each select="eml:Contests">
                            <xsl:for-each select="eml:Contest">
                                <xsl:for-each select="eml:TotalVotes">
                                    <xsl:variable name="altova:CurrContextGrid_069CA0C0" select="."/>
                                    ...
                                    <xsl:variable name="altova:nSumColumnWidthsTw_0" select="round(9401.50)"/>
                                    ...
                                    <xsl:variable name="altova:nColumnWidthTw_0_0" select="round(4.44 * 1440 * $altova:TableWidthFactor_0)"/>
                                    <xsl:variable name="altova:nColumnWidthTw_0_1" select="round(1.25 * 1440 * $altova:TableWidthFactor_0)"/>
                                    <xsl:variable name="altova:nColumnWidthTw_0_2" select="round(0.83 * 1440 * $altova:TableWidthFactor_0)"/>
                                    ...
                                    <xsl:variable name="tablestyle0">
                                        ...
                                        <xsl:text>\ts33\ts34\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf141\brdrw15\trbrdrl\brdrs\brdrcf141\brdrw15\trbrdrb\brdrs\brdrcf141\brdrw15\trbrdrr\brdrs\brdrcf141\brdrw15</xsl:text>
                                    </xsl:variable>
                                    ...
                                    <xsl:value-of select="$altova:RowStyle5"/>
                                    <xsl:value-of select="$rowend0"/>
                                    <xsl:text>\pard\s1\f0\fs24\sl0\fs22\s21\s22\sl0\f1\fs22</xsl:text>
                                    <xsl:if test="$templatetablelevel + 0 &gt; 0">\intbl</xsl:if>
                                    <xsl:text>\itap</xsl:text>
                                    <xsl:value-of select="$templatetablelevel + 0"/>
                                    <xsl:text> </xsl:text>
                    ...
                    <xsl:if test="$SV_OutputFormat = &apos;PDF&apos;">
                        ...
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 0"/>
                        <xsl:text>\s1\f0\fs24\sl0\fs22\s21\s22\sl0\f1\fs22\s0\f0\fs24\sl0\fs22\s60\s61\sl0\f1\fs22 </xsl:text>
                        <xsl:text>\s0\f0\fs24\f0\fs24</xsl:text>
                    </xsl:if>
                    <xsl:for-each select="rg:RG510">
                        <xsl:text>\par </xsl:text>
                        <xsl:variable name="altova:CurrContextGrid_069CEF40" select="."/>
                        ...
                        <xsl:variable name="altova:nTableIndentTw_1" select="15"/>
                        <xsl:variable name="altova:nSumColumnWidthsTw_1" select="round(9402.00)"/>
                        ...
                        <xsl:variable name="altova:nColumnWidthTw_1_0" select="round(0.83 * 1440 * $altova:TableWidthFactor_1)"/>
                        <xsl:variable name="altova:nColumnWidthTw_1_1" select="round(3.61 * 1440 * $altova:TableWidthFactor_1)"/>
                        <xsl:variable name="altova:nColumnWidthTw_1_2" select="round(1.25 * 1440 * $altova:TableWidthFactor_1)"/>
                        <xsl:variable name="altova:nColumnWidthTw_1_3" select="round(0.83 * 1440 * $altova:TableWidthFactor_1)"/>
                        <xsl:text>\pard\s0\f0\fs24</xsl:text>
                        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
                        <xsl:text>\itap</xsl:text>
                        <xsl:value-of select="$templatetablelevel + 1"/>
                        <xsl:variable name="tablestyle1">
                            ...
                            <xsl:text>\ts62\ts63\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf141\brdrw15\trbrdrl\brdrs\brdrcf141\brdrw15\trbrdrb\brdrs\brdrcf141\brdrw15\trbrdrr\brdrs\brdrcf141\brdrw15</xsl:text>
                        </xsl:variable>
                        ...
                        <xsl:for-each select="rg:AffiliationVotes">
                            ...
                            <xsl:for-each select="eml:AffiliationIdentifier">
                                <xsl:for-each select="eml:RegisteredName">
                                    ...
                                    <xsl:apply-templates>
                                        <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_1 div 1440) - 0.01042 - 0.01042 - 0.02083 - 0.02083"/>
                                        <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                    </xsl:apply-templates>
                                    <xsl:text>}</xsl:text>
                                </xsl:for-each>
                            ...
                            <xsl:for-each select="rg:ValidVotes">
                                ...
                                <xsl:apply-templates>
                                    <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_1_2 div 1440) - 0.01042 - 0.01042 - 0.02083 - 0.02083"/>
                                    <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
                                </xsl:apply-templates>
                                <xsl:text>}</xsl:text>
                            </xsl:for-each>
    ...
    <xsl:template name="Date">
        ...
        <xsl:if test="$fontSize = &apos;x-small&apos;">
            <xsl:if test="$isBold=0">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;04&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs142\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>april</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs143\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_april"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;05&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs144\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>mei</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs145\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_mei"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;10&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs155\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_oktober"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;11&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs156\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>november</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs157\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_november"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs158\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>december</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs159\f1\fs18 </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_december"/>
                                    </xsl:with-param>
                ...
                <xsl:text>{\cs160\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs161\f1\fs18 </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="substring(text(),1, 4)"/>
                    </xsl:with-param>
            ...
            <xsl:if test="$isBold=1">
                <xsl:if test="substring(text(),9, 1) != &quot;0&quot;">
                    <xsl:text>{\cs162\f1\fs18\b </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:value-of select="substring(text(),9, 1)"/>
                        </xsl:with-param>
                ...
                <xsl:text>{\cs163\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:value-of select="substring(text(),10, 1)"/>
                    </xsl:with-param>
                ...
                <xsl:text>}</xsl:text>
                <xsl:text>{\cs164\f1\fs18\b </xsl:text>
                <xsl:call-template name="write-text">
                    <xsl:with-param name="text">
                        <xsl:text> </xsl:text>
                    </xsl:with-param>
                ...
                <xsl:choose>
                    <xsl:when test="substring(text(),6, 2) = &quot;01&quot;">
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs166\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_januari"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;02&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs167\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>februari</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs168\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_februari"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;03&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs169\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>maart</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs170\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_maart"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;04&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs171\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>april</xsl:text>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2) = &quot;10&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs183\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>oktober</xsl:text>
                                    </xsl:with-param>
                            ...
                            <xsl:otherwise>
                                <xsl:text>{\cs184\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:value-of select="$RP_Date_oktober"/>
                                    </xsl:with-param>
                    ...
                    <xsl:when test="substring(text(),6, 2)  = &quot;12&quot;">
                        <xsl:choose>
                            <xsl:when test="$lang=0">
                                <xsl:text>{\cs187\f1\fs18\b </xsl:text>
                                <xsl:call-template name="write-text">
                                    <xsl:with-param name="text">
                                        <xsl:text>december</xsl:text>
                                    </xsl:with-param>
    ...
    <xsl:template name="LineBreak">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\fs22\s202\s203\sl0\f1\fs22 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="LineBreakTable">
        ...
        <xsl:choose>
            <xsl:when test="$SV_OutputFormat = &apos;PDF&apos;">
                ...
                <xsl:text>\itap</xsl:text>
                <xsl:value-of select="$templatetablelevel + 0"/>
                <xsl:text>\s0\f0\fs24\sl0\fs22\s204\s205\sl0\f1\fs22 </xsl:text>
                <xsl:text>\f0\fs24</xsl:text>
            </xsl:when>
            <xsl:otherwise>
                <xsl:text>\par </xsl:text>
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="altova:CurrContextGrid_06B08E80" select="."/>
        ...
        <xsl:variable name="altova:nSumColumnWidthsTw_2" select="round(2000.50)"/>
        ...
        <xsl:variable name="altova:nColumnWidthTw_2_1" select="round(1.39 * 1440 * $altova:TableWidthFactor_2)"/>
        <xsl:text>\pard</xsl:text>
        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 1"/>
        <xsl:variable name="tablestyle2">
            ...
            <xsl:text>\ts216\ts217\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrnil\trbrdrl\brdrnil\trbrdrb\brdrnil\trbrdrr\brdrnil</xsl:text>
        </xsl:variable>
        ...
        <xsl:call-template name="FooterLine">
            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_2_0 div 1440) + ($altova:nColumnWidthTw_2_1 div 1440)"/>
            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
        </xsl:call-template>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend2"/>
        ...
        <xsl:if test="$isHashcode=1">
            <xsl:call-template name="FooterWithHashcode">
                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_2_0 div 1440)"/>
                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
            </xsl:call-template>
        </xsl:if>
        ...
        <xsl:if test="$isPagenumber=1">
            ...
            <xsl:text>{\cs221\f1\fs18 </xsl:text>
            <xsl:call-template name="write-text">
                <xsl:with-param name="text">
                    <xsl:text> / </xsl:text>
                </xsl:with-param>
            ...
            <xsl:text>}</xsl:text>
            <xsl:text>{\field{\*\fldinst{\cs222\f1\fs18 NUMPAGES }}{\fldrslt }}</xsl:text>
        </xsl:if>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend2"/>
        <xsl:if test="$templatetablelevel + 1 > 1">
    ...
    <xsl:template name="altova:Section_0659C2F8_FooterRight">
    ...
    <xsl:template name="altova:Section_0659C2F8_FooterLeft">
        <xsl:variable name="altova:nMaxWidthIn" select="7.07"/>
        <xsl:variable name="templatetablelevel" select="0"/>
        <xsl:call-template name="LegacyFooter">
            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>

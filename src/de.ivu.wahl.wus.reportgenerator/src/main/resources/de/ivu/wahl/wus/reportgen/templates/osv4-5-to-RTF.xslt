...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:eml="urn:oasis:names:tc:evs:schema:eml" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:kr="http://www.kiesraad.nl/extensions" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:rg="http://www.kiesraad.nl/reportgenerator" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:ts="urn:oasis:names:tc:evs:schema:eml:ts" xmlns:xal="urn:oasis:names:tc:ciq:xsdschema:xAL:2.0" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xnl="urn:oasis:names:tc:ciq:xsdschema:xNL:2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="altova altova-xfi altovaext array clitype ds eml fn iso4217 ix java kr link map math rg sps ts xal xbrldi xbrli xff xfi xlink xnl xs xsi">
                ...
                <xsl:for-each select="eml:Count">
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Dag van de zitting: </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o4-5_032_DagZitting"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Tijdstipvan de zitting: </xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
                        <xsl:otherwise>
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:value-of select="$o4-5_034_TijdstipZitting"/>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:otherwise>
                    ...
                    <xsl:text>\par </xsl:text>
                    <xsl:text>\par </xsl:text>
                    <xsl:text>{\f1\fs22\b </xsl:text>
                    <xsl:call-template name="write-text">
                        <xsl:with-param name="text">
                            <xsl:text>Toegelaten kiezers en uitgebrachte stemmen</xsl:text>
                        </xsl:with-param>
                    </xsl:call-template>
                    <xsl:text>}</xsl:text>
                    <xsl:text>\par </xsl:text>
                        ...
                        <xsl:for-each select="eml:Contests">
                            <xsl:for-each select="eml:Contest">
                                <xsl:for-each select="eml:TotalVotes">
                                    ...
                                    <xsl:for-each select="eml:UncountedVotes[@ReasonCode = &quot;geldige stempassen&quot;]">
                                        <xsl:text>{\f1\fs18\b </xsl:text>
                                        <xsl:apply-templates>
                                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o4-5_045_gemachtigde"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    <xsl:for-each select="eml:UncountedVotes[@ReasonCode = &quot;geldige volmachtbewijzen&quot;]">
                                        <xsl:text>{\f1\fs18\b </xsl:text>
                                        <xsl:apply-templates>
                                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    ...
                                    <xsl:choose>
                                        ...
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o4-5_050_toegelatenKiezers"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    <xsl:for-each select="eml:UncountedVotes[@ReasonCode = &quot;toegelaten kiezers&quot;]">
                                        <xsl:text>{\f1\fs18\b </xsl:text>
                                        <xsl:apply-templates>
                                            <xsl:with-param name="altova:nMaxWidthIn" select="$altova:nMaxWidthIn"/>
                                            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 0"/>
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$lang=0">
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:text>Het aantal uitgebrachte stemmen: </xsl:text>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:when>
                                        <xsl:otherwise>
                                            ...
                                            <xsl:call-template name="write-text">
                                                <xsl:with-param name="text">
                                                    <xsl:value-of select="$o4-5_055_uitgebrachteStemmen"/>
                                                </xsl:with-param>
                                            </xsl:call-template>
                                            <xsl:text>}</xsl:text>
                                        </xsl:otherwise>
                    ...
                    <xsl:choose>
                        <xsl:when test="$lang=0">
                            ...
                            <xsl:call-template name="write-text">
                                <xsl:with-param name="text">
                                    <xsl:text>Op de verschillende lijsten zijn de volgende aantallen stemmen uitgebracht:</xsl:text>
                                </xsl:with-param>
                            </xsl:call-template>
                            <xsl:text>}</xsl:text>
                        </xsl:when>
            ...
            <xsl:choose>
                <xsl:when test="rg:CandidateVotes">
                    ...
                    <xsl:variable name="tablestyle1">
                        ...
                        <xsl:text>\ts16\trpaddt15\trpaddl15\trpaddb15\trpaddr15\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf1\brdrw15\trbrdrl\brdrnil\trbrdrb\brdrs\brdrcf1\brdrw15\trbrdrr\brdrnil</xsl:text>
                    </xsl:variable>
                ...
                <xsl:otherwise>
                    ...
                    <xsl:variable name="tablestyle2">
                        ...
                        <xsl:text>\ts17\trspdl15\trspdt15\trspdb15\trspdr15\trspdfl3\trspdft3\trspdfb3\trspdfr3\trpaddt30\trpaddl30\trpaddb30\trpaddr30\trpaddft3\trpaddfl3\trpaddfb3\trpaddfr3\trbrdrt\brdrs\brdrcf141\brdrw15\trbrdrl\brdrs\brdrcf141\brdrw15\trbrdrb\brdrs\brdrcf141\brdrw15\trbrdrr\brdrs\brdrcf141\brdrw15</xsl:text>
                    </xsl:variable>
    ...
    <xsl:template name="LegacyFooter">
        ...
        <xsl:variable name="altova:nColumnWidthTw_3_0" select="round($altova:nTableWidthTw_3 * 0.83 * $altova:TableWidthFactor_3)"/>
        <xsl:variable name="altova:nColumnWidthTw_3_1" select="round($altova:nTableWidthTw_3 * 0.17 * $altova:TableWidthFactor_3)"/>
        <xsl:text>\pard</xsl:text>
        <xsl:if test="$templatetablelevel + 1 &gt; 0">\intbl</xsl:if>
        <xsl:text>\itap</xsl:text>
        <xsl:value-of select="$templatetablelevel + 1"/>
        ...
        <xsl:call-template name="FooterLine">
            <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_0 div 1440) + ($altova:nColumnWidthTw_3_1 div 1440)"/>
            <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
        </xsl:call-template>
        <xsl:text>\f0\fs24</xsl:text>
        <xsl:value-of select="$cellend3"/>
        ...
        <xsl:if test="$isHashcode=1">
            <xsl:call-template name="FooterWithHashcode">
                <xsl:with-param name="altova:nMaxWidthIn" select="($altova:nColumnWidthTw_3_0 div 1440)"/>
                <xsl:with-param name="templatetablelevel" select="$templatetablelevel + 1"/>
            </xsl:call-template>
        </xsl:if>

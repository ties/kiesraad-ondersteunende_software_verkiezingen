                                ...
                                <xsl:for-each select="eml:EML">
                                    <xsl:for-each select="eml:CandidateList">
                                        <xsl:for-each select="eml:Election">
                                            ...
                                            <fo:block font-family="Arial" font-size="13pt" text-align="center" margin-right="100% - 100%" margin="0pt">
                                                <xsl:choose>
                                                    <xsl:when test="$lang=0">
                                                        <fo:inline font-family="Arial" font-size="13pt">
                                            ...
                                            <xsl:if test="$isDraft=&quot;false&quot;">
                                                ...
                                                <fo:block font-family="Arial" font-size="13pt" text-align="center" margin-right="100% - 100%" margin="0pt">
                                                    <xsl:choose>
                                                        <xsl:when test="$lang=0">
                                                            <fo:inline font-family="Arial" font-size="13pt">
                                                                <xsl:text>De SHA-256 hashcode van het EML 230b bestand genaamd Kandidatenlijsten is</xsl:text>
                                                            </fo:inline>
                                                        </xsl:when>
                                                        <xsl:otherwise>
                                                            <fo:inline font-family="Arial" font-size="13pt">
